...
SINGLE_BATTLE_TEST("Thunder Shock cannot paralyse an Electric-type")
{
    GIVEN {
...
SINGLE_BATTLE_TEST("Body Slam should paralyse Normal-types")
#else
SINGLE_BATTLE_TEST("Body Slam shouldn't paralyse Normal-types")
#endif
{
    GIVEN {
