...
#define AI_FRAME_CEILING_CHECK                                  TRUE// If TRUE, forces all thinking time tests to fail. Useful for printing all actual frame times to console by running the tests
