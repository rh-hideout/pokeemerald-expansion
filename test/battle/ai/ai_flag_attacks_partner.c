...
AI_DOUBLE_BATTLE_TEST("AI_FLAG_ATTACKS_PARTNER steps on its ally's weather")
{
    ...
    GIVEN {
        ...
        PLAYER(TEST_SPECIES_WOBBUFFET) { Speed(50); }
        OPPONENT(TEST_SPECIES_WOBBUFFET) { Speed(75); Moves(weather1, move1, MOVE_HEADBUTT); }
        OPPONENT(TEST_SPECIES_WOBBUFFET) { Speed(100); Moves(weather2, move2, MOVE_HEADBUTT); }
    } WHEN {
        TURN
        {
