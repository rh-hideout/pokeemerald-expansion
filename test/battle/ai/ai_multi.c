...
AI_MULTI_BATTLE_TEST("AI will only explode and kill everything on the field with Risky or Will Suicide (multi)")
{
    ...
    GIVEN {
        ...
        MULTI_PLAYER(TEST_SPECIES_WOBBUFFET) { HP(1); }
        MULTI_PARTNER(TEST_SPECIES_WOBBUFFET) { HP(1); }
...
AI_MULTI_BATTLE_TEST("Partner will not steal your pokemon when running out")
{
    ...
    GIVEN {
        ...
        MULTI_PLAYER(TEST_SPECIES_WOBBUFFET) { }
        MULTI_PLAYER(TEST_SPECIES_WOBBUFFET) { }
        MULTI_PARTNER(TEST_SPECIES_WYNAUT) { Moves(MOVE_MEMENTO); }
        MULTI_OPPONENT_A(TEST_SPECIES_WOBBUFFET) { Moves(MOVE_CELEBRATE); }
        MULTI_OPPONENT_B(TEST_SPECIES_WOBBUFFET) { Moves(MOVE_CELEBRATE); }
    } WHEN {
...
AI_MULTI_BATTLE_TEST("AI opponents do not steal their partner pokemon in multi battle to delay using their ace")
{
    ...
    GIVEN {
        ...
        MULTI_OPPONENT_A(TEST_SPECIES_WOBBUFFET) { Moves(MOVE_CELEBRATE); HP(1);}
        MULTI_OPPONENT_A(SPECIES_VENUSAUR) { Moves(MOVE_GIGA_DRAIN); }
        MULTI_OPPONENT_B(TEST_SPECIES_WYNAUT) { Moves(MOVE_CELEBRATE); }
    } WHEN {
...
AI_MULTI_BATTLE_TEST("AI opponents do not steal their partner pokemon in multi battle when forced out")
{
    ...
    GIVEN {
        ...
        MULTI_PLAYER(TEST_SPECIES_WOBBUFFET) { }
        MULTI_PARTNER(TEST_SPECIES_WOBBUFFET) { }
        MULTI_OPPONENT_A(TEST_SPECIES_WOBBUFFET) { Moves(MOVE_CELEBRATE); Item(item);}
        MULTI_OPPONENT_A(SPECIES_VENUSAUR) { Moves(MOVE_GIGA_DRAIN); }
        MULTI_OPPONENT_B(TEST_SPECIES_WYNAUT) { Moves(MOVE_CELEBRATE); }
    } WHEN {
