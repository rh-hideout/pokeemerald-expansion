...
AI_DOUBLE_BATTLE_TEST("AI uses Final Gambit")
{
    GIVEN {
        ...
        PLAYER(TEST_SPECIES_WOBBUFFET);
        PLAYER(TEST_SPECIES_WOBBUFFET);
        OPPONENT(TEST_SPECIES_WOBBUFFET) { Moves(MOVE_SPLASH, MOVE_FINAL_GAMBIT); }
...
AI_DOUBLE_BATTLE_TEST("AI uses Guillotine")
{
    GIVEN {
        ...
        PLAYER(TEST_SPECIES_WOBBUFFET);
        PLAYER(TEST_SPECIES_WOBBUFFET);
        OPPONENT(TEST_SPECIES_WOBBUFFET) { Moves(MOVE_SPLASH, MOVE_GUILLOTINE); }
        OPPONENT(TEST_SPECIES_WOBBUFFET);
        OPPONENT(TEST_SPECIES_WOBBUFFET);
        OPPONENT(TEST_SPECIES_WOBBUFFET);
    } WHEN {
...
AI_DOUBLE_BATTLE_TEST("AI uses Sheer Cold")
{
    GIVEN {
        ...
        PLAYER(TEST_SPECIES_WOBBUFFET);
        PLAYER(TEST_SPECIES_WOBBUFFET);
        OPPONENT(TEST_SPECIES_WOBBUFFET) { Moves(MOVE_SPLASH, MOVE_SHEER_COLD); }
        OPPONENT(TEST_SPECIES_WOBBUFFET);
        OPPONENT(TEST_SPECIES_WOBBUFFET);
        OPPONENT(TEST_SPECIES_WOBBUFFET);
    } WHEN {
...
AI_DOUBLE_BATTLE_TEST("AI can use all moves, 1-100")
{
    ...
    GIVEN {
        ...
        PLAYER(TEST_SPECIES_WOBBUFFET);
        PLAYER(TEST_SPECIES_WOBBUFFET);
        OPPONENT(TEST_SPECIES_WOBBUFFET) { Moves(MOVE_SPLASH, move); Status1(STATUS1_BURN); Item(ITEM_STARF_BERRY); }
        OPPONENT(TEST_SPECIES_WOBBUFFET) { Moves(MOVE_POUND, move); Item(ITEM_STARF_BERRY); }
