...
{
    GIVEN {
        PLAYER(TEST_SPECIES_WOBBUFFET) { MovesWithPP({MOVE_POUND, 35}); }
        OPPONENT(TEST_SPECIES_WOBBUFFET) { Ability(ABILITY_PRESSURE); }
    } WHEN {
...
{
    GIVEN {
        PLAYER(TEST_SPECIES_WOBBUFFET) { MovesWithPP({MOVE_SWIFT, 20}); }
        PLAYER(TEST_SPECIES_WYNAUT);
        OPPONENT(TEST_SPECIES_WOBBUFFET) { Ability(ABILITY_PRESSURE); }
        OPPONENT(TEST_SPECIES_WYNAUT) { Ability(ABILITY_PRESSURE); }
    } WHEN {
...
{
    GIVEN {
        PLAYER(TEST_SPECIES_WOBBUFFET) { MovesWithPP({MOVE_IMPRISON, 10}, {MOVE_SNATCH, 10}); }
        OPPONENT(TEST_SPECIES_WOBBUFFET) { Ability(ABILITY_PRESSURE); }
    } WHEN {
...
{
    GIVEN {
        PLAYER(TEST_SPECIES_WOBBUFFET) { MovesWithPP({MOVE_SPIKES, 20}, {MOVE_STEALTH_ROCK, 20}, {MOVE_TOXIC_SPIKES, 20}); }
        OPPONENT(TEST_SPECIES_WOBBUFFET) { Ability(ABILITY_PRESSURE); }
    } WHEN {
...
{
    GIVEN {
        PLAYER(TEST_SPECIES_WOBBUFFET) { MovesWithPP({MOVE_STICKY_WEB, 20}); }
        OPPONENT(TEST_SPECIES_WOBBUFFET) { Ability(ABILITY_PRESSURE); }
    } WHEN {
