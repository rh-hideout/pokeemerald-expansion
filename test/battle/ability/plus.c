...
DOUBLE_BATTLE_TEST("Plus starts boosting when its partner switches in", s16 before; s16 after)
{
    enum Ability ability;
    PARAMETRIZE { ability = ABILITY_PLUS; }
    PARAMETRIZE { ability = ABILITY_MINUS; }
    GIVEN {
        PLAYER(SPECIES_PLUSLE) { Ability(ABILITY_PLUS); Level(50); SpAttack(200); Speed(100); }
...
DOUBLE_BATTLE_TEST("Plus stops boosting when its partner switches out", s16 before; s16 after)
{
    enum Ability ability;
    PARAMETRIZE { ability = ABILITY_PLUS; }
    PARAMETRIZE { ability = ABILITY_MINUS; }
...
DOUBLE_BATTLE_TEST("Plus stops boosting if its partner faints before the user attacks", s16 before; s16 after)
{
    enum Ability ability;
    PARAMETRIZE { ability = ABILITY_PLUS; }
    PARAMETRIZE { ability = ABILITY_MINUS; }
...
DOUBLE_BATTLE_TEST("Plus does not boost fixed damage")
{
    enum Ability ability;
...
DOUBLE_BATTLE_TEST("Plus boosts special damage with a Plus or Minus ally", s16 damage)
{
    enum Ability ability;
    PARAMETRIZE { ability = ABILITY_CLEAR_BODY; }
    PARAMETRIZE { ability = ABILITY_PLUS; }
    PARAMETRIZE { ability = ABILITY_MINUS; }
    GIVEN {
        PLAYER(SPECIES_PLUSLE) { Ability(ABILITY_PLUS); SpAttack(200); Attack(200); Speed(100); }
        PLAYER(SPECIES_KLINK) { Ability(ability); Speed(90); }
...
DOUBLE_BATTLE_TEST("Plus does not boost physical damage", s16 damage)
{
    enum Ability ability;
    PARAMETRIZE { ability = ABILITY_CLEAR_BODY; }
    PARAMETRIZE { ability = ABILITY_PLUS; }
...
DOUBLE_BATTLE_TEST("Plus stops boosting damage when the user's ability is suppressed", s16 damage)
{
    enum Ability ability;
    PARAMETRIZE { ability = ABILITY_CLEAR_BODY; }
    PARAMETRIZE { ability = ABILITY_PLUS; }
...
DOUBLE_BATTLE_TEST("Plus stops boosting damage when the ally's ability is suppressed", s16 damage)
{
    enum Ability ability;
    PARAMETRIZE { ability = ABILITY_CLEAR_BODY; }
    PARAMETRIZE { ability = ABILITY_PLUS; }
...
SINGLE_BATTLE_TEST("Plus is not activated by an opposing Plus or Minus Pokemon", s16 damage)
{
    enum Ability ability;
    PARAMETRIZE { ability = ABILITY_CLEAR_BODY; }
    PARAMETRIZE { ability = ABILITY_PLUS; }
    PARAMETRIZE { ability = ABILITY_MINUS; }
    GIVEN {
        PLAYER(SPECIES_PLUSLE) { Ability(ABILITY_PLUS); SpAttack(200); }
...
SINGLE_BATTLE_TEST("Plus is not activated by a benched Plus or Minus Pokemon", s16 damage)
{
    enum Ability ability;
    PARAMETRIZE { ability = ABILITY_CLEAR_BODY; }
    PARAMETRIZE { ability = ABILITY_PLUS; }
