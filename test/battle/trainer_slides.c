...
AI_SINGLE_BATTLE_TEST("Trainer Slide: Singles: Enemy Last Switchin")
{
    GIVEN {
        FLAG_SET(TESTING_FLAG_TRAINER_SLIDES);
        VAR_SET(TESTING_VAR_TRAINER_SLIDES, TRAINER_SLIDE_ENEMY_LAST_SWITCHIN);
        PLAYER(SPECIES_WOBBUFFET);
        OPPONENT(SPECIES_WOBBUFFET);
        OPPONENT(SPECIES_WYNAUT) { Moves(MOVE_CELEBRATE); }
    } WHEN {
...
AI_SINGLE_BATTLE_TEST("Trainer Slide: Singles: Enemy Last Half Hp")
{
    GIVEN {
        FLAG_SET(TESTING_FLAG_TRAINER_SLIDES);
        VAR_SET(TESTING_VAR_TRAINER_SLIDES, TRAINER_SLIDE_ENEMY_LAST_HALF_HP);
...
AI_SINGLE_BATTLE_TEST("Trainer Slide: Singles: Enemy Last Low Hp")
{
    GIVEN {
        FLAG_SET(TESTING_FLAG_TRAINER_SLIDES);
...
AI_SINGLE_BATTLE_TEST("Trainer Slide: Singles: Enemy Mega Evolution")
{
    GIVEN {
        FLAG_SET(TESTING_FLAG_TRAINER_SLIDES);
...
AI_SINGLE_BATTLE_TEST("Trainer Slide: Singles: Enemy Z Move")
{
    GIVEN {
        FLAG_SET(TESTING_FLAG_TRAINER_SLIDES);
        VAR_SET(TESTING_VAR_TRAINER_SLIDES, TRAINER_SLIDE_ENEMY_Z_MOVE);
        PLAYER(SPECIES_WOBBUFFET);
...
AI_SINGLE_BATTLE_TEST("Trainer Slide: Singles: Enemy Dynamax")
{
    GIVEN {
        FLAG_SET(TESTING_FLAG_TRAINER_SLIDES);
...
SINGLE_BATTLE_TEST("Trainer Slide: Singles: Player Mega Evolution")
{
    GIVEN {
        ...
        MESSAGE("Trainer A: This message plays before the player activates the Mega Evolution gimmick.{PAUSE_UNTIL_PRESS}");
...
SINGLE_BATTLE_TEST("Trainer Slide: Singles: Player Z Move")
{
    GIVEN {
        ...
        MESSAGE("Trainer A: This message plays before the player activates the Z-Move gimmick.{PAUSE_UNTIL_PRESS}");
...
SINGLE_BATTLE_TEST("Trainer Slide: Singles: Player Dynamax")
{
    GIVEN {
        ...
        MESSAGE("Trainer A: This message plays before the player activates the Dynamax gimmick.{PAUSE_UNTIL_PRESS}");
...
SINGLE_BATTLE_TEST("Trainer Slide: Singles: Player Tera")
{
    GIVEN {
        ...
        MESSAGE("Trainer A: This message plays before the player activates the Tera gimmick.{PAUSE_UNTIL_PRESS}");
...
AI_DOUBLE_BATTLE_TEST("Trainer Slide: Doubles: Enemy Last Switchin")
{
    GIVEN {
        FLAG_SET(TESTING_FLAG_TRAINER_SLIDES);
        VAR_SET(TESTING_VAR_TRAINER_SLIDES, TRAINER_SLIDE_ENEMY_LAST_SWITCHIN);
...
AI_DOUBLE_BATTLE_TEST("Trainer Slide: Doubles: Enemy Last Half Hp")
{
    GIVEN {
        FLAG_SET(TESTING_FLAG_TRAINER_SLIDES);
        VAR_SET(TESTING_VAR_TRAINER_SLIDES, TRAINER_SLIDE_ENEMY_LAST_HALF_HP);
...
AI_DOUBLE_BATTLE_TEST("Trainer Slide: Doubles: Enemy Last Low Hp")
{
    GIVEN {
        FLAG_SET(TESTING_FLAG_TRAINER_SLIDES);
        VAR_SET(TESTING_VAR_TRAINER_SLIDES, TRAINER_SLIDE_ENEMY_LAST_LOW_HP);
...
AI_DOUBLE_BATTLE_TEST("Trainer Slide: Doubles: Enemy Mega Evolution")
{
    GIVEN {
        FLAG_SET(TESTING_FLAG_TRAINER_SLIDES);
        VAR_SET(TESTING_VAR_TRAINER_SLIDES, TRAINER_SLIDE_ENEMY_MEGA_EVOLUTION);
...
AI_DOUBLE_BATTLE_TEST("Trainer Slide: Doubles: Enemy Z Move")
{
    GIVEN {
        FLAG_SET(TESTING_FLAG_TRAINER_SLIDES);
        VAR_SET(TESTING_VAR_TRAINER_SLIDES, TRAINER_SLIDE_ENEMY_Z_MOVE);
...
AI_DOUBLE_BATTLE_TEST("Trainer Slide: Doubles: Enemy Dynamax")
{
    GIVEN {
        FLAG_SET(TESTING_FLAG_TRAINER_SLIDES);
        VAR_SET(TESTING_VAR_TRAINER_SLIDES, TRAINER_SLIDE_ENEMY_DYNAMAX);
...
AI_MULTI_BATTLE_TEST("Trainer Slide: Multi: Enemy Last Switchin")
{
    GIVEN {
        FLAG_SET(TESTING_FLAG_TRAINER_SLIDES);
        VAR_SET(TESTING_VAR_TRAINER_SLIDES, TRAINER_SLIDE_ENEMY_LAST_SWITCHIN);
...
AI_MULTI_BATTLE_TEST("Trainer Slide: Multi: Enemy Last Half Hp")
{
    GIVEN {
        FLAG_SET(TESTING_FLAG_TRAINER_SLIDES);
        VAR_SET(TESTING_VAR_TRAINER_SLIDES, TRAINER_SLIDE_ENEMY_LAST_HALF_HP);
...
AI_MULTI_BATTLE_TEST("Trainer Slide: Multi: Enemy Last Low Hp")
{
    GIVEN {
        FLAG_SET(TESTING_FLAG_TRAINER_SLIDES);
        VAR_SET(TESTING_VAR_TRAINER_SLIDES, TRAINER_SLIDE_ENEMY_LAST_LOW_HP);
...
AI_MULTI_BATTLE_TEST("Trainer Slide: Multi: Enemy Mega Evolution")
{
    GIVEN {
        FLAG_SET(TESTING_FLAG_TRAINER_SLIDES);
        VAR_SET(TESTING_VAR_TRAINER_SLIDES, TRAINER_SLIDE_ENEMY_MEGA_EVOLUTION);
...
AI_MULTI_BATTLE_TEST("Trainer Slide: Multi: Enemy Z Move")
{
    GIVEN {
        FLAG_SET(TESTING_FLAG_TRAINER_SLIDES);
        VAR_SET(TESTING_VAR_TRAINER_SLIDES, TRAINER_SLIDE_ENEMY_Z_MOVE);
...
AI_MULTI_BATTLE_TEST("Trainer Slide: Multi: Enemy Dynamax")
{
