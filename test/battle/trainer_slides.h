[DIFFICULTY_NORMAL] =
{
    [TRAINER_LEAF_TEST] =
    {
        ...
        [TRAINER_SLIDE_ATTACKER_GIMMICK] = COMPOUND_STRING("Trainer A: This message plays before the attacker activates a gimmick.{PAUSE_UNTIL_PRESS}"),
        [TRAINER_SLIDE_OPPONENT_GIMMICK] = COMPOUND_STRING("Trainer A: This message plays before the opponent activates a gimmick.{PAUSE_UNTIL_PRESS}"),
    ...
    [TRAINER_RED_TEST] =
    {
        ...
        [TRAINER_SLIDE_ATTACKER_GIMMICK] = COMPOUND_STRING("Trainer B: This message plays before the attacker activates a gimmick.{PAUSE_UNTIL_PRESS}"),
        [TRAINER_SLIDE_OPPONENT_GIMMICK] = COMPOUND_STRING("Trainer B: This message plays before the opponent activates a gimmick.{PAUSE_UNTIL_PRESS}"),
    ...
    [TRAINER_PARTNER(PARTNER_STEVEN_TEST)] =
    {
        ...
        [TRAINER_SLIDE_ATTACKER_GIMMICK] = COMPOUND_STRING("Trainer Partner: This message plays before the attacker activates a gimmick.{PAUSE_UNTIL_PRESS}"),
        [TRAINER_SLIDE_OPPONENT_GIMMICK] = COMPOUND_STRING("Trainer Partner: This message plays before the opponent activates a gimmick.{PAUSE_UNTIL_PRESS}"),
