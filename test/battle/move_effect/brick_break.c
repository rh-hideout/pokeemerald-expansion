...
ASSUMPTIONS
{
	ASSUME(MoveHasAdditionalEffect(MOVE_BRICK_BREAK, MOVE_EFFECT_REMOVE_SCREENS));
	ASSUME(MoveHasAdditionalEffect(MOVE_PSYCHIC_FANGS, MOVE_EFFECT_REMOVE_SCREENS));
