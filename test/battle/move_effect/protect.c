...
ASSUMPTIONS
{
    ...
    ASSUME(GetMoveEffect(MOVE_DETECT) == EFFECT_PREVENT_DAMAGE);
    ASSUME(GetMoveEffect(MOVE_KINGS_SHIELD) == EFFECT_PREVENT_DAMAGE);
    ASSUME(GetMoveEffect(MOVE_SILK_TRAP) == EFFECT_PREVENT_DAMAGE);
    ASSUME(GetMoveEffect(MOVE_SPIKY_SHIELD) == EFFECT_PREVENT_DAMAGE);
    ASSUME(GetMoveEffect(MOVE_WIDE_GUARD) == EFFECT_PREVENT_DAMAGE);
    ...
    ASSUME(GetMoveEffect(MOVE_BURNING_BULWARK) == EFFECT_PREVENT_DAMAGE);
