...
AI_SINGLE_BATTLE_TEST("AI uses Stuff Cheeks")
{
    GIVEN {
        ...
        PLAYER(TEST_SPECIES_WOBBUFFET) { Moves(MOVE_CELEBRATE, MOVE_HEADBUTT); }
        PLAYER(TEST_SPECIES_WOBBUFFET) { Moves(MOVE_CELEBRATE, MOVE_HEADBUTT); }
        OPPONENT(TEST_SPECIES_WOBBUFFET) { Item(ITEM_LIECHI_BERRY); Moves(MOVE_HEADBUTT, MOVE_STUFF_CHEEKS); }
    } WHEN {
