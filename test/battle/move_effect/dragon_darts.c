...
DOUBLE_BATTLE_TEST("Dragon Darts strikes an opponent twice if the other one is Fairy-type")
{
    ...
    PARAMETRIZE { chosenTarget = opponentLeft;  finalTarget = opponentRight; speciesLeft = SPECIES_FIDOUGH;        speciesRight = TEST_SPECIES_WOBBUFFET; }
    PARAMETRIZE { chosenTarget = opponentRight; finalTarget = opponentRight; speciesLeft = SPECIES_FIDOUGH;        speciesRight = TEST_SPECIES_WOBBUFFET; }
    PARAMETRIZE { chosenTarget = opponentLeft;  finalTarget = opponentLeft;  speciesLeft = TEST_SPECIES_WOBBUFFET; speciesRight = SPECIES_FIDOUGH; }
    PARAMETRIZE { chosenTarget = opponentRight; finalTarget = opponentLeft;  speciesLeft = TEST_SPECIES_WOBBUFFET; speciesRight = SPECIES_FIDOUGH; }
...
DOUBLE_BATTLE_TEST("Dragon Darts strikes an opponent twice if the other one is fainted")
{
    ...
    GIVEN {
        PLAYER(TEST_SPECIES_WOBBUFFET);
        PLAYER(TEST_SPECIES_WOBBUFFET);
        OPPONENT(TEST_SPECIES_WOBBUFFET) { HP(hpLeft); }
        OPPONENT(TEST_SPECIES_WOBBUFFET) { HP(hpRight); }
    } WHEN {
...
DOUBLE_BATTLE_TEST("Dragon Darts strikes left ally twice if one strike misses")
{
    ...
    GIVEN {
        PLAYER(TEST_SPECIES_WOBBUFFET);
        PLAYER(TEST_SPECIES_WOBBUFFET);
        OPPONENT(TEST_SPECIES_WOBBUFFET) { Item(itemLeft); };
        OPPONENT(TEST_SPECIES_WOBBUFFET) { Item(itemRight); };
    } WHEN {
