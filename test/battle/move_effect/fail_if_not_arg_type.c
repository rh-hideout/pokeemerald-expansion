...
SINGLE_BATTLE_TEST("Burn Up user loses its Fire-type")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(TEST_SPECIES_WOBBUFFET, 0) != TYPE_FIRE || GetSpeciesType(TEST_SPECIES_WOBBUFFET, 1) != TYPE_FIRE);
...
SINGLE_BATTLE_TEST("Double Shock user loses its Electric-type")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(TEST_SPECIES_WOBBUFFET, 0) != TYPE_ELECTRIC || GetSpeciesType(TEST_SPECIES_WOBBUFFET, 1) != TYPE_ELECTRIC);
