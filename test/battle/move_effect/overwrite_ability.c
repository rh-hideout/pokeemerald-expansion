...
SINGLE_BATTLE_TEST("Simple Beam fails if target has an ability that can't be overwritten")
{
    ...
    PARAMETRIZE { species = SPECIES_MUNNA; ability = ABILITY_COMATOSE; }
    PARAMETRIZE { species = SPECIES_MUSHARNA; ability = ABILITY_COMATOSE; }
    ...
    PARAMETRIZE { species = SPECIES_CARBINK; ability = ABILITY_ZERO_TO_HERO; }
    PARAMETRIZE { species = SPECIES_TATSUGIRI; ability = ABILITY_COMMANDER; }
    PARAMETRIZE { species = SPECIES_DUOSION; ability = ABILITY_COMMANDER; }
