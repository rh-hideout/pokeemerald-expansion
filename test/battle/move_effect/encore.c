...
TO_DO_BATTLE_TEST("(Gens2-3) Encore forces consecutive move uses for 2-6 turns: Encore used after move");
TO_DO_BATTLE_TEST("(Gen4) Encore forces consecutive move uses for 3-7 turns: Encore used after move");
