...
{
    GIVEN {
        PLAYER(TEST_SPECIES_WOBBUFFET) { Moves(MOVE_LAST_RESORT); }
...
{
    GIVEN {
        PLAYER(TEST_SPECIES_WOBBUFFET) { Moves(MOVE_LAST_RESORT, MOVE_SCRATCH); }
        OPPONENT(TEST_SPECIES_WOBBUFFET);
    } WHEN {
        TURN { MOVE(player, MOVE_LAST_RESORT); }
...
{
    GIVEN {
        PLAYER(TEST_SPECIES_WOBBUFFET) { Moves(MOVE_LAST_RESORT, MOVE_QUICK_ATTACK, MOVE_SCRATCH); }
        OPPONENT(TEST_SPECIES_WOBBUFFET);
    } WHEN {
        TURN { MOVE(player, MOVE_LAST_RESORT); }
...
{
    GIVEN {
        PLAYER(TEST_SPECIES_WOBBUFFET) { Moves(MOVE_LAST_RESORT, MOVE_QUICK_ATTACK, MOVE_SCRATCH, MOVE_GUST); }
        OPPONENT(TEST_SPECIES_WOBBUFFET);
    } WHEN {
        TURN { MOVE(player, MOVE_LAST_RESORT); }
        TURN { MOVE(player, MOVE_QUICK_ATTACK); }
...
SINGLE_BATTLE_TEST("Last Resort works with Sleep Talk")
{
    GIVEN {
        ...
        PLAYER(TEST_SPECIES_WOBBUFFET) { Moves(MOVE_LAST_RESORT, MOVE_SLEEP_TALK); Status1(STATUS1_SLEEP_TURN(3)); }
        OPPONENT(TEST_SPECIES_WOBBUFFET);
    } WHEN {
...
AI_SINGLE_BATTLE_TEST("AI uses Last Resort - 2 moves")
{
    ...
    GIVEN {
        ...
        OPPONENT(TEST_SPECIES_WOBBUFFET) { Moves(MOVE_LAST_RESORT, MOVE_SCRATCH); }
    } WHEN {
...
AI_SINGLE_BATTLE_TEST("AI uses Last Resort - 3 moves")
{
    ...
    GIVEN {
        PLAYER(TEST_SPECIES_WOBBUFFET);
        OPPONENT(TEST_SPECIES_WOBBUFFET) { MovesWithPP({MOVE_LAST_RESORT, 5}, {MOVE_QUICK_ATTACK, 1}, {MOVE_SCRATCH, 35}); }
    } WHEN {
        TURN { NOT_EXPECT_MOVE(opponent, MOVE_LAST_RESORT); }
        TURN { NOT_EXPECT_MOVE(opponent, MOVE_LAST_RESORT); }
        TURN { EXPECT_MOVE(opponent, MOVE_LAST_RESORT); }
...
AI_SINGLE_BATTLE_TEST("AI uses Last Resort - 4 moves")
{
    ...
    GIVEN {
        PLAYER(TEST_SPECIES_WOBBUFFET);
        OPPONENT(TEST_SPECIES_WOBBUFFET) { MovesWithPP({MOVE_LAST_RESORT, 5}, {MOVE_QUICK_ATTACK, 1}, {MOVE_SCRATCH, 1}, {MOVE_GUST, 35}); }
    } WHEN {
        TURN { NOT_EXPECT_MOVE(opponent, MOVE_LAST_RESORT); }
        TURN { NOT_EXPECT_MOVE(opponent, MOVE_LAST_RESORT); }
        TURN { NOT_EXPECT_MOVE(opponent, MOVE_LAST_RESORT); }
