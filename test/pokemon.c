...
TEST("givemon [egg]: properties are preserved after hatching")
{
    ...
    EXPECT_EQ(GetMonData(&gParties[B_TRAINER_0][0], MON_DATA_IS_EGG), TRUE);
    ...
    EXPECT_EQ(GetMonData(&gParties[B_TRAINER_0][0], MON_DATA_SPECIES_OR_EGG), SPECIES_WOBBUFFET);
    EXPECT_EQ(GetMonData(&gParties[B_TRAINER_0][0], MON_DATA_SANITY_IS_BAD_EGG), FALSE);
    EXPECT_EQ(GetMonData(&gParties[B_TRAINER_0][0], MON_DATA_LANGUAGE), GAME_LANGUAGE);
    EXPECT_EQ(GetMonData(&gParties[B_TRAINER_0][0], MON_DATA_FRIENDSHIP), 120);
