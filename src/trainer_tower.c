...
#define TRAINER_TOWER gSaveBlock1Ptr->trainerHill[gSaveBlock1Ptr->trainerHillMode]
...
static const struct SinglesTrainerInfo sSingleBattleTrainerInfo[] = {
    ...
    {OBJ_EVENT_GFX_YOUNGSTER_FRLG, FACILITY_CLASS_YOUNGSTER,           MALE},
    {OBJ_EVENT_GFX_BUG_CATCHER_FRLG, FACILITY_CLASS_BUG_CATCHER,         MALE},
    {OBJ_EVENT_GFX_LASS_FRLG,      FACILITY_CLASS_LASS,              FEMALE},
    {OBJ_EVENT_GFX_SAILOR_FRLG,    FACILITY_CLASS_SAILOR,              MALE},
    {OBJ_EVENT_GFX_CAMPER_FRLG,    FACILITY_CLASS_CAMPER,              MALE},
    {OBJ_EVENT_GFX_PICNICKER_FRLG, FACILITY_CLASS_PICNICKER,         FEMALE},
    {OBJ_EVENT_GFX_SUPER_NERD,     FACILITY_CLASS_POKEMANIAC,          MALE},
    {OBJ_EVENT_GFX_SUPER_NERD,     FACILITY_CLASS_SUPER_NERD,          MALE},
    {OBJ_EVENT_GFX_HIKER_FRLG,     FACILITY_CLASS_HIKER,               MALE},
    ...
    {OBJ_EVENT_GFX_BEAUTY_FRLG,    FACILITY_CLASS_BEAUTY,            FEMALE},
    ...
    {OBJ_EVENT_GFX_WOMAN_1_FRLG,   FACILITY_CLASS_PSYCHIC_F,         FEMALE},
    {OBJ_EVENT_GFX_BATTLE_GIRL,    FACILITY_CLASS_CRUSH_GIRL,        FEMALE},
    {OBJ_EVENT_GFX_TUBER_F_FRLG,   FACILITY_CLASS_TUBER,             FEMALE},
    {OBJ_EVENT_GFX_WOMAN_2_FRLG,   FACILITY_CLASS_PKMN_BREEDER,      FEMALE},
    {OBJ_EVENT_GFX_CAMPER_FRLG,    FACILITY_CLASS_PKMN_RANGER_M,       MALE},
    {OBJ_EVENT_GFX_PICNICKER_FRLG, FACILITY_CLASS_PKMN_RANGER_F,     FEMALE},
    {OBJ_EVENT_GFX_WOMAN_2_FRLG,   FACILITY_CLASS_AROMA_LADY,        FEMALE},
    {OBJ_EVENT_GFX_HIKER_FRLG,     FACILITY_CLASS_RUIN_MANIAC,         MALE},
    {OBJ_EVENT_GFX_WOMAN_2_FRLG,   FACILITY_CLASS_LADY,              FEMALE}
};
...
static const struct DoublesTrainerInfo sDoubleBattleTrainerInfo[] = {
    ...
    {OBJ_EVENT_GFX_LITTLE_GIRL_FRLG, OBJ_EVENT_GFX_LITTLE_GIRL_FRLG,    FACILITY_CLASS_TWINS,           FEMALE, FEMALE},
    {OBJ_EVENT_GFX_COOLTRAINER_M,  OBJ_EVENT_GFX_COOLTRAINER_F,  FACILITY_CLASS_COOL_COUPLE,       MALE, FEMALE},
    {OBJ_EVENT_GFX_BEAUTY_FRLG,    OBJ_EVENT_GFX_MAN,            FACILITY_CLASS_YOUNG_COUPLE,    FEMALE,   MALE},
...
{
#if FREE_TRAINER_HILL == FALSE
    u32 challengeType = gSaveBlock1Ptr->trainerHillMode;
#else
...
static void StartTrainerTowerChallenge(void)
{
    ...
    if (gSaveBlock1Ptr->trainerHillMode >= NUM_TOWER_CHALLENGE_TYPES)
        gSaveBlock1Ptr->trainerHillMode = 0;
    ValidateOrResetCurTrainerTowerRecord();
...
{
#if FREE_TRAINER_HILL == FALSE
    if (TRAINER_TOWER.unused != sTrainerTowerState->data.id)
    {
        TRAINER_TOWER.unused = sTrainerTowerState->data.id;
...
void PrintTrainerTowerRecords(void)
{
    ...
    for (i = 0; i < NUM_TOWER_CHALLENGE_TYPES; i++)
    {
        PRINT_TOWER_TIME(GetTrainerTowerRecordTime(&gSaveBlock1Ptr->trainerHill[i].bestTime));
        StringExpandPlaceholders(gStringVar4, gText_XMinYZSec);
...
void ResetTrainerTowerResults(void)
{
    ...
    for (i = 0; i < NUM_TOWER_CHALLENGE_TYPES; i++)
    {
        SetTrainerTowerRecordTime(&gSaveBlock1Ptr->trainerHill[i].bestTime, TRAINER_TOWER_MAX_TIME);
    }
#endif //FREE_TRAINER_HILL
}
