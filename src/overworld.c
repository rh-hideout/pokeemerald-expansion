...
bool8 GetSetItemObtained(enum ItemId item, enum ItemObtainFlags caseId)
{
...
static void ShowItemIconSprite(enum ItemId item, bool8 firstTime, bool8 flash);
static void DestroyItemIconSprite(void);

static u8 ReformatItemDescription(enum ItemId item, u8 *dest)
{
    u8 count = 0;
    u8 numLines = 1;
    u8 maxChars = 32;
...
void ScriptShowItemDescription(struct ScriptContext *ctx)
{
    ...
    enum ItemId item = gSpecialVar_0x8006;
    u8 textY;
    u8 *dst;
