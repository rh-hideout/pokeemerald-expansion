...
static void DrawSelectedMonScreen(u8 whichParty)
{
    ...
    case 1:
        ...
        gSprites[sTradeMenu->partySpriteIds[selectedMonParty][partyIdx]].sDuration_lt = 20;
        gSprites[sTradeMenu->partySpriteIds[selectedMonParty][partyIdx]].sInputEndX_lt = (sTradeMonSpriteCoords[selectedMonParty * PARTY_SIZE][0]
                                                                                         + sTradeMonSpriteCoords[selectedMonParty * PARTY_SIZE + 1][0]) / 2 * 8 + 14;
        gSprites[sTradeMenu->partySpriteIds[selectedMonParty][partyIdx]].sInputEndY_lt = (sTradeMonSpriteCoords[selectedMonParty * PARTY_SIZE][1] * 8) - 12;
