...
{
    if (battlerDef.statStages[STAT_DEF] > DEFAULT_STAT_STAGE) && HasMoveWithCategory(battlerAtk, DAMAGE_CATEGORY_PHYSICAL)
         return TRUE;
    if (battlerDef.statStages[STAT_SPDEF] > DEFAULT_STAT_STAGE) && HasMoveWithCategory(battlerAtk, DAMAGE_CATEGORY_SPECIAL)
         return TRUE;
    if (battlerAtk.statStages[STAT_ATK] < DEFAULT_STAT_STAGE) && HasMoveWithCategory(battlerAtk, DAMAGE_CATEGORY_PHYSICAL)
         return TRUE;
    if (battlerAtk.statStages[STAT_SPATK] < DEFAULT_STAT_STAGE) && HasMoveWithCategory(battlerAtk, DAMAGE_CATEGORY_SPECIAL)
         return TRUE;
    return FALSE;
}
