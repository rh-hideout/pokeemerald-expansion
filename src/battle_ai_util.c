...
bool32 ShouldSetHail(u32 battler, u32 ability, enum ItemHoldEffect holdEffect)
{
    ...
    if (ability == ABILITY_SNOW_CLOAK
      ...
      || HasMoveWithEffect(battler, EFFECT_BLIZZARD)
...
bool32 ShouldSetRain(u32 battlerAtk, u32 atkAbility, enum ItemHoldEffect holdEffect)
{
    ...
    if (holdEffect != HOLD_EFFECT_UTILITY_UMBRELLA
     && (atkAbility == ABILITY_SWIFT_SWIM
      ...
      || HasMoveWithEffect(battlerAtk, EFFECT_THUNDER)
...
void IncreasePoisonScore(u32 battlerAtk, u32 battlerDef, u32 move, s32 *score)
{
    ...
    if (AI_CanPoison(battlerAtk, battlerDef, AI_DATA->abilities[battlerDef], move, AI_DATA->partnerMove) && AI_DATA->hpPercents[battlerDef] > 20)
    {
        ...
        if (AI_THINKING_STRUCT->aiFlags[battlerAtk] & AI_FLAG_STALL && HasMoveWithEffect(battlerAtk, EFFECT_PROTECT))
...
u32 IncreaseSubstituteMoveScore(u32 battlerAtk, u32 battlerDef, u32 move)
{
    ...
    if (HasMoveWithEffect(battlerDef, EFFECT_SLEEP)
     || HasMoveWithEffect(battlerDef, EFFECT_TOXIC)
     || HasMoveWithEffect(battlerDef, EFFECT_POISON)
     || HasMoveWithEffect(battlerDef, EFFECT_PARALYZE)
     || HasMoveWithEffect(battlerDef, EFFECT_WILL_O_WISP)
