...
bool32 IsDamageMoveUnusable(struct BattleMoveContext *ctx)
{
...
static inline void CalcDynamicMoveDamage(struct BattleMoveContext *ctx, u16 *medianDamage, u16 *minimumDamage, u16 *maximumDamage)
{
...
static inline bool32 ShouldCalcCritDamage(struct BattleMoveContext *ctx)
{
...
static s32 HandleKOThroughBerryReduction(struct BattleMoveContext *ctx, s32 dmg)
{
...
static s32 AI_ApplyModifiersAfterDmgRoll(struct BattleMoveContext *ctx, s32 dmg)
{
