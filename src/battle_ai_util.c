...
bool32 IsPartyMonOnFieldOrChosenToSwitch(u32 partyIndex, enum BattlerId battlerIn1, enum BattlerId battlerIn2) // grintoul TO DO - how to make this work for everywhere it's used
{
