                      ...
                      const struct HabitatOfferContext *offer)
{
    ...
    case COND_PARTY_SPECIES:      // [this phase, Task 3]
    case COND_PARTY_FRIENDSHIP:   // [this phase, Task 3]
    case COND_PARTY_MOVE:         // [this phase, Task 3]
    case COND_PARTY_NATURE:       // [this phase, Task 3]
