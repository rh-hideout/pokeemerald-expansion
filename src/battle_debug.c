...
static const u8 sText_HoldEffectCursedFang[] = _("Cursed Fang");
static const u8 sText_HoldEffectCrimsonLens[] = _("Crimson Lens");
...
static const u8 *const sHoldEffectNames[] =
{
    ...
    [HOLD_EFFECT_CURSED_FANG] = sText_HoldEffectCursedFang,
    [HOLD_EFFECT_CRIMSON_LENS] = sText_HoldEffectCrimsonLens,
