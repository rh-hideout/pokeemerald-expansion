...
const u8 gText_AButton[] = _("Botao A"); // Unused
const u8 gText_BButton[] = _("Botao B"); // Unused
const u8 gText_RButton[] = _("Botao R"); // Unused
const u8 gText_LButton[] = _("Botao L"); // Unused
...
ALIGNED(4) const u8 gText_Next[] = _("{A_BUTTON}PROXIMO");
ALIGNED(4) const u8 gText_NextBack[] = _("{A_BUTTON}PROXIMO {B_BUTTON}VOLTAR");
ALIGNED(4) const u8 gText_PickNextCancel[] = _("{DPAD_UPDOWN}ESCOLHER {A_BUTTON}PROXIMO {B_BUTTON}CANCELAR");
ALIGNED(4) const u8 gText_PickCancel[] = _("{DPAD_UPDOWN}ESCOLHER {A_BUTTON}{B_BUTTON}CANCELAR");
...
const u8 gText_WhatWouldYouLike[] = _("O que voce gostaria de fazer?");
...
const u8 gText_CantWriteMail[] = _("Nao da para escrever\nCARTA aqui.");
const u8 gText_NoPokemon[] = _("Nao ha\nPOKeMON.");
const u8 gText_MoveVar1Where[] = _("Mover o\n{STR_VAR_1}\npara onde?");
const u8 gText_Var1CantBeHeld[] = _("O {STR_VAR_1} nao pode ser segurado.");
const u8 gText_TossHowManyVar1s[] = _("Jogar fora quantos\n{STR_VAR_1}?");
const u8 gText_ThrewAwayVar2Var1s[] = _("Foram jogados fora {STR_VAR_2}\n{STR_VAR_1}.");
const u8 gText_ConfirmTossItems[] = _("Tem certeza que quer\njogar fora {STR_VAR_2}\n{STR_VAR_1}?");
...
const u8 gText_ThePokemonList[] = _("a LISTA de POKeMON");
...
const u8 gText_ThatItemIsSoldOut[] = _("Desculpe, este item esgotou.{PAUSE_UNTIL_PRESS}");
const u8 gText_SoldOut[] = _("ESGOTADO");
const u8 gText_InBagVar1[] = _("NA BOLSA: {STR_VAR_1}");
const u8 gText_QuitShopping[] = _("Encerrar compras.");
...
const u8 gText_YouDontHaveMoney[] = _("Voce nao tem dinheiro suficiente.{PAUSE_UNTIL_PRESS}");
const u8 gText_NoMoreRoomForThis[] = _("Nao ha mais espaco para este\nitem.{PAUSE_UNTIL_PRESS}");
const u8 gText_SpaceForVar1Full[] = _("O espaco para {STR_VAR_1} esta cheio.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_WontHaveEffect[] = _("Nao tera efeito.{PAUSE_UNTIL_PRESS}");
const u8 gText_NextFusionMon[] = _("Choose {PKMN} to fuse with.");
const u8 gText_CantBeUsedOnPkmn[] = _("Nao pode ser usado nesse\nPOKeMON.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_EggCantBattle[] = _("Um OVO nao pode batalhar!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TeachWhichPokemon[] = _("Ensinar para qual POKeMON?");
const u8 gText_UseOnWhichPokemon[] = _("Usar em qual POKeMON?");
const u8 gText_GiveToWhichPokemon[] = _("Dar para qual POKeMON?");
const u8 gText_DoWhatWithPokemon[] = _("O que fazer com este {PKMN}?");
...
const u8 gText_CantUseHere[] = _("Nao pode usar isso aqui.");
...
const u8 gText_NoPokemonForBattle[] = _("Sem POKeMON para batalha!");
