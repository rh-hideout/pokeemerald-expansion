...
const u8 gText_ThisIsAPokemon[] = _("In fact, here is one of my friends!{PAUSE 96}\p");
...
const u8 gText_MoveRelearnerPkmnForgotMoveAndLearnedNew[] = _("{STR_VAR_1} replaced {STR_VAR_3}\nwith {STR_VAR_2}!");
...
const u8 gText_SEASONS_Summer[]                     = _("Summer");
const u8 gText_SEASONS_Autumn[]                     = _("Autumn");
const u8 gText_SEASONS_Winter[]                     = _("Winter");
const u8 gText_SEASONS_Spring[]                     = _("Spring");
const u8 gText_dayOfWeek_Sunday[]                   = _("Su, ");
const u8 gText_dayOfWeek_Monday[]                   = _("Mo, ");
const u8 gText_dayOfWeek_Tuesday[]                  = _("Tu, ");
const u8 gText_dayOfWeek_Wednesday[]                = _("We, ");
const u8 gText_dayOfWeek_Thursday[]                 = _("Th, ");
const u8 gText_dayOfWeek_Friday[]                   = _("Fr, ");
const u8 gText_dayOfWeek_Saturday[]                 = _("Sa, ");
const u8 gText_MONTH_JAN[]                          = _("Jan");
const u8 gText_MONTH_FEB[]                          = _("Feb");
const u8 gText_MONTH_MAR[]                          = _("Mar");
const u8 gText_MONTH_APR[]                          = _("Apr");
const u8 gText_MONTH_MAY[]                          = _("May");
const u8 gText_MONTH_JUN[]                          = _("Jun");
const u8 gText_MONTH_JUL[]                          = _("Jul");
const u8 gText_MONTH_AUG[]                          = _("Aug");
const u8 gText_MONTH_SEP[]                          = _("Sep");
