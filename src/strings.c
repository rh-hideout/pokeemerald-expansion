...
const u8 gText_ExpandedPlaceholder_Celeste[] = _("CELESTE");
const u8 gText_ExpandedPlaceholder_Hiiro[] = _("HIIRO");
const u8 gText_ExpandedPlaceholder_Aleciya[] = _("ALECIYA");
const u8 gText_ExpandedPlaceholder_Aster[] = _("ASTER");
