...
void PrepareStringBattle(enum StringID stringId, u32 battler)
{
    ...
    if (stringId == STRINGID_STATSWONTDECREASE && !(gBattleScripting.statChanger & STAT_BUFF_NEGATIVE))
        ...
        // skip other checks
    else if (stringId == STRINGID_STATSWONTDECREASE2)
        stringId = STRINGID_STATSWONTINCREASE2;
    else if (stringId == STRINGID_STATSWONTINCREASE2)
        stringId = STRINGID_STATSWONTDECREASE2;
    else if (stringId == STRINGID_USINGITEMSTATOFPKMNROSE)
        stringId = STRINGID_USINGITEMSTATOFPKMNFELL;
    else if (stringId == STRINGID_USINGITEMSTATOFPKMNFELL)
        stringId = STRINGID_USINGITEMSTATOFPKMNROSE;
