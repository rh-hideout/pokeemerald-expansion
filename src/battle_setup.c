...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_SIDNEY] = REMATCH(TRAINER_RED_DOUBLES, TRAINER_RED_DOUBLES, TRAINER_RED_DOUBLES, TRAINER_RED_DOUBLES, TRAINER_RED_DOUBLES, EVER_GRANDE_CITY),
    [REMATCH_PHOEBE] = REMATCH(TRAINER_WALLY_DOUBLES, TRAINER_WALLY_DOUBLES, TRAINER_WALLY_DOUBLES, TRAINER_WALLY_DOUBLES, TRAINER_WALLY_DOUBLES, EVER_GRANDE_CITY),
    [REMATCH_GLACIA] = REMATCH(TRAINER_GLACIA, TRAINER_GLACIA, TRAINER_GLACIA, TRAINER_GLACIA, TRAINER_GLACIA, EVER_GRANDE_CITY),
    [REMATCH_DRAKE] = REMATCH(TRAINER_LEAF, TRAINER_LEAF, TRAINER_LEAF, TRAINER_LEAF, TRAINER_LEAF, EVER_GRANDE_CITY),
