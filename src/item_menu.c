...
static const enum ItemSortType sItemsByType[ITEMS_COUNT] =
{
...
static s32 CompareItemsByType(enum Pocket pocketId, struct ItemSlot item1, struct ItemSlot item2)
{
    enum ItemSortType type1 = sItemsByType[item1.itemId];
    enum ItemSortType type2 = sItemsByType[item2.itemId];
