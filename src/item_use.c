...
u8 CheckIfItemIsTMHMOrEvolutionStone(enum ItemId itemId)
{
...
static bool32 IteamHealsMonVolatile(u32 battler, enum ItemId itemId)
{
...
static bool32 SelectedMonHasVolatile(enum ItemId itemId)
{
...
bool32 CannotUseItemsInBattle(enum ItemId itemId, struct Pokemon *mon)
{
