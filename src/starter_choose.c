...
#define GRASS_STARTER (IS_FRLG ? SPECIES_BULBASAUR  : SPECIES_GROWLITHE_HISUI)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_CHARMANDER : SPECIES_SOLOSIS)
#define WATER_STARTER (IS_FRLG ? SPECIES_SQUIRTLE   : SPECIES_DREEPY )
