...
void HandleBattleLowHpMusicChange(void)
{
    if (gMain.inBattle)
    {
        ...
        enum PartyMon battler1PartyId = GetPartyIdFromBattlePartyId(gBattlerPartyIndexes[playerBattler1]);
        enum PartyMon battler2PartyId = GetPartyIdFromBattlePartyId(gBattlerPartyIndexes[playerBattler2]);
