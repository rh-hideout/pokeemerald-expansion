...
{
    ANIMCMD_FRAME(TYPE_ICON_1_FRAME(TYPE_MACHINE), 0),
    ANIMCMD_END
};
...
const union AnimCmd *const sSpriteAnimTable_TypeIcons[] =
{
    ...
    [TYPE_PUPPET] =      sSpriteAnim_TypeIcon_Fairy,
