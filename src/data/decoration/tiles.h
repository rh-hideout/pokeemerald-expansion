...
const u16 DecorGfx_COLOURFUL_PLANT[] = {
    DECOR_TILE(ColourfulPlant_TopLeft),
    DECOR_TILE(ColourfulPlant_TopRight),
    DECOR_TILE(ColourfulPlant_BaseLeft1),
    DECOR_TILE(ColourfulPlant_BaseRight1)
};
...
const u16 DecorGfx_FIRE_BLAST_MAT[] = {
    ...
    DECOR_TILE(FireBlastMat_Centre),
...
const u16 DecorGfx_POWDER_SNOW_MAT[] = {
    ...
    DECOR_TILE(PowderSnowMat_Centre),
