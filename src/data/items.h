...
// Ability Modifiers
    ...
    [ITEM_ABILITY_CAPSULE] =
    {
        ...
        .price = (I_PRICE < GEN_7) ? 100 : ((I_PRICE < GEN_9) ? 100 : 100),
        .holdEffectParam = 0,
        .description = COMPOUND_STRING(
            "Switches a Poké-\n"
            "mon's ability."),
