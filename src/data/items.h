...
// Poké Balls
    ...
    {
        .name = _("Cyro Ball"),
        .price = (I_PRICE >= GEN_7) ? 500 : 1000,
        .description = COMPOUND_STRING(
            "A Ball made\n"
            "to catch Ice pokemon,\n"
            "or Pokemon in Snow."),
        .pocket = POCKET_POKE_BALLS,
        .type = ITEM_USE_BAG_MENU,
        .battleUsage = EFFECT_ITEM_THROW_BALL,
        .secondaryId = BALL_CYRO,
        .iconPic = gItemIcon_PremierBall,
        .iconPalette = gItemIconPalette_LuxuryBall,
    },
...
// Ability Modifiers
    ...
    [ITEM_ABILITY_CAPSULE] =
    {
        ...
        .price = (I_PRICE < GEN_7) ? 1000 : ((I_PRICE < GEN_9) ? 10000 : 5000),
        .holdEffectParam = 0,
        .description = COMPOUND_STRING(
            "Switches a Poké-\n"
            "mon's ability."),
...
// Type-boosting Held Items
    ...
    [ITEM_SILK_SCARF] =
    {
        ...
        .price = (I_PRICE >= GEN_9) ? 2000 : ((I_PRICE >= GEN_7) ? 1000 : 100),
    ...
    {
        .name = _("Charcoal"),
        .price = (I_PRICE >= GEN_9) ? 2000 : ((I_PRICE >= GEN_7) ? 1000 : 9800),
    ...
    {
        .name = _("Metal Coat"),
        .price = (I_PRICE >= GEN_9) ? 2000 : ((I_PRICE >= GEN_7) ? 2000 : 100),
...
// Type-activated Stat Modifiers
    ...
    [ITEM_LUMINOUS_MOSS] =
    {
        ...
        .price = (I_PRICE >= GEN_9) ? 2000 : ((I_PRICE >= GEN_7) ? 4000 : 1000),
...
// Misc. Held Items
    ...
    [ITEM_BRIGHT_POWDER] =
    {
        ...
        .price = (I_PRICE >= GEN_9) ? 5000 : ((I_PRICE >= GEN_7) ? 4000 : 10),
        .holdEffect = HOLD_EFFECT_EVASION_UP,
        .holdEffectParam = 10,
        .description = COMPOUND_STRING(
            "A hold item that\n"
    ...
    {
        .name = _("Quick Claw"),
        .price = (I_PRICE >= GEN_9) ? 2000 : ((I_PRICE >= GEN_7) ? 4000 : 100),
    ...
    {
        .name = _("King's Rock"),
        .price = (I_PRICE >= GEN_9) ? 8000 : ((I_PRICE >= GEN_7) ? 5000 : 100),
    ...
    {
        .name = _("Amulet Coin"),
        .price = (I_PRICE >= GEN_9) ? 3000 : ((I_PRICE >= GEN_7) ? 10000 : 100),
        .holdEffect = HOLD_EFFECT_DOUBLE_PRIZE,
        .description = sLuckIncenseDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
    ...
    {
        .name = _("Muscle Band"),
        .price = (I_PRICE >= GEN_9) ? 6000 : ((I_PRICE >= GEN_7) ? 4000 : 200),
    ...
    {
        .name = _("Razor Claw"),
        .price = (I_PRICE >= GEN_9) ? 10000 : ((I_PRICE >= GEN_7) ? 5000 : 2100),
        .holdEffect = HOLD_EFFECT_SCOPE_LENS,
        .description = COMPOUND_STRING(
            "A hooked claw that\n"
            "ups the holder's\n"
    ...
    [ITEM_SAND_BAG] =
    {
        .name = _("Sand Bag"),
        .price = (I_PRICE >= GEN_9) ? 8000 : ((I_PRICE >= GEN_7) ? 4000 : 200),
        .holdEffect = HOLD_EFFECT_SAND_BAG,
        .holdEffectParam = 0,
        .description = COMPOUND_STRING(
            "Makes the holder\n"
            "grounded but bursts\n"
    ...
    [ITEM_HARD_HAT] =
    {
        .name = _("Hard Hat"),
        .price = (I_PRICE >= GEN_9) ? 8000 : ((I_PRICE >= GEN_7) ? 4000 : 200),
        .holdEffect = HOLD_EFFECT_HARD_HAT,
        .holdEffectParam = 0,
        .description = COMPOUND_STRING(
            "Makes the holder\n"
            "safe from incoming\n"
    ...
    [ITEM_WEAKNESS_POLICY] =
    {
        ...
        .price = (I_PRICE >= GEN_9) ? 30000 : 1000,
    ...
    [ITEM_TERRAIN_EXTENDER] =
    {
        ...
        .price = (I_PRICE >= GEN_9) ? 10000 : 4000,
...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM_POWER_CHORD] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_POWER_CHORD,
    },

    [ITEM_TM_BOULDER_BASH] =
    {
        .name = _("TM164"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
    ...
    [ITEM_TM_FINAL_MIGHT] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_FINAL_MIGHT,
    },

    [ITEM_TM_TALON_STRIKE] =
    {
        .name = _("TM173"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
    ...
    [ITEM_TM_ASTRAL_WAVE] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_ASTRAL_WAVE,
    },

    [ITEM_TM_TOXIC_TUMBLE] =
    {
        .name = _("TM176"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_TOXIC_TUMBLE,
    },

    [ITEM_TM_PRESSURE_POINT] =
    {
        .name = _("TM177"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_PRESSURE_POINT,
    },

    [ITEM_TM_POLLEN_BREEZE] =
    {
        .name = _("TM178"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_POLLEN_BREEZE,
    },

    [ITEM_TM_THUNDER_SPEAR] =
    {
        .name = _("TM179"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_THUNDER_SPEAR,
    },
    ...
    [ITEM_TM_CYCLONE] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_CYCLONE,
    },

    [ITEM_TM_SINISTER_SLAM] =
    {
        .name = _("TM181"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_SINISTER_SLAM,
    },

    [ITEM_TM_FRIGID_PUNCH] =
    {
        .name = _("TM182"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_FRIGID_PUNCH,
    },
    
    [ITEM_TM_GLACIAL_TEMPEST] =
    {
        .name = _("TM183"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_GLACIAL_TEMPEST,
    },

    [ITEM_TM_DESERT_STORM] =
    {
        .name = _("TM184"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_DESERT_STORM,
    },

    [ITEM_TM_TREMOR_BARGE] =
    {
        .name = _("TM185"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_TREMOR_BARGE,
    },
    
    [ITEM_TM_ELECTRO_SHOT] =
    {
        .name = _("TM186"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
...
// GEN 9 ITEMS
    ...
    [ITEM_IRON_MASK] =
    {
        .name = _("Iron Mask"),
        .price = 15000,
        .holdEffect = HOLD_EFFECT_IRON_MASK,
        .description = COMPOUND_STRING(
            "Powers up biting\n"
            "moves and removes\n"
            "their contact."),
