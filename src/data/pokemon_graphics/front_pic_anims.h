...
PLACEHOLDER_ANIM_SINGLE_FRAME(Arachnote);
SINGLE_ANIMATION(Arachnote);

PLACEHOLDER_ANIM_SINGLE_FRAME(Fucker);
SINGLE_ANIMATION(Fucker);

PLACEHOLDER_ANIM_SINGLE_FRAME(Hazelnaut);
SINGLE_ANIMATION(Hazelnaut);

PLACEHOLDER_ANIM_SINGLE_FRAME(Ginocchio);
SINGLE_ANIMATION(Ginocchio);

PLACEHOLDER_ANIM_SINGLE_FRAME(Noxilium);
SINGLE_ANIMATION(Noxilium);

PLACEHOLDER_ANIM_SINGLE_FRAME(Yuukiino);
SINGLE_ANIMATION(Yuukiino);

PLACEHOLDER_ANIM_SINGLE_FRAME(Aquadiiva);
SINGLE_ANIMATION(Aquadiiva);

PLACEHOLDER_ANIM_SINGLE_FRAME(Forgotno);
SINGLE_ANIMATION(Forgotno);

PLACEHOLDER_ANIM_SINGLE_FRAME(Doomsay);
SINGLE_ANIMATION(Doomsay);

PLACEHOLDER_ANIM_SINGLE_FRAME(Hydroil);
SINGLE_ANIMATION(Hydroil);

PLACEHOLDER_ANIM_SINGLE_FRAME(Dubsnake);
SINGLE_ANIMATION(Dubsnake);

PLACEHOLDER_ANIM_SINGLE_FRAME(Kumataro);
SINGLE_ANIMATION(Kumataro);

PLACEHOLDER_ANIM_SINGLE_FRAME(Bearedaze);
SINGLE_ANIMATION(Bearedaze);

PLACEHOLDER_ANIM_SINGLE_FRAME(Parmiausan);
SINGLE_ANIMATION(Parmiausan);

PLACEHOLDER_ANIM_SINGLE_FRAME(Krackodemon);
SINGLE_ANIMATION(Krackodemon);

PLACEHOLDER_ANIM_SINGLE_FRAME(Mammount);
SINGLE_ANIMATION(Mammount);

PLACEHOLDER_ANIM_SINGLE_FRAME(Moltama);
SINGLE_ANIMATION(Moltama);

PLACEHOLDER_ANIM_SINGLE_FRAME(Molterra);
SINGLE_ANIMATION(Molterra);

PLACEHOLDER_ANIM_SINGLE_FRAME(Mamini);
SINGLE_ANIMATION(Mamini);

PLACEHOLDER_ANIM_SINGLE_FRAME(Krissy);
SINGLE_ANIMATION(Krissy);

PLACEHOLDER_ANIM_SINGLE_FRAME(Blubbastard);
SINGLE_ANIMATION(Blubbastard);

PLACEHOLDER_ANIM_SINGLE_FRAME(Flubbster);
SINGLE_ANIMATION(Flubbster);

PLACEHOLDER_ANIM_SINGLE_FRAME(Reveloros);
SINGLE_ANIMATION(Reveloros);

PLACEHOLDER_ANIM_SINGLE_FRAME(Ouroblack);
SINGLE_ANIMATION(Ouroblack);

PLACEHOLDER_ANIM_SINGLE_FRAME(Impfection);
SINGLE_ANIMATION(Impfection);

PLACEHOLDER_ANIM_SINGLE_FRAME(Dinomight);
SINGLE_ANIMATION(Dinomight);

PLACEHOLDER_ANIM_SINGLE_FRAME(Cocken);
SINGLE_ANIMATION(Cocken);

PLACEHOLDER_ANIM_SINGLE_FRAME(Buggy);
SINGLE_ANIMATION(Buggy);

PLACEHOLDER_ANIM_SINGLE_FRAME(Bugatti);
SINGLE_ANIMATION(Bugatti);

PLACEHOLDER_ANIM_SINGLE_FRAME(Bullepede);
SINGLE_ANIMATION(Bullepede);

PLACEHOLDER_ANIM_SINGLE_FRAME(Gargarramer);
SINGLE_ANIMATION(Gargarramer);

PLACEHOLDER_ANIM_SINGLE_FRAME(GargarramerAwaken);
SINGLE_ANIMATION(GargarramerAwaken);

PLACEHOLDER_ANIM_SINGLE_FRAME(Garble);
SINGLE_ANIMATION(Garble);

PLACEHOLDER_ANIM_SINGLE_FRAME(Garookie);
SINGLE_ANIMATION(Garookie);

PLACEHOLDER_ANIM_SINGLE_FRAME(Bandicute);
SINGLE_ANIMATION(Bandicute);

PLACEHOLDER_ANIM_SINGLE_FRAME(Naughtycoot);
SINGLE_ANIMATION(Naughtycoot);

PLACEHOLDER_ANIM_SINGLE_FRAME(Ibask);
SINGLE_ANIMATION(Ibask);

PLACEHOLDER_ANIM_SINGLE_FRAME(Dirtybis);
SINGLE_ANIMATION(Dirtybis);

PLACEHOLDER_ANIM_SINGLE_FRAME(Apocamise);
SINGLE_ANIMATION(Apocamise);

PLACEHOLDER_ANIM_SINGLE_FRAME(Venireal);
SINGLE_ANIMATION(Venireal);

PLACEHOLDER_ANIM_SINGLE_FRAME(Platylics);
SINGLE_ANIMATION(Platylics);

PLACEHOLDER_ANIM_SINGLE_FRAME(Bluduck);
SINGLE_ANIMATION(Bluduck);

PLACEHOLDER_ANIM_SINGLE_FRAME(Hyduck);
SINGLE_ANIMATION(Hyduck);

PLACEHOLDER_ANIM_SINGLE_FRAME(Indignifly);
SINGLE_ANIMATION(Indignifly);

PLACEHOLDER_ANIM_SINGLE_FRAME(Fusjahl);
SINGLE_ANIMATION(Fusjahl);

PLACEHOLDER_ANIM_SINGLE_FRAME(Jahl);
SINGLE_ANIMATION(Jahl);

PLACEHOLDER_ANIM_SINGLE_FRAME(Jumblegore);
SINGLE_ANIMATION(Jumblegore);

PLACEHOLDER_ANIM_SINGLE_FRAME(Jumblinart);
SINGLE_ANIMATION(Jumblinart);

PLACEHOLDER_ANIM_SINGLE_FRAME(Nyanonite);
SINGLE_ANIMATION(Nyanonite);

PLACEHOLDER_ANIM_SINGLE_FRAME(Ignifatu);
SINGLE_ANIMATION(Ignifatu);

PLACEHOLDER_ANIM_SINGLE_FRAME(Emeffyume);
SINGLE_ANIMATION(Emeffyume);

PLACEHOLDER_ANIM_SINGLE_FRAME(Phantorney);
SINGLE_ANIMATION(Phantorney);

PLACEHOLDER_ANIM_SINGLE_FRAME(Kokaiju);
SINGLE_ANIMATION(Kokaiju);

PLACEHOLDER_ANIM_SINGLE_FRAME(Levititan);
SINGLE_ANIMATION(Levititan);

PLACEHOLDER_ANIM_SINGLE_FRAME(Brashalisk);
SINGLE_ANIMATION(Brashalisk);

PLACEHOLDER_ANIM_SINGLE_FRAME(Larvatrice);
SINGLE_ANIMATION(Larvatrice);

PLACEHOLDER_ANIM_SINGLE_FRAME(Whipsicuffs);
SINGLE_ANIMATION(Whipsicuffs);

PLACEHOLDER_ANIM_SINGLE_FRAME(Whimple);
SINGLE_ANIMATION(Whimple);

PLACEHOLDER_ANIM_SINGLE_FRAME(Whipscuffle);
SINGLE_ANIMATION(Whipscuffle);

PLACEHOLDER_ANIM_SINGLE_FRAME(Epilate);
SINGLE_ANIMATION(Epilate);

PLACEHOLDER_ANIM_SINGLE_FRAME(Qrakenmark);
SINGLE_ANIMATION(Qrakenmark);

PLACEHOLDER_ANIM_SINGLE_FRAME(Weatherbane);
SINGLE_ANIMATION(Weatherbane);

PLACEHOLDER_ANIM_SINGLE_FRAME(Epipheror);
SINGLE_ANIMATION(Epipheror);

PLACEHOLDER_ANIM_SINGLE_FRAME(Wattitude);
SINGLE_ANIMATION(Wattitude);

PLACEHOLDER_ANIM_SINGLE_FRAME(Rendalopod);
SINGLE_ANIMATION(Rendalopod);

PLACEHOLDER_ANIM_SINGLE_FRAME(Spycrab);
SINGLE_ANIMATION(Spycrab);

PLACEHOLDER_ANIM_SINGLE_FRAME(Turturret);
SINGLE_ANIMATION(Turturret);

PLACEHOLDER_ANIM_SINGLE_FRAME(Skallaxy);
SINGLE_ANIMATION(Skallaxy);

PLACEHOLDER_ANIM_SINGLE_FRAME(Mimikrab);
SINGLE_ANIMATION(Mimikrab);

PLACEHOLDER_ANIM_SINGLE_FRAME(Turtini);
SINGLE_ANIMATION(Turtini);

PLACEHOLDER_ANIM_SINGLE_FRAME(Borkosmos);
SINGLE_ANIMATION(Borkosmos);

PLACEHOLDER_ANIM_SINGLE_FRAME(Gharroste);
SINGLE_ANIMATION(Gharroste);

PLACEHOLDER_ANIM_SINGLE_FRAME(Termagnius);
SINGLE_ANIMATION(Termagnius);

PLACEHOLDER_ANIM_SINGLE_FRAME(Lemirethun);
SINGLE_ANIMATION(Lemirethun);

PLACEHOLDER_ANIM_SINGLE_FRAME(Cyclonian);
SINGLE_ANIMATION(Cyclonian);

PLACEHOLDER_ANIM_SINGLE_FRAME(Shroomalice);
SINGLE_ANIMATION(Shroomalice);

PLACEHOLDER_ANIM_SINGLE_FRAME(Onsenpura);
SINGLE_ANIMATION(Onsenpura);

PLACEHOLDER_ANIM_SINGLE_FRAME(Horntuba);
SINGLE_ANIMATION(Horntuba);

PLACEHOLDER_ANIM_SINGLE_FRAME(Virtuita);
SINGLE_ANIMATION(Virtuita);

PLACEHOLDER_ANIM_SINGLE_FRAME(Strollge);
SINGLE_ANIMATION(Strollge);

PLACEHOLDER_ANIM_SINGLE_FRAME(Doomter);
SINGLE_ANIMATION(Doomter);

PLACEHOLDER_ANIM_SINGLE_FRAME(Sporestool);
SINGLE_ANIMATION(Sporestool);

PLACEHOLDER_ANIM_SINGLE_FRAME(Tokoyaki);
SINGLE_ANIMATION(Tokoyaki);

PLACEHOLDER_ANIM_SINGLE_FRAME(Ampstar);
SINGLE_ANIMATION(Ampstar);

PLACEHOLDER_ANIM_SINGLE_FRAME(Strixnight);
SINGLE_ANIMATION(Strixnight);

PLACEHOLDER_ANIM_SINGLE_FRAME(Selaghast);
SINGLE_ANIMATION(Selaghast);

PLACEHOLDER_ANIM_SINGLE_FRAME(Karkutlass);
SINGLE_ANIMATION(Karkutlass);

PLACEHOLDER_ANIM_SINGLE_FRAME(Glucurs);
SINGLE_ANIMATION(Glucurs);

PLACEHOLDER_ANIM_SINGLE_FRAME(Spiranha);
SINGLE_ANIMATION(Spiranha);

PLACEHOLDER_ANIM_SINGLE_FRAME(Hamstatic);
SINGLE_ANIMATION(Hamstatic);

PLACEHOLDER_ANIM_SINGLE_FRAME(Stowlet);
SINGLE_ANIMATION(Stowlet);

PLACEHOLDER_ANIM_SINGLE_FRAME(Doubtlaw);
SINGLE_ANIMATION(Doubtlaw);

PLACEHOLDER_ANIM_SINGLE_FRAME(Starhiro);
SINGLE_ANIMATION(Starhiro);

PLACEHOLDER_ANIM_SINGLE_FRAME(Amalgum);
SINGLE_ANIMATION(Amalgum);

PLACEHOLDER_ANIM_SINGLE_FRAME(Tamanaut);
SINGLE_ANIMATION(Tamanaut);

PLACEHOLDER_ANIM_SINGLE_FRAME(Klasicope);
SINGLE_ANIMATION(Klasicope);

PLACEHOLDER_ANIM_SINGLE_FRAME(Essention);
SINGLE_ANIMATION(Essention);

PLACEHOLDER_ANIM_SINGLE_FRAME(Frudge);
SINGLE_ANIMATION(Frudge);

PLACEHOLDER_ANIM_SINGLE_FRAME(Aquaos);
SINGLE_ANIMATION(Aquaos);

PLACEHOLDER_ANIM_SINGLE_FRAME(Dredgod);
SINGLE_ANIMATION(Dredgod);

PLACEHOLDER_ANIM_SINGLE_FRAME(Adentity);
SINGLE_ANIMATION(Adentity);

PLACEHOLDER_ANIM_SINGLE_FRAME(Coilspill);
SINGLE_ANIMATION(Coilspill);

PLACEHOLDER_ANIM_SINGLE_FRAME(Regigigone);
SINGLE_ANIMATION(Regigigone);

PLACEHOLDER_ANIM_SINGLE_FRAME(Regicide);
SINGLE_ANIMATION(Regicide);

PLACEHOLDER_ANIM_SINGLE_FRAME(Regishort);
SINGLE_ANIMATION(Regishort);

PLACEHOLDER_ANIM_SINGLE_FRAME(Glaciun);
SINGLE_ANIMATION(Glaciun);

PLACEHOLDER_ANIM_SINGLE_FRAME(Galvadeux);
SINGLE_ANIMATION(Galvadeux);

PLACEHOLDER_ANIM_SINGLE_FRAME(Pyrotrois);
SINGLE_ANIMATION(Pyrotrois);

PLACEHOLDER_ANIM_SINGLE_FRAME(Sablini);
SINGLE_ANIMATION(Sablini);

PLACEHOLDER_ANIM_SINGLE_FRAME(Bambuya);
SINGLE_ANIMATION(Bambuya);

PLACEHOLDER_ANIM_SINGLE_FRAME(Temawria);
SINGLE_ANIMATION(Temawria);

PLACEHOLDER_ANIM_SINGLE_FRAME(Retwina);
SINGLE_ANIMATION(Retwina);

PLACEHOLDER_ANIM_SINGLE_FRAME(Winkhulu);
SINGLE_ANIMATION(Winkhulu);

PLACEHOLDER_ANIM_SINGLE_FRAME(Xeninter);
SINGLE_ANIMATION(Xeninter);

PLACEHOLDER_ANIM_SINGLE_FRAME(Icehugger);
SINGLE_ANIMATION(Icehugger);

PLACEHOLDER_ANIM_SINGLE_FRAME(Draklown);
SINGLE_ANIMATION(Draklown);

PLACEHOLDER_ANIM_SINGLE_FRAME(Trickling);
SINGLE_ANIMATION(Trickling);

PLACEHOLDER_ANIM_SINGLE_FRAME(Regirust);
SINGLE_ANIMATION(Regirust);

PLACEHOLDER_ANIM_SINGLE_FRAME(Regimelt);
SINGLE_ANIMATION(Regimelt);

PLACEHOLDER_ANIM_SINGLE_FRAME(Regirode);
SINGLE_ANIMATION(Regirode);

PLACEHOLDER_ANIM_SINGLE_FRAME(Camerex);
SINGLE_ANIMATION(Camerex);

PLACEHOLDER_ANIM_SINGLE_FRAME(Shaikle);
SINGLE_ANIMATION(Shaikle);

PLACEHOLDER_ANIM_SINGLE_FRAME(Zillichina);
SINGLE_ANIMATION(Zillichina);

PLACEHOLDER_ANIM_SINGLE_FRAME(Drattel);
SINGLE_ANIMATION(Drattel);

PLACEHOLDER_ANIM_SINGLE_FRAME(Mantasm);
SINGLE_ANIMATION(Mantasm);

PLACEHOLDER_ANIM_SINGLE_FRAME(Junkgeist);
SINGLE_ANIMATION(Junkgeist);

PLACEHOLDER_ANIM_SINGLE_FRAME(Poltire);
SINGLE_ANIMATION(Poltire);

PLACEHOLDER_ANIM_SINGLE_FRAME(Barabyss);
SINGLE_ANIMATION(Barabyss);

PLACEHOLDER_ANIM_SINGLE_FRAME(Seaman);
SINGLE_ANIMATION(Seaman);

PLACEHOLDER_ANIM_SINGLE_FRAME(Tsemani);
SINGLE_ANIMATION(Tsemani);

PLACEHOLDER_ANIM_SINGLE_FRAME(Serpotine);
SINGLE_ANIMATION(Serpotine);

PLACEHOLDER_ANIM_SINGLE_FRAME(Jarumite);
SINGLE_ANIMATION(Jarumite);

PLACEHOLDER_ANIM_SINGLE_FRAME(Warghork);
SINGLE_ANIMATION(Warghork);

PLACEHOLDER_ANIM_SINGLE_FRAME(Goblazer);
SINGLE_ANIMATION(Goblazer);

PLACEHOLDER_ANIM_SINGLE_FRAME(Squithee);
SINGLE_ANIMATION(Squithee);

PLACEHOLDER_ANIM_SINGLE_FRAME(Cheesetah);
SINGLE_ANIMATION(Cheesetah);

PLACEHOLDER_ANIM_SINGLE_FRAME(Cheepouf);
SINGLE_ANIMATION(Cheepouf);

PLACEHOLDER_ANIM_SINGLE_FRAME(Faustival);
SINGLE_ANIMATION(Faustival);

PLACEHOLDER_ANIM_SINGLE_FRAME(Jermin);
SINGLE_ANIMATION(Jermin);

PLACEHOLDER_ANIM_SINGLE_FRAME(JerminSwarm);
SINGLE_ANIMATION(JerminSwarm);

PLACEHOLDER_ANIM_SINGLE_FRAME(Saccestoda);
SINGLE_ANIMATION(Saccestoda);

PLACEHOLDER_ANIM_SINGLE_FRAME(Vortrix);
SINGLE_ANIMATION(Vortrix);

PLACEHOLDER_ANIM_SINGLE_FRAME(Salezerker);
SINGLE_ANIMATION(Salezerker);

PLACEHOLDER_ANIM_SINGLE_FRAME(Delava);
SINGLE_ANIMATION(Delava);

PLACEHOLDER_ANIM_SINGLE_FRAME(Magmata);
SINGLE_ANIMATION(Magmata);

PLACEHOLDER_ANIM_SINGLE_FRAME(Gigapuddi);
SINGLE_ANIMATION(Gigapuddi);

PLACEHOLDER_ANIM_SINGLE_FRAME(Empidae);
SINGLE_ANIMATION(Empidae);

PLACEHOLDER_ANIM_SINGLE_FRAME(Seraphill);
SINGLE_ANIMATION(Seraphill);

PLACEHOLDER_ANIM_SINGLE_FRAME(Spenjbab);
SINGLE_ANIMATION(Spenjbab);

PLACEHOLDER_ANIM_SINGLE_FRAME(Ranruu);
SINGLE_ANIMATION(Ranruu);

PLACEHOLDER_ANIM_SINGLE_FRAME(Doomsday);
SINGLE_ANIMATION(Doomsday);

PLACEHOLDER_ANIM_SINGLE_FRAME(DoomsdayRevenant);
SINGLE_ANIMATION(DoomsdayRevenant);

PLACEHOLDER_ANIM_SINGLE_FRAME(Foxcet);
SINGLE_ANIMATION(Foxcet);

PLACEHOLDER_ANIM_SINGLE_FRAME(Skoxious);
SINGLE_ANIMATION(Skoxious);

PLACEHOLDER_ANIM_SINGLE_FRAME(Sanickel);
SINGLE_ANIMATION(Sanickel);

PLACEHOLDER_ANIM_SINGLE_FRAME(Carpedian);
SINGLE_ANIMATION(Carpedian);

PLACEHOLDER_ANIM_SINGLE_FRAME(Arctiglobe);
SINGLE_ANIMATION(Arctiglobe);

PLACEHOLDER_ANIM_SINGLE_FRAME(ArctiglobeFreed);
SINGLE_ANIMATION(ArctiglobeFreed);

PLACEHOLDER_ANIM_SINGLE_FRAME(Fryzzle);
SINGLE_ANIMATION(Fryzzle);

PLACEHOLDER_ANIM_SINGLE_FRAME(Crolord);
SINGLE_ANIMATION(Crolord);

PLACEHOLDER_ANIM_SINGLE_FRAME(Sphare);
SINGLE_ANIMATION(Sphare);

PLACEHOLDER_ANIM_SINGLE_FRAME(Costrike);
SINGLE_ANIMATION(Costrike);

PLACEHOLDER_ANIM_SINGLE_FRAME(Theforest);
SINGLE_ANIMATION(Theforest);

PLACEHOLDER_ANIM_SINGLE_FRAME(Clobber);
SINGLE_ANIMATION(Clobber);

PLACEHOLDER_ANIM_SINGLE_FRAME(Lober);
SINGLE_ANIMATION(Lober);

PLACEHOLDER_ANIM_SINGLE_FRAME(Lunabbit);
SINGLE_ANIMATION(Lunabbit);

PLACEHOLDER_ANIM_SINGLE_FRAME(Lepooze);
SINGLE_ANIMATION(Lepooze);

PLACEHOLDER_ANIM_SINGLE_FRAME(Flubunny);
SINGLE_ANIMATION(Flubunny);

PLACEHOLDER_ANIM_SINGLE_FRAME(Disbeary);
SINGLE_ANIMATION(Disbeary);

PLACEHOLDER_ANIM_SINGLE_FRAME(DisbearyEbil);
SINGLE_ANIMATION(DisbearyEbil);

PLACEHOLDER_ANIM_SINGLE_FRAME(Berfgoyle);
SINGLE_ANIMATION(Berfgoyle);

PLACEHOLDER_ANIM_SINGLE_FRAME(Bretkhelm);
SINGLE_ANIMATION(Bretkhelm);

PLACEHOLDER_ANIM_SINGLE_FRAME(Tadpoison);
SINGLE_ANIMATION(Tadpoison);

PLACEHOLDER_ANIM_SINGLE_FRAME(Afloof);
SINGLE_ANIMATION(Afloof);

PLACEHOLDER_ANIM_SINGLE_FRAME(Ulmiraint);
SINGLE_ANIMATION(Ulmiraint);

PLACEHOLDER_ANIM_SINGLE_FRAME(UlmiraintGrass);
SINGLE_ANIMATION(UlmiraintGrass);

PLACEHOLDER_ANIM_SINGLE_FRAME(UlmiraintDark);
SINGLE_ANIMATION(UlmiraintDark);

PLACEHOLDER_ANIM_SINGLE_FRAME(UlmiraintSteel);
SINGLE_ANIMATION(UlmiraintSteel);

PLACEHOLDER_ANIM_SINGLE_FRAME(UlmiraintDragon);
SINGLE_ANIMATION(UlmiraintDragon);

PLACEHOLDER_ANIM_SINGLE_FRAME(UlmiraintIce);
SINGLE_ANIMATION(UlmiraintIce);

PLACEHOLDER_ANIM_SINGLE_FRAME(UlmiraintGhost);
SINGLE_ANIMATION(UlmiraintGhost);

PLACEHOLDER_ANIM_SINGLE_FRAME(UlmiraintPsychic);
SINGLE_ANIMATION(UlmiraintPsychic);

PLACEHOLDER_ANIM_SINGLE_FRAME(UlmiraintPoison);
SINGLE_ANIMATION(UlmiraintPoison);

PLACEHOLDER_ANIM_SINGLE_FRAME(UlmiraintFighting);
SINGLE_ANIMATION(UlmiraintFighting);

PLACEHOLDER_ANIM_SINGLE_FRAME(UlmiraintFairy);
SINGLE_ANIMATION(UlmiraintFairy);

PLACEHOLDER_ANIM_SINGLE_FRAME(UlmiraintGround);
SINGLE_ANIMATION(UlmiraintGround);

PLACEHOLDER_ANIM_SINGLE_FRAME(UlmiraintRock);
SINGLE_ANIMATION(UlmiraintRock);

PLACEHOLDER_ANIM_SINGLE_FRAME(UlmiraintFlying);
SINGLE_ANIMATION(UlmiraintFlying);

PLACEHOLDER_ANIM_SINGLE_FRAME(UlmiraintBug);
SINGLE_ANIMATION(UlmiraintBug);

PLACEHOLDER_ANIM_SINGLE_FRAME(UlmiraintElectric);
SINGLE_ANIMATION(UlmiraintElectric);

PLACEHOLDER_ANIM_SINGLE_FRAME(UlmiraintWater);
SINGLE_ANIMATION(UlmiraintWater);

PLACEHOLDER_ANIM_SINGLE_FRAME(UlmiraintFire);
SINGLE_ANIMATION(UlmiraintFire);

PLACEHOLDER_ANIM_SINGLE_FRAME(Cofferule);
SINGLE_ANIMATION(Cofferule);

PLACEHOLDER_ANIM_SINGLE_FRAME(Sabsute);
SINGLE_ANIMATION(Sabsute);

PLACEHOLDER_ANIM_SINGLE_FRAME(Dollghost);
SINGLE_ANIMATION(Dollghost);

PLACEHOLDER_ANIM_SINGLE_FRAME(Knitten);
SINGLE_ANIMATION(Knitten);

PLACEHOLDER_ANIM_SINGLE_FRAME(Simionach);
SINGLE_ANIMATION(Simionach);

PLACEHOLDER_ANIM_SINGLE_FRAME(SimionachZen);
SINGLE_ANIMATION(SimionachZen);

PLACEHOLDER_ANIM_SINGLE_FRAME(Guertenity);
SINGLE_ANIMATION(Guertenity);

PLACEHOLDER_ANIM_SINGLE_FRAME(Emojinn);
SINGLE_ANIMATION(Emojinn);

PLACEHOLDER_ANIM_SINGLE_FRAME(EmojinnJoyful);
SINGLE_ANIMATION(EmojinnJoyful);

PLACEHOLDER_ANIM_SINGLE_FRAME(EmojinnSobbing);
SINGLE_ANIMATION(EmojinnSobbing);

PLACEHOLDER_ANIM_SINGLE_FRAME(EmojinnRaging);
SINGLE_ANIMATION(EmojinnRaging);

PLACEHOLDER_ANIM_SINGLE_FRAME(Loituma);
SINGLE_ANIMATION(Loituma);

PLACEHOLDER_ANIM_SINGLE_FRAME(Towhorse);
SINGLE_ANIMATION(Towhorse);

PLACEHOLDER_ANIM_SINGLE_FRAME(Canvellia);
SINGLE_ANIMATION(Canvellia);

PLACEHOLDER_ANIM_SINGLE_FRAME(Fabrinnial);
SINGLE_ANIMATION(Fabrinnial);

PLACEHOLDER_ANIM_SINGLE_FRAME(Oryugami);
SINGLE_ANIMATION(Oryugami);

PLACEHOLDER_ANIM_SINGLE_FRAME(Fractyvern);
SINGLE_ANIMATION(Fractyvern);

PLACEHOLDER_ANIM_SINGLE_FRAME(Moyalith);
SINGLE_ANIMATION(Moyalith);

PLACEHOLDER_ANIM_SINGLE_FRAME(Ganglython);
SINGLE_ANIMATION(Ganglython);

PLACEHOLDER_ANIM_SINGLE_FRAME(Moblin);
SINGLE_ANIMATION(Moblin);

PLACEHOLDER_ANIM_SINGLE_FRAME(Fangster);
SINGLE_ANIMATION(Fangster);

PLACEHOLDER_ANIM_SINGLE_FRAME(Mafiadon);
SINGLE_ANIMATION(Mafiadon);

PLACEHOLDER_ANIM_SINGLE_FRAME(Hookling);
SINGLE_ANIMATION(Hookling);

PLACEHOLDER_ANIM_SINGLE_FRAME(Cirnumiru);
SINGLE_ANIMATION(Cirnumiru);

PLACEHOLDER_ANIM_SINGLE_FRAME(Mogumole);
SINGLE_ANIMATION(Mogumole);

PLACEHOLDER_ANIM_SINGLE_FRAME(Triderling);
SINGLE_ANIMATION(Triderling);

PLACEHOLDER_ANIM_SINGLE_FRAME(Tarantagon);
SINGLE_ANIMATION(Tarantagon);

PLACEHOLDER_ANIM_SINGLE_FRAME(Konekoth);
SINGLE_ANIMATION(Konekoth);

PLACEHOLDER_ANIM_SINGLE_FRAME(Grumpoon);
SINGLE_ANIMATION(Grumpoon);

PLACEHOLDER_ANIM_SINGLE_FRAME(Larvitty);
SINGLE_ANIMATION(Larvitty);

PLACEHOLDER_ANIM_SINGLE_FRAME(Vriskeleton);
SINGLE_ANIMATION(Vriskeleton);

PLACEHOLDER_ANIM_SINGLE_FRAME(Shroomag);
SINGLE_ANIMATION(Shroomag);

PLACEHOLDER_ANIM_SINGLE_FRAME(Fungnet);
SINGLE_ANIMATION(Fungnet);

PLACEHOLDER_ANIM_SINGLE_FRAME(Fleurrium);
SINGLE_ANIMATION(Fleurrium);

PLACEHOLDER_ANIM_SINGLE_FRAME(Cristanium);
SINGLE_ANIMATION(Cristanium);

PLACEHOLDER_ANIM_SINGLE_FRAME(Vanitwin);
SINGLE_ANIMATION(Vanitwin);

PLACEHOLDER_ANIM_SINGLE_FRAME(VanitwinFemale);
SINGLE_ANIMATION(VanitwinFemale);

PLACEHOLDER_ANIM_SINGLE_FRAME(Yardstein);
SINGLE_ANIMATION(Yardstein);

PLACEHOLDER_ANIM_SINGLE_FRAME(Monkite);
SINGLE_ANIMATION(Monkite);

PLACEHOLDER_ANIM_SINGLE_FRAME(Konglide);
SINGLE_ANIMATION(Konglide);

PLACEHOLDER_ANIM_SINGLE_FRAME(Yokite);
SINGLE_ANIMATION(Yokite);

PLACEHOLDER_ANIM_SINGLE_FRAME(Displacerk);
SINGLE_ANIMATION(Displacerk);

PLACEHOLDER_ANIM_SINGLE_FRAME(Floribel);
SINGLE_ANIMATION(Floribel);

PLACEHOLDER_ANIM_SINGLE_FRAME(Mogeria);
SINGLE_ANIMATION(Mogeria);

PLACEHOLDER_ANIM_SINGLE_FRAME(Juankey);
SINGLE_ANIMATION(Juankey);

PLACEHOLDER_ANIM_SINGLE_FRAME(Equuan);
SINGLE_ANIMATION(Equuan);

PLACEHOLDER_ANIM_SINGLE_FRAME(Kiwi);
SINGLE_ANIMATION(Kiwi);

PLACEHOLDER_ANIM_SINGLE_FRAME(Iwik);
SINGLE_ANIMATION(Iwik);

PLACEHOLDER_ANIM_SINGLE_FRAME(Hybrotamus);
SINGLE_ANIMATION(Hybrotamus);

PLACEHOLDER_ANIM_SINGLE_FRAME(Commutant);
SINGLE_ANIMATION(Commutant);

PLACEHOLDER_ANIM_SINGLE_FRAME(Pascal);
SINGLE_ANIMATION(Pascal);

PLACEHOLDER_ANIM_SINGLE_FRAME(Korokami);
SINGLE_ANIMATION(Korokami);

PLACEHOLDER_ANIM_SINGLE_FRAME(Flockarrion);
SINGLE_ANIMATION(Flockarrion);

PLACEHOLDER_ANIM_SINGLE_FRAME(Sepulture);
SINGLE_ANIMATION(Sepulture);

PLACEHOLDER_ANIM_SINGLE_FRAME(Burnugget);
SINGLE_ANIMATION(Burnugget);

PLACEHOLDER_ANIM_SINGLE_FRAME(Flarhea);
SINGLE_ANIMATION(Flarhea);

PLACEHOLDER_ANIM_SINGLE_FRAME(Vinebomb);
SINGLE_ANIMATION(Vinebomb);

PLACEHOLDER_ANIM_SINGLE_FRAME(Ramboom);
SINGLE_ANIMATION(Ramboom);

PLACEHOLDER_ANIM_SINGLE_FRAME(Vinedup);
SINGLE_ANIMATION(Vinedup);

PLACEHOLDER_ANIM_SINGLE_FRAME(Helmata);
SINGLE_ANIMATION(Helmata);

PLACEHOLDER_ANIM_SINGLE_FRAME(Punkuyu);
SINGLE_ANIMATION(Punkuyu);

PLACEHOLDER_ANIM_SINGLE_FRAME(Chamelee);
SINGLE_ANIMATION(Chamelee);

PLACEHOLDER_ANIM_SINGLE_FRAME(Bubbasaur);
SINGLE_ANIMATION(Bubbasaur);

PLACEHOLDER_ANIM_SINGLE_FRAME(Bungaloon);
SINGLE_ANIMATION(Bungaloon);

PLACEHOLDER_ANIM_SINGLE_FRAME(Bitteragon);
SINGLE_ANIMATION(Bitteragon);

PLACEHOLDER_ANIM_SINGLE_FRAME(Wycern);
SINGLE_ANIMATION(Wycern);

PLACEHOLDER_ANIM_SINGLE_FRAME(Firvid);
SINGLE_ANIMATION(Firvid);

PLACEHOLDER_ANIM_SINGLE_FRAME(Cholefir);
SINGLE_ANIMATION(Cholefir);

PLACEHOLDER_ANIM_SINGLE_FRAME(Sparmor);
SINGLE_ANIMATION(Sparmor);

PLACEHOLDER_ANIM_SINGLE_FRAME(Ohmadillo);
SINGLE_ANIMATION(Ohmadillo);

PLACEHOLDER_ANIM_SINGLE_FRAME(Colombolt);
SINGLE_ANIMATION(Colombolt);

PLACEHOLDER_ANIM_SINGLE_FRAME(Pillaia);
SINGLE_ANIMATION(Pillaia);

PLACEHOLDER_ANIM_SINGLE_FRAME(Voltocor);
SINGLE_ANIMATION(Voltocor);

PLACEHOLDER_ANIM_SINGLE_FRAME(Volbrat);
SINGLE_ANIMATION(Volbrat);

PLACEHOLDER_ANIM_SINGLE_FRAME(Voliath);
SINGLE_ANIMATION(Voliath);

PLACEHOLDER_ANIM_SINGLE_FRAME(Meower);
SINGLE_ANIMATION(Meower);

PLACEHOLDER_ANIM_SINGLE_FRAME(Catation);
SINGLE_ANIMATION(Catation);

PLACEHOLDER_ANIM_SINGLE_FRAME(Erochre);
SINGLE_ANIMATION(Erochre);

PLACEHOLDER_ANIM_SINGLE_FRAME(Pedestone);
SINGLE_ANIMATION(Pedestone);

PLACEHOLDER_ANIM_SINGLE_FRAME(Inkrow);
SINGLE_ANIMATION(Inkrow);

PLACEHOLDER_ANIM_SINGLE_FRAME(Liquill);
SINGLE_ANIMATION(Liquill);

PLACEHOLDER_ANIM_SINGLE_FRAME(Ravarnish);
SINGLE_ANIMATION(Ravarnish);

PLACEHOLDER_ANIM_SINGLE_FRAME(Shiribiko);
SINGLE_ANIMATION(Shiribiko);

PLACEHOLDER_ANIM_SINGLE_FRAME(ShiribikoUltra);
SINGLE_ANIMATION(ShiribikoUltra);

PLACEHOLDER_ANIM_SINGLE_FRAME(Schizstarf);
SINGLE_ANIMATION(Schizstarf);

PLACEHOLDER_ANIM_SINGLE_FRAME(Wawho);
SINGLE_ANIMATION(Wawho);

PLACEHOLDER_ANIM_SINGLE_FRAME(Phamothom);
SINGLE_ANIMATION(Phamothom);

PLACEHOLDER_ANIM_SINGLE_FRAME(Magghost);
SINGLE_ANIMATION(Magghost);

PLACEHOLDER_ANIM_SINGLE_FRAME(Coccurn);
SINGLE_ANIMATION(Coccurn);

PLACEHOLDER_ANIM_SINGLE_FRAME(Permaceros);
SINGLE_ANIMATION(Permaceros);

PLACEHOLDER_ANIM_SINGLE_FRAME(Maleentis);
SINGLE_ANIMATION(Maleentis);

PLACEHOLDER_ANIM_SINGLE_FRAME(Walkalack);
SINGLE_ANIMATION(Walkalack);

PLACEHOLDER_ANIM_SINGLE_FRAME(Belieech);
SINGLE_ANIMATION(Belieech);

PLACEHOLDER_ANIM_SINGLE_FRAME(Medusith);
SINGLE_ANIMATION(Medusith);

PLACEHOLDER_ANIM_SINGLE_FRAME(Sycosect);
SINGLE_ANIMATION(Sycosect);

PLACEHOLDER_ANIM_SINGLE_FRAME(Swinggle);
SINGLE_ANIMATION(Swinggle);

PLACEHOLDER_ANIM_SINGLE_FRAME(Substrale);
SINGLE_ANIMATION(Substrale);

PLACEHOLDER_ANIM_SINGLE_FRAME(Triactite);
SINGLE_ANIMATION(Triactite);

PLACEHOLDER_ANIM_SINGLE_FRAME(Kaquapo);
SINGLE_ANIMATION(Kaquapo);

PLACEHOLDER_ANIM_SINGLE_FRAME(Airuite);
SINGLE_ANIMATION(Airuite);

PLACEHOLDER_ANIM_SINGLE_FRAME(Ghastropod);
SINGLE_ANIMATION(Ghastropod);

PLACEHOLDER_ANIM_SINGLE_FRAME(Onusalt);
SINGLE_ANIMATION(Onusalt);

PLACEHOLDER_ANIM_SINGLE_FRAME(Piurette);
SINGLE_ANIMATION(Piurette);

PLACEHOLDER_ANIM_SINGLE_FRAME(Polybrawn);
SINGLE_ANIMATION(Polybrawn);

PLACEHOLDER_ANIM_SINGLE_FRAME(PolybrawnH);
SINGLE_ANIMATION(PolybrawnH);

PLACEHOLDER_ANIM_SINGLE_FRAME(PolybrawnW);
SINGLE_ANIMATION(PolybrawnW);

PLACEHOLDER_ANIM_SINGLE_FRAME(PolybrawnP);
SINGLE_ANIMATION(PolybrawnP);

PLACEHOLDER_ANIM_SINGLE_FRAME(PolybrawnI);
SINGLE_ANIMATION(PolybrawnI);

PLACEHOLDER_ANIM_SINGLE_FRAME(PolybrawnK);
SINGLE_ANIMATION(PolybrawnK);

PLACEHOLDER_ANIM_SINGLE_FRAME(Ankhurah);
SINGLE_ANIMATION(Ankhurah);

PLACEHOLDER_ANIM_SINGLE_FRAME(Ankhpu);
SINGLE_ANIMATION(Ankhpu);

PLACEHOLDER_ANIM_SINGLE_FRAME(Ankhira);
SINGLE_ANIMATION(Ankhira);

PLACEHOLDER_ANIM_SINGLE_FRAME(Copolar);
SINGLE_ANIMATION(Copolar);

PLACEHOLDER_ANIM_SINGLE_FRAME(CopolarFemale);
SINGLE_ANIMATION(CopolarFemale);

PLACEHOLDER_ANIM_SINGLE_FRAME(Pechit);
SINGLE_ANIMATION(Pechit);

PLACEHOLDER_ANIM_SINGLE_FRAME(Pegui);
SINGLE_ANIMATION(Pegui);

PLACEHOLDER_ANIM_SINGLE_FRAME(Skubmarine);
SINGLE_ANIMATION(Skubmarine);

PLACEHOLDER_ANIM_SINGLE_FRAME(SkubmarinePro);
SINGLE_ANIMATION(SkubmarinePro);

PLACEHOLDER_ANIM_SINGLE_FRAME(Skuba);
SINGLE_ANIMATION(Skuba);

PLACEHOLDER_ANIM_SINGLE_FRAME(SkubaPro);
SINGLE_ANIMATION(SkubaPro);

PLACEHOLDER_ANIM_SINGLE_FRAME(Sherifuego);
SINGLE_ANIMATION(Sherifuego);

PLACEHOLDER_ANIM_SINGLE_FRAME(Picantero);
SINGLE_ANIMATION(Picantero);

PLACEHOLDER_ANIM_SINGLE_FRAME(Frijolero);
SINGLE_ANIMATION(Frijolero);

PLACEHOLDER_ANIM_SINGLE_FRAME(Rootchew);
SINGLE_ANIMATION(Rootchew);

PLACEHOLDER_ANIM_SINGLE_FRAME(Toofgrew);
SINGLE_ANIMATION(Toofgrew);

PLACEHOLDER_ANIM_SINGLE_FRAME(Hognaw);
SINGLE_ANIMATION(Hognaw);

PLACEHOLDER_ANIM_SINGLE_FRAME(Primiteve);
SINGLE_ANIMATION(Primiteve);

PLACEHOLDER_ANIM_SINGLE_FRAME(Primitool);
SINGLE_ANIMATION(Primitool);

PLACEHOLDER_ANIM_SINGLE_FRAME(Kramberry);
SINGLE_ANIMATION(Kramberry);

PLACEHOLDER_ANIM_SINGLE_FRAME(Fettorch);
SINGLE_ANIMATION(Fettorch);

PLACEHOLDER_ANIM_SINGLE_FRAME(Manicle);
SINGLE_ANIMATION(Manicle);

PLACEHOLDER_ANIM_SINGLE_FRAME(Smogars);
SINGLE_ANIMATION(Smogars);

PLACEHOLDER_ANIM_SINGLE_FRAME(Dogan);
SINGLE_ANIMATION(Dogan);

PLACEHOLDER_ANIM_SINGLE_FRAME(Vergilion);
SINGLE_ANIMATION(Vergilion);

PLACEHOLDER_ANIM_SINGLE_FRAME(Devante);
SINGLE_ANIMATION(Devante);

PLACEHOLDER_ANIM_SINGLE_FRAME(Leopawn);
SINGLE_ANIMATION(Leopawn);

PLACEHOLDER_ANIM_SINGLE_FRAME(Braxitytan);
SINGLE_ANIMATION(Braxitytan);

PLACEHOLDER_ANIM_SINGLE_FRAME(Tunghaska);
SINGLE_ANIMATION(Tunghaska);

PLACEHOLDER_ANIM_SINGLE_FRAME(Meatier);
SINGLE_ANIMATION(Meatier);

PLACEHOLDER_ANIM_SINGLE_FRAME(Kaustikrok);
SINGLE_ANIMATION(Kaustikrok);

PLACEHOLDER_ANIM_SINGLE_FRAME(Envile);
SINGLE_ANIMATION(Envile);

PLACEHOLDER_ANIM_SINGLE_FRAME(Haarshogun);
SINGLE_ANIMATION(Haarshogun);

PLACEHOLDER_ANIM_SINGLE_FRAME(Vaponobi);
SINGLE_ANIMATION(Vaponobi);

PLACEHOLDER_ANIM_SINGLE_FRAME(Peasol);
SINGLE_ANIMATION(Peasol);

PLACEHOLDER_ANIM_SINGLE_FRAME(Eccosmic);
SINGLE_ANIMATION(Eccosmic);

PLACEHOLDER_ANIM_SINGLE_FRAME(EccosmicMagellanic);
SINGLE_ANIMATION(EccosmicMagellanic);

PLACEHOLDER_ANIM_SINGLE_FRAME(EccosmicSol);
SINGLE_ANIMATION(EccosmicSol);

PLACEHOLDER_ANIM_SINGLE_FRAME(EccosmicStarburst);
SINGLE_ANIMATION(EccosmicStarburst);

PLACEHOLDER_ANIM_SINGLE_FRAME(EccosmicQuasar);
SINGLE_ANIMATION(EccosmicQuasar);

PLACEHOLDER_ANIM_SINGLE_FRAME(EccosmicNebula);
SINGLE_ANIMATION(EccosmicNebula);

PLACEHOLDER_ANIM_SINGLE_FRAME(EccosmicMilky);
SINGLE_ANIMATION(EccosmicMilky);

PLACEHOLDER_ANIM_SINGLE_FRAME(Nebulite);
SINGLE_ANIMATION(Nebulite);

PLACEHOLDER_ANIM_SINGLE_FRAME(NebuliteMagellanic);
SINGLE_ANIMATION(NebuliteMagellanic);

PLACEHOLDER_ANIM_SINGLE_FRAME(NebuliteSol);
SINGLE_ANIMATION(NebuliteSol);

PLACEHOLDER_ANIM_SINGLE_FRAME(NebuliteStarburst);
SINGLE_ANIMATION(NebuliteStarburst);

PLACEHOLDER_ANIM_SINGLE_FRAME(NebuliteQuasar);
SINGLE_ANIMATION(NebuliteQuasar);

PLACEHOLDER_ANIM_SINGLE_FRAME(NebuliteNebula);
SINGLE_ANIMATION(NebuliteNebula);

PLACEHOLDER_ANIM_SINGLE_FRAME(NebuliteMilky);
SINGLE_ANIMATION(NebuliteMilky);

#if P_MEGA_EVOLUTIONS
PLACEHOLDER_ANIM_SINGLE_FRAME(CockenMega);
SINGLE_ANIMATION(CockenMega);
#endif //P_MEGA_EVOLUTIONS
