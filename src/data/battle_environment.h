...
static const struct {
    ...
    {MAP_BATTLE_SCENE_LEADER,   BATTLE_ENVIRONMENT_LEADER},
    {MAP_BATTLE_SCENE_WALLACE,  BATTLE_ENVIRONMENT_CHAMPION},
    {MAP_BATTLE_SCENE_GROUDON,  BATTLE_ENVIRONMENT_GROUDON},
    {MAP_BATTLE_SCENE_KYOGRE,   BATTLE_ENVIRONMENT_KYOGRE},
    {MAP_BATTLE_SCENE_RAYQUAZA, BATTLE_ENVIRONMENT_RAYQUAZA}
};
