...
const u32 gTrainerFrontPic_ProfessorBirch[] = INCBIN_U32("graphics/trainers/front_pics/PROF_BIRCH.img.bin");
const u32 gTrainerPalette_ProfessorBirch[] = INCBIN_U32("graphics/trainers/front_pics/PROF_BIRCH.pal.bin");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_BIRCH, gTrainerFrontPic_ProfessorBirch, gTrainerPalette_ProfessorBirch)
};
