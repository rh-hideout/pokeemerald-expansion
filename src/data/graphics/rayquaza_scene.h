...
const u32 gRaySceneCharges_Streaks_Gfx[]      = INCGFX_U32("graphics/rayquaza_scene/scene_4/streaks.png", ".4bpp.smol");
const u32 gRaySceneCharges_Streaks_Tilemap[]  = INCBIN_U32("graphics/rayquaza_scene/scene_4/streaks.bin.smolTM");
const u32 gRaySceneCharges_Rayquaza_Gfx[]     = INCGFX_U32("graphics/rayquaza_scene/scene_4/rayquaza.png", ".4bpp.smol");
