...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_KARATE_CHOP] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = 50,
        .type = B_UPDATED_MOVE_DATA >= GEN_2 ? TYPE_FIGHTING : TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_GUST] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = 40,
        .type = B_UPDATED_MOVE_DATA >= GEN_2 ? TYPE_FLYING : TYPE_NORMAL,
        .accuracy = 100,
        .pp = 35,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_SAND_ATTACK] =
    {
        ...
        .power = 0,
        .type = B_UPDATED_MOVE_DATA >= GEN_2 ? TYPE_GROUND : TYPE_NORMAL,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_LEECH_SEED] =
    {
        ...
        .category = DAMAGE_CATEGORY_STATUS,
        .zMove = { .effect = Z_EFFECT_RESET_STATS },
        .ignoresSubstitute = B_UPDATED_MOVE_FLAGS == GEN_1,
        .magicCoatAffected = TRUE,
