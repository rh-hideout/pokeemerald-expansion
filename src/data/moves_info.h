...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_DIG] =
    {
        ...
        .effect = EFFECT_SEMI_INVULNERABLE,
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 90 : 60, //90 : 60
        .type = TYPE_GROUND,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_SEARING_BLAST] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("SearingBlast"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PIERCING_JET] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Piercing Jet"),
        .description = COMPOUND_STRING(
            "A aquatic beam that\n"
            "ignores abilities."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_LEAF_SHURIKEN] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("LeafShuriken"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CANNONBALL] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Cannonball"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BLIGHT] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Blight"),
        .description = COMPOUND_STRING(
            "Absorbs half the damage\n"
    ...
    [MOVE_CORROSHOT] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Corro-shot"),
        .description = COMPOUND_STRING(
            "A corrosive bolt\n"
            "that may badly poison."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_COLOSSAL_FLARE] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Colossal Flare"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SNOWSEAR_STORM] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Snowsear Storm"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TURBULENT_DIVE] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Turbulent Dive"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GIGATON_PUNCH] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Gigaton Punch"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STEEL_ROT] =
    {
        ...
        .effect = EFFECT_SUPER_EFFECTIVE_STEEL,
        .power = 70,
        .type = TYPE_POISON,
        .accuracy = 100,
        .pp = 20,
    ...
    [MOVE_LUMINSPHERE] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Luminsphere"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BARRICADE] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Barricade"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CHEMBOOST] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Chem-boost"),
        .description = COMPOUND_STRING(
            "The user uses some of its\n"
            "HP to raise all its stats."),
        .effect = EFFECT_CLANGOROUS_SOUL,
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Hydroshot", "Hydroshot Flurry"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAGNET_PUNCH] =
    {
        ...
        .effect = EFFECT_SUPER_EFFECTIVE_ELECTRIC,
        .power = 70,
        .type = TYPE_STEEL,
        .accuracy = 100,
        .pp = 20,
    ...
    [MOVE_MYTHIC_CLAW] =
    {
        ...
        .effect = EFFECT_SUPER_EFFECTIVE_FAIRY,
        .power = 70,
        .type = TYPE_DRAGON,
        .accuracy = 100,
        .pp = 20,
