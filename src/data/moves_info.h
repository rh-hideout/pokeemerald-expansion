...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_FORESIGHT] =
    {
        ...
        .description = sForesightDescription,
    ...
    [MOVE_SHEER_COLD] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Causes fainting. Unlikely\n"
            "to hit if user isn't Ice. "),
        #else
            "A chilling attack that\n"
