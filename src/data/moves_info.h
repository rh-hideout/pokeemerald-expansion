...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_TELEPORT] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "The user switches out. Also\n"
            "can warp to the last Center."),
        #else
    ...
    [MOVE_GLITZY_GLOW] =
    {
        ...
        .description = COMPOUND_STRING(
            "Force puts up a wall,\n"
            "weakening special moves."),
        .effect = EFFECT_HIT,
