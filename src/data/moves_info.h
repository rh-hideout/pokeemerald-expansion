...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_ROCKET_PUNCH] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Rocket Punch"),
        .description = COMPOUND_STRING(
            "Hits hard and first.\n"
            "Only works first turn."),
        .effect = EFFECT_FIRST_TURN_ONLY,
    ...
    [MOVE_SHADOW_SCALES] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("ShadowScales", "Shadow Scales"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CHAOS_DUNK] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Chaos Dunk"),
        .description = COMPOUND_STRING(
            "A cosmic dunk that\n"
            "dunks the opponent."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_BRUTAL_PUNISHMENT] =
    {
        ...
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .metronomeBanned = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({ //GTODO: Make a proper battle script for increasing both attack and special attack simultaniously
            .moveEffect = MOVE_EFFECT_ATK_PLUS_1,
            .self = TRUE,
            .chance = 100,
        },
