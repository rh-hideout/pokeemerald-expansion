...
const u16 gMetatiles_gTileset_Ekat[] = INCBIN_U16("data/tilesets/secondary/ekat/metatiles.bin");
const u16 gMetatileAttributes_gTileset_Ekat[] = INCBIN_U16("data/tilesets/secondary/ekat/metatile_attributes.bin");
