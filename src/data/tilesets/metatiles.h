...
const u16 gMetatiles_Tester[] = INCBIN_U16("data/tilesets/primary/tester/metatiles.bin");
const u16 gMetatileAttributes_Tester[] = INCBIN_U16("data/tilesets/primary/tester/metatile_attributes.bin");
