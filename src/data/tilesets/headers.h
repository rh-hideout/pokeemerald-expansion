...
const struct Tileset gTileset_BuildingFrlg =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_BuildingFrlg,
    .palettes = gTilesetPalettes_BuildingFrlg,
    .metatiles = gMetatiles_BuildingFrlg,
    .metatileAttributes = gMetatileAttributes_BuildingFrlg,
    .callback = NULL,
};
