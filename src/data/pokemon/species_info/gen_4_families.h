...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_TORTERRA] =
    {
        ...
        .baseSpAttack  = 75,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_PLANT, TYPE_EARTH),
        .catchRate = 45,
    ...
    [SPECIES_EMPOLEON] =
    {
        ...
        .baseSpAttack  = 111,
        .baseSpDefense = 101,
        .types = MON_TYPES(TYPE_WATER, TYPE_MACHINE),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 265,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_BIBAREL] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_NULL, TYPE_WATER),
        .catchRate = 127,
    ...
    [SPECIES_WORMADAM_PLANT] =
    {
        ...
        .baseSpAttack  = 79,
        .baseSpDefense = 105,
        .types = MON_TYPES(TYPE_INSECT, TYPE_PLANT),
        .catchRate = 45,
    ...
    [SPECIES_WORMADAM_TRASH] =
    {
        ...
        .baseSpAttack  = 69,
        .baseSpDefense = 95,
        .types = MON_TYPES(TYPE_INSECT, TYPE_MACHINE),
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 148 : 159,
        .evYield_Defense = 1,
        .evYield_SpDefense = 1,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_STUNKY] =
    {
        ...
        .baseSpAttack  = 41,
        .baseSpDefense = 41,
        .types = MON_TYPES(TYPE_FILTH, TYPE_DARK),
        .catchRate = 225,
    ...
    [SPECIES_SPIRITOMB] =
    {
        ...
        .baseSpAttack  = 92,
        .baseSpDefense = 108,
        .types = MON_TYPES(TYPE_UNDEAD, TYPE_DARK),
        .catchRate = 100,
    ...
    [SPECIES_LUCARIO] =
    {
        ...
        .baseSpAttack  = 115,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_COMBAT, TYPE_MACHINE),
        .catchRate = 45,
    ...
    [SPECIES_SKORUPI] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 55,
        .types = MON_TYPES(TYPE_FILTH, TYPE_INSECT),
        .catchRate = 120,
    ...
    [SPECIES_SNOVER] =
    {
        ...
        .baseSpAttack  = 62,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_PLANT, TYPE_ICE),
        .catchRate = 120,
    ...
    [SPECIES_ROTOM] =
    {
        ...
        .baseSpAttack  = 95,
        .baseSpDefense = 77,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_UNDEAD),
        .catchRate = 45,
    ...
    [SPECIES_ROTOM_MOW] =
    {
        ...
        .baseSpAttack  = 105,
        .baseSpDefense = 107,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_PLANT),
        .catchRate = 45,
        .expYield = ROTOM_APPLIANCE_EXP_YIELD,
        .evYield_Speed = 1,
        .evYield_SpAttack = 1,
    ...
    [SPECIES_DIALGA] =
    {
        ...
        .baseSpAttack  = 150,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_MACHINE, TYPE_DRAGON),
        .catchRate = 3,
    ...
    [SPECIES_HEATRAN] =
    {
        ...
        .baseSpAttack  = 130,
        .baseSpDefense = 106,
        .types = MON_TYPES(TYPE_FIRE, TYPE_MACHINE),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
...
#define ARCEUS_SPECIES_INFO(type, typeName, iconPal)                                \
    ...
    [SPECIES_ARCEUS_NORMAL]   = ARCEUS_SPECIES_INFO(TYPE_NULL,   Normal,   1),
    [SPECIES_ARCEUS_FIGHTING] = ARCEUS_SPECIES_INFO(TYPE_COMBAT, Fighting, 1),
    [SPECIES_ARCEUS_FLYING]   = ARCEUS_SPECIES_INFO(TYPE_WIND,   Flying,   2),
    [SPECIES_ARCEUS_POISON]   = ARCEUS_SPECIES_INFO(TYPE_FILTH,   Poison,   2),
    [SPECIES_ARCEUS_GROUND]   = ARCEUS_SPECIES_INFO(TYPE_EARTH,   Ground,   1),
    [SPECIES_ARCEUS_ROCK]     = ARCEUS_SPECIES_INFO(TYPE_BEAST,     Rock,     2),
    [SPECIES_ARCEUS_BUG]      = ARCEUS_SPECIES_INFO(TYPE_INSECT,      Bug,      1),
    [SPECIES_ARCEUS_GHOST]    = ARCEUS_SPECIES_INFO(TYPE_UNDEAD,    Ghost,    2),
    [SPECIES_ARCEUS_STEEL]    = ARCEUS_SPECIES_INFO(TYPE_MACHINE,    Steel,    0),
    [SPECIES_ARCEUS_FIRE]     = ARCEUS_SPECIES_INFO(TYPE_FIRE,     Fire,     0),
    [SPECIES_ARCEUS_WATER]    = ARCEUS_SPECIES_INFO(TYPE_WATER,    Water,    0),
    [SPECIES_ARCEUS_GRASS]    = ARCEUS_SPECIES_INFO(TYPE_PLANT,    Grass,    1),
    ...
    [SPECIES_ARCEUS_FAIRY]    = ARCEUS_SPECIES_INFO(TYPE_PUPPET,    Fairy,    0),
