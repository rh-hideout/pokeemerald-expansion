...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_CHIMCHAR] =
    {
        ...
        .abilities  = {ABILITY_BLAZE, ABILITY_IRON_FIST, ABILITY_LIBERO},
    ...
    [SPECIES_KRICKETOT] =
    {
        ...
        .abilities = { ABILITY_SHED_SKIN, ABILITY_SOUNDPROOF, ABILITY_PARROT },
    ...
    [SPECIES_SHINX] =
    {
        ...
        .abilities  = {ABILITY_INTIMIDATE, ABILITY_DAZZLING, ABILITY_ELECTRIC_SURGE},
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Shinx"),
        .cryId = CRY_SHINX,
    ...
    [SPECIES_SHIELDON] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities  = {ABILITY_STURDY, ABILITY_MIRROR_ARMOR, ABILITY_HEAVY_METAL},
    ...
    [SPECIES_BURMY_PLANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = {ABILITY_MIMICRY, ABILITY_NONE, ABILITY_OVERCOAT},\
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Burmy"),
        .cryId = CRY_BURMY,
    ...
    [SPECIES_WORMADAM_PLANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities  = {ABILITY_GRASSY_SURGE, ABILITY_NONE, ABILITY_OVERCOAT},
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_WORMADAM_SANDY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities  = {ABILITY_SAND_FORCE, ABILITY_NONE, ABILITY_OVERCOAT},
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Wormadam"),
        .cryId = CRY_WORMADAM,
        .natDexNum = NATIONAL_DEX_WORMADAM,
    ...
    [SPECIES_WORMADAM_TRASH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = {ABILITY_STEELY_SPIRIT, ABILITY_NONE, ABILITY_OVERCOAT},
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Wormadam"),
        .cryId = CRY_WORMADAM,
        .natDexNum = NATIONAL_DEX_WORMADAM,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_VESPIQUEN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_HONEY_GATHER, ABILITY_NONE, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_PACHIRISU] =
    {
        ...
        .abilities = {ABILITY_CHEEK_POUCH, ABILITY_GALVANIZE, ABILITY_VOLT_ABSORB},
    ...
    [SPECIES_CHERUBI] =
    {
        ...
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_NONE, ABILITY_SOLAR_POWER },
    ...
    [SPECIES_SHELLOS_WEST] =
    {
        ...
        .abilities = { ABILITY_GOOEY, ABILITY_STORM_DRAIN, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_BUNEARY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_RUN_AWAY, ABILITY_UNAWARE, ABILITY_LIMBER },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LOPUNNY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_UNAWARE, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PURUGLY] =
    {
        ...
        .types = MON_TYPES(TYPE_NORMAL),
        .catchRate = 75,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 223 : 223,
        .evYield_Speed = 2,
        .genderRatio = PERCENT_FEMALE(75),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_STUNKY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities  = {ABILITY_LINGERING_AROMA, ABILITY_AFTERMATH, ABILITY_NEUTRALIZING_GAS },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_CHATOT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_PARROT, ABILITY_NONE, ABILITY_TANGLED_FEET},
    ...
    [SPECIES_RIOLU] =
    {
        ...
        .abilities  = {ABILITY_STEADFAST, ABILITY_PRANKSTER, ABILITY_UNSEEN_FIST},
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Riolu"),
        .cryId = CRY_RIOLU,
    ...
    [SPECIES_LUCARIO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities  = {ABILITY_INNER_FOCUS, ABILITY_JUSTIFIED, ABILITY_UNSEEN_FIST},
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SKORUPI] =
    {
        ...
        .abilities = { ABILITY_TOXIC_DEBRIS, ABILITY_SNIPER, ABILITY_BATTLE_ARMOR },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_CARNIVINE] =
    {
        ...
        .abilities  = {ABILITY_CONSTRICTOR, ABILITY_STRONG_JAW, ABILITY_LEVITATE},
        .bodyColor = BODY_COLOR_GREEN,
