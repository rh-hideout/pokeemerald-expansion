...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_IVYSAUR] = //changed atk and spa
    {
        .baseHP        = 60,
        .baseAttack    = 80,
        .baseDefense   = 63,
    ...
    {
        .baseHP        = 80,
        .baseAttack    = 100,      //changed with spa
        .baseDefense   = 83,
        .baseSpeed     = 90,       //+10
        .baseSpAttack  = 82,       //changed with atk
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_GRASS, TYPE_POISON),
        .catchRate = 45,
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 85 : 65) //+10
    ...
    [SPECIES_MEWTWO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PROTEAN, ABILITY_ADAPTABILITY, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_PURPLE,
