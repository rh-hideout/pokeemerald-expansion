...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BULBASAUR] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_SUN_SOUL, ABILITY_THICK_FAT }, //will be given sunbathe
...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    [SPECIES_PARASECT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_GRASS),
        .abilities = { ABILITY_TERRAFORM, ABILITY_DRY_SKIN, ABILITY_DAMP },
        .bodyColor = BODY_COLOR_RED,
...
#define GOLEM_ATTACK (P_UPDATED_STATS >= GEN_6 ? 130 : 110) //+10
    ...
    [SPECIES_PONYTA_GALAR] =
    {
        ...
        .formSpeciesIdTable = sPonytaFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_RAPIDASH_GALARIAN}),    //40
    },
...
#define GENGAR_ABILITIES {ABILITY_CURSED_BODY, ABILITY_PRIDE}
#else
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_ELECTRODE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_LIGHTNING_ROD, ABILITY_STEELWORKER, ABILITY_AFTERMATH },
        .bodyColor = BODY_COLOR_RED,
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 85 : 65) //+10
    ...
    [SPECIES_CUBONE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_MAROWAK},
                                {EVO_ITEM, ITEM_DAWN_STONE, SPECIES_MAROWAK_ALOLAN},
    ...
    [SPECIES_MAROWAK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_LIGHTNING_ROD, ABILITY_BULLY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LICKITUNG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_SERENE_STRIKE, ABILITY_OBLIVIOUS },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_SEAKING] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_BULLY, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_RED,
