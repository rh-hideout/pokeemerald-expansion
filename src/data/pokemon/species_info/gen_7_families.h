...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_DARTRIX] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_DECIDUEYE, CONDITIONS({IF_NOT_REGION, POKEMON_REGION_HISUI})}
                            #if P_HISUIAN_FORMS
                                ,{EVO_LEVEL, 36, SPECIES_DECIDUEYE_HISUI, CONDITIONS({IF_REGION, POKEMON_REGION_HISUI})}
                            #endif
                            ),
    },
