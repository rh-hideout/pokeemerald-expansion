...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_TRUMBEAK] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "nuisance for its neighbours. It eats\n"
...
#if P_FAMILY_MINIOR
#define MINIOR_MISC_INFO(colour)                                             \
...
#define MINIOR_METEOR_SPECIES_INFO(Form)                    \
    {                                                       \
        ...
        MINIOR_MISC_INFO(BODY_COLOUR_BROWN),                 \
    }

#define MINIOR_CORE_SPECIES_INFO(Form, colour, iconPal)          \
    {                                                           \
        .baseHP        = 60,                                    \
        .baseAttack    = 100,                                   \
        .baseDefense   = 60,                                    \
    ...
    [SPECIES_MINIOR_CORE_RED]      = MINIOR_CORE_SPECIES_INFO(Red,    BODY_COLOUR_RED,    0),
    [SPECIES_MINIOR_CORE_ORANGE]   = MINIOR_CORE_SPECIES_INFO(Orange, BODY_COLOUR_RED,    0),
    [SPECIES_MINIOR_CORE_YELLOW]   = MINIOR_CORE_SPECIES_INFO(Yellow, BODY_COLOUR_YELLOW, 0),
    [SPECIES_MINIOR_CORE_GREEN]    = MINIOR_CORE_SPECIES_INFO(Green,  BODY_COLOUR_GREEN,  1),
    [SPECIES_MINIOR_CORE_BLUE]     = MINIOR_CORE_SPECIES_INFO(Blue,   BODY_COLOUR_BLUE,   0),
    [SPECIES_MINIOR_CORE_INDIGO]   = MINIOR_CORE_SPECIES_INFO(Indigo, BODY_COLOUR_BLUE,   0),
    [SPECIES_MINIOR_CORE_VIOLET]   = MINIOR_CORE_SPECIES_INFO(Violet, BODY_COLOUR_PURPLE, 2),
