...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_PRIMARINA] =
    {
        ...
        .baseSpAttack  = 126,
        .baseSpDefense = 116,
        .types = MON_TYPES(TYPE_WATER, TYPE_PUPPET),
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 265 : 239,
        .evYield_SpAttack = 3,
        .genderRatio = PERCENT_FEMALE(12.5),
    ...
    [SPECIES_CHARJABUG] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_INSECT, TYPE_ELECTRIC),
        .catchRate = 120,
        .expYield = 140,
        .evYield_Defense = 2,
    ...
    [SPECIES_CRABOMINABLE] =
    {
        ...
        .baseSpAttack  = 62,
        .baseSpDefense = 67,
        .types = MON_TYPES(TYPE_COMBAT, TYPE_ICE),
        .catchRate = 60,
        .expYield = 167,
        .evYield_Attack = 2,
    ...
    [SPECIES_ORICORIO_PAU] =
    {
        ...
        .baseSpAttack  = 98,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_WIND),
        .catchRate = 45,
        .expYield = 167,
        .evYield_SpAttack = 2,
    ...
    [SPECIES_CUTIEFLY] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 40,
        .types = MON_TYPES(TYPE_INSECT, TYPE_PUPPET),
        .catchRate = 190,
        .expYield = 61,
        .evYield_Speed = 1,
        .itemRare = ITEM_HONEY,
    ...
    [SPECIES_DEWPIDER] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 72,
        .types = MON_TYPES(TYPE_WATER, TYPE_INSECT),
        .catchRate = 200,
        .expYield = 54,
        .evYield_SpDefense = 1,
    ...
    [SPECIES_SALANDIT] =
    {
        ...
        .baseSpAttack  = 71,
        .baseSpDefense = 40,
        .types = MON_TYPES(TYPE_FILTH, TYPE_FIRE),
        .catchRate = 120,
        .expYield = 64,
        .evYield_Speed = 1,
    ...
    [SPECIES_STUFFUL] =
    {
        ...
        .baseSpAttack  = 45,
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_NULL, TYPE_COMBAT),
        .catchRate = 140,
        .expYield = 68,
        .evYield_Attack = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_ORANGURU] =
    {
        ...
        .baseSpAttack  = 90,
        .baseSpDefense = 110,
        .types = MON_TYPES(TYPE_NULL, TYPE_PSYCHIC),
        .catchRate = 45,
        .expYield = 172,
        .evYield_SpDefense = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_SANDYGAST] =
    {
        ...
        .baseSpAttack  = 70,
        .baseSpDefense = 45,
        .types = MON_TYPES(TYPE_UNDEAD, TYPE_EARTH),
        .catchRate = 140,
        .expYield = 64,
        .evYield_Defense = 1,
...
#define SILVALLY_SPECIES_INFO(type, _palette)                                       \
    ...
    [SPECIES_SILVALLY_NORMAL]   = SILVALLY_SPECIES_INFO(TYPE_NULL,   Normal),
    [SPECIES_SILVALLY_FIGHTING] = SILVALLY_SPECIES_INFO(TYPE_COMBAT, Fighting),
    [SPECIES_SILVALLY_FLYING]   = SILVALLY_SPECIES_INFO(TYPE_WIND,   Flying),
    [SPECIES_SILVALLY_POISON]   = SILVALLY_SPECIES_INFO(TYPE_FILTH,   Poison),
    [SPECIES_SILVALLY_GROUND]   = SILVALLY_SPECIES_INFO(TYPE_EARTH,   Ground),
    [SPECIES_SILVALLY_ROCK]     = SILVALLY_SPECIES_INFO(TYPE_BEAST,     Rock),
    [SPECIES_SILVALLY_BUG]      = SILVALLY_SPECIES_INFO(TYPE_INSECT,      Bug),
    [SPECIES_SILVALLY_GHOST]    = SILVALLY_SPECIES_INFO(TYPE_UNDEAD,    Ghost),
    [SPECIES_SILVALLY_STEEL]    = SILVALLY_SPECIES_INFO(TYPE_MACHINE,    Steel),
    [SPECIES_SILVALLY_FIRE]     = SILVALLY_SPECIES_INFO(TYPE_FIRE,     Fire),
    [SPECIES_SILVALLY_WATER]    = SILVALLY_SPECIES_INFO(TYPE_WATER,    Water),
    [SPECIES_SILVALLY_GRASS]    = SILVALLY_SPECIES_INFO(TYPE_PLANT,    Grass),
    ...
    [SPECIES_SILVALLY_FAIRY]    = SILVALLY_SPECIES_INFO(TYPE_PUPPET,    Fairy),
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_TOGEDEMARU] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 73,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_MACHINE),
        .catchRate = 180,
        .expYield = 152,
        .evYield_Attack = 2,
    ...
    [SPECIES_DRAMPA] =
    {
        ...
        .baseSpAttack  = 135,
        .baseSpDefense = 91,
        .types = MON_TYPES(TYPE_NULL, TYPE_DRAGON),
        .catchRate = 70,
        .expYield = 170,
        .evYield_SpAttack = 2,
    ...
    [SPECIES_HAKAMO_O] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_DRAGON, TYPE_COMBAT),
        .catchRate = 45,
        .expYield = 147,
        .evYield_Defense = 2,
        .itemRare = ITEM_RAZOR_CLAW,
    ...
    [SPECIES_TAPU_LELE] =
    {
        ...
        .baseSpAttack  = 130,
        .baseSpDefense = 115,
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_PUPPET),
        .catchRate = 3,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 285 : 257,
        .evYield_SpAttack = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_SOLGALEO] =
    {
        ...
        .baseSpAttack  = 113,
        .baseSpDefense = 89,
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_MACHINE),
        .catchRate = 45,
    ...
    [SPECIES_CELESTEELA] =
    {
        ...
        .baseSpAttack  = 107,
        .baseSpDefense = 101,
        .types = MON_TYPES(TYPE_MACHINE, TYPE_WIND),
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 285 : 257,
        .evYield_Attack = 1,
        .evYield_Defense = 1,
    ...
    [SPECIES_KARTANA] =
    {
        ...
        .baseSpAttack  = 59,
        .baseSpDefense = 31,
        .types = MON_TYPES(TYPE_PLANT, TYPE_MACHINE),
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 285 : 257,
        .evYield_Attack = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_MARSHADOW] =
    {
        ...
        .baseSpAttack  = 90,
        .baseSpDefense = 90,
        .types = MON_TYPES(TYPE_COMBAT, TYPE_UNDEAD),
        .catchRate = 3,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 300 : 270,
        .evYield_Attack = 2,
        .evYield_Speed = 1,
