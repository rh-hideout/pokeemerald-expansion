...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_DARTRIX] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_DECIDUEYE},
                                {EVO_ITEM, ITEM_SHINY_STONE, SPECIES_DECIDUEYE_HISUI}),
    },
    ...
    [SPECIES_LYCANROC_MIDNIGHT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_TOUGH_CLAWS, ABILITY_NO_GUARD },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Lycanroc"),
    ...
    [SPECIES_MORELULL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_ILLUMINATE, ABILITY_SWEET_VEIL, ABILITY_TRIAGE },
        .bodyColor = BODY_COLOR_PURPLE,
