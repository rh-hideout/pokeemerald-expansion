...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_ROWLET] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_BIG_PECKS, ABILITY_SNIPER },
    ...
    [SPECIES_POPPLIO] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_LIQUID_VOICE, ABILITY_GOOD_AS_GOLD },
    ...
    [SPECIES_TOUCANNON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_SKILL_LINK, ABILITY_INTIMIDATE }, //BURNING BEAK that burns on contact ? ? no. beak blkasts job.
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_CHARJABUG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_BATTERY, ABILITY_NONE, ABILITY_ELECTRIC_SURGE },
    ...
    [SPECIES_VIKAVOLT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SPEED_BOOST, ABILITY_NONE, ABILITY_MEGA_LAUNCHER },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CRABOMINABLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_DOUBLE_WALLOP, ABILITY_IRON_FIST, ABILITY_UNSEEN_FIST },
    ...
    [SPECIES_ORICORIO_BAILE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_DANCER, ABILITY_NONE, ABILITY_DROUGHT },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_ORICORIO_POM_POM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_DANCER, ABILITY_NONE, ABILITY_STATIC },
    ...
    [SPECIES_ORICORIO_PAU] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_DANCER, ABILITY_NONE, ABILITY_PARROT },
    ...
    [SPECIES_ORICORIO_SENSU] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_DANCER, ABILITY_NONE, ABILITY_WIND_POWER },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Oricorio"),
...
{EVO_LEVEL, 25, SPECIES_LYCANROC_MIDDAY, CONDITIONS({IF_NOT_TIME, TIME_NIGHT})},
    ...
    [SPECIES_LURANTIS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_SOLAR_POWER, ABILITY_SHARPNESS, ABILITY_CONTRARY},
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_MORELULL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_POISON_HEAL, ABILITY_ILLUMINATE, ABILITY_MYCELIUM_MIGHT },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SALANDIT] =
    {
        ...
        .abilities = { ABILITY_CORROSION, ABILITY_WHITE_SMOKE, ABILITY_OBLIVIOUS },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_BOUNSWEET] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_LEAF_GUARD, ABILITY_OBLIVIOUS, ABILITY_PASTEL_VEIL },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_TSAREENA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_LEAF_GUARD, ABILITY_QUEENLY_MAJESTY, ABILITY_PASTEL_VEIL },
        .bodyColor = BODY_COLOR_PURPLE,
        .noFlip = TRUE,
    ...
    [SPECIES_ORANGURU] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_MOVE_RELEARNER, ABILITY_SYMBIOSIS }, ///Oranguru also tells you type effectiveness of its moves
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_PASSIMIAN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_RECEIVER, ABILITY_GRAND_DEBUT, ABILITY_DEFIANT },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_WIMPOD] =
    {
        ...
        .abilities = { ABILITY_WIMP_OUT, ABILITY_NONE, ABILITY_BATTLE_ARMOR },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_GOLISOPOD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_WATER_3),
        .abilities = { ABILITY_EMERGENCY_EXIT, ABILITY_NONE, ABILITY_BATTLE_ARMOR },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_SANDYGAST] =
    {
        ...
        .abilities = { ABILITY_WATER_COMPACTION, ABILITY_SAND_VEIL, ABILITY_SAND_SPIT },
        .bodyColor = BODY_COLOR_BROWN,
...
#define MINIOR_MISC_INFO(color)                                             \
        ...
        .abilities = { ABILITY_SHIELDS_DOWN, ABILITY_NONE, ABILITY_VICTORY_STAR},  \
        .bodyColor = color,                                                 \
        .noFlip = TRUE,                                                     \
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_TOGEDEMARU] =
    {
        ...
        .abilities = { ABILITY_IRON_BARBS, ABILITY_TRANSISTOR, ABILITY_STURDY},
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_DRAMPA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_BERSERK, ABILITY_SAP_SIPPER, ABILITY_MOVE_RELEARNER },
        .bodyColor = BODY_COLOR_WHITE,
