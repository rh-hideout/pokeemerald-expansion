...
#define LINOONE_MISC_INFO                                                       \
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_TINTED_LENS, ABILITY_IMMUNITY, ABILITY_TRIAGE },
    ...
    [SPECIES_DUSTOX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_MULTISCALE, ABILITY_COMPOUND_EYES },
        .bodyColor = BODY_COLOR_GREEN,
...
#define CAMERUPT_MISC_INFO                                  \
    ...
    [SPECIES_GRUMPIG] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_THICK_FAT, ABILITY_OWN_TEMPO, ABILITY_CUD_CHEW },
        .bodyColor = BODY_COLOR_PURPLE,
