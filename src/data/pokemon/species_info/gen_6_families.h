...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_CHESPIN] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_BULLETPROOF, ABILITY_UNBURDEN },
    ...
    [SPECIES_FENNEKIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_SERENE_GRACE, ABILITY_MAGICIAN },
    ...
    [SPECIES_FROAKIE] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_STICKY_HOLD, ABILITY_PROTEAN },
    ...
    [SPECIES_FLETCHINDER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_FLAME_BODY, ABILITY_GALE_WINGS, ABILITY_WHITE_SMOKE },
        .bodyColor = BODY_COLOR_RED,
...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
    ...
    [SPECIES_PYROAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLAME_BODY, ABILITY_PRIDE, ABILITY_BEAST_BOOST },    //will change shield dust later to "royal coat" if ends up testing well
        .bodyColor = BODY_COLOR_BROWN,
...
//cant put the following comments inside a define so the changes are as follows
//Florges DEF -5 HP +5
...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
    ...
    [SPECIES_SKIDDO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAP_SIPPER, ABILITY_CUD_CHEW, ABILITY_GRASS_PELT },
        .bodyColor = BODY_COLOR_BROWN,
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    ...
    [SPECIES_MEOWSTIC_M] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_QUICK_WIT, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MEOWSTIC_F] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_PRODIGAL, ABILITY_COMPETITIVE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Meowstic"),
        .cryId = CRY_MEOWSTIC,
        .natDexNum = NATIONAL_DEX_MEOWSTIC,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SWIRLIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_SWEET_VEIL, ABILITY_MIST_GLIDER, ABILITY_UNBURDEN },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_SKRELP] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 42, SPECIES_DRAGALGE}), //48
    },
    ...
    [SPECIES_DRAGALGE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_POISON_POINT, ABILITY_WATER_BUBBLE, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_HELIOLISK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_DRY_SKIN, ABILITY_SAND_VEIL, ABILITY_PROTOSYNTHESIS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_TYRUNT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_STRONG_JAW, ABILITY_STURDY, ABILITY_RIVALRY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_TYRANTRUM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_STRONG_JAW, ABILITY_ROCK_HEAD, ABILITY_DEFIANT },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_AMAURA] =
    {
        ...
        .abilities = { ABILITY_SNOW_WARNING, ABILITY_REFRIGERATE, ABILITY_ABSOLUTE_ZERO },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_NIGHT, 32, SPECIES_AURORUS}),    //39
    },
    ...
    [SPECIES_DEDENNE] =
    {
        ...
        .abilities = { ABILITY_CHEEK_POUCH, ABILITY_STATIC, ABILITY_LOVER },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_GOODRA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SAP_SIPPER, ABILITY_FOCUS_FLOOD, ABILITY_GOOEY },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_TREVENANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS, EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_TERRAFORM, ABILITY_FOCUS_FLOOD, ABILITY_HARVEST },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_AVALUGG_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = BERGMITE_EGG_GROUPS,
        .abilities = { ABILITY_STRONG_JAW, ABILITY_ABSOLUTE_ZERO, ABILITY_STURDY },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Avalugg"),
        .cryId = CRY_AVALUGG,
        .natDexNum = NATIONAL_DEX_AVALUGG,
    ...
    [SPECIES_NOIBAT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 44, SPECIES_NOIVERN}),  //48
    },
