...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_CHESPIN] =
    {
        ...
        .abilities  = {ABILITY_OVERGROW, ABILITY_BULLETPROOF, ABILITY_LEAF_GUARD},
    ...
    [SPECIES_FROAKIE] =
    {
        ...
        .abilities  = {ABILITY_TORRENT, ABILITY_MOXIE, ABILITY_PROTEAN},
...
#define FLOETTE_MISC_INFO(form, FORM, iconPal)                                  \
        ...
        .friendship = STANDARD_FRIENDSHIP,                                      \
        .growthRate = GROWTH_MEDIUM_FAST,                                       \
        .abilities  = {ABILITY_FLOWER_VEIL, ABILITY_GRASSY_SURGE, ABILITY_SYMBIOSIS},  \
        .bodyColor = BODY_COLOR_WHITE,                                          \
...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
    ...
    [SPECIES_SKIDDO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities  = {ABILITY_SEED_SOWER, ABILITY_GRASS_PELT, ABILITY_STAMINA},
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PANGORO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_IRON_FIST, ABILITY_MOLD_BREAKER, ABILITY_SUPREME_OVERLORD },
        .bodyColor = BODY_COLOR_WHITE,
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    ...
    [SPECIES_ESPURR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities  = {ABILITY_OPPORTUNIST, ABILITY_PRANKSTER, ABILITY_OWN_TEMPO},
    ...
    [SPECIES_MEOWSTIC_F] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities  = {ABILITY_OPPORTUNIST, ABILITY_PSYCHIC_SURGE, ABILITY_OWN_TEMPO},
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Meowstic"),
        .cryId = CRY_MEOWSTIC,
        .natDexNum = NATIONAL_DEX_MEOWSTIC,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SPRITZEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = {ABILITY_AROMA_VEIL, ABILITY_FAIRY_AURA, ABILITY_TRIAGE},
    ...
    [SPECIES_AROMATISSE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities  = {ABILITY_AROMA_VEIL, ABILITY_FAIRY_AURA, ABILITY_FUR_COAT},
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_SWIRLIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities  = {ABILITY_SUPERSWEET_SYRUP, ABILITY_GLUTTONY, ABILITY_SWEET_VEIL},
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_SLURPUFF] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities  = {ABILITY_SUPERSWEET_SYRUP, ABILITY_UNBURDEN, ABILITY_SWEET_VEIL},
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_INKAY] =
    {
        ...
        .abilities = { ABILITY_OPPOSITE_DAY, ABILITY_CONTRARY, ABILITY_CURIOUS_MEDICINE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Inkay"),
        .cryId = CRY_INKAY,
    ...
    [SPECIES_BINACLE] =
    {
        ...
        .abilities  = {ABILITY_TOUGH_CLAWS, ABILITY_CONSTRICTOR, ABILITY_PICKPOCKET},
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_DRAGALGE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities  = {ABILITY_MULTISCALE, ABILITY_TOXIC_CHAIN, ABILITY_ADAPTABILITY},
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CLAUNCHER] =
    {
        ...
        .abilities  = {ABILITY_MEGA_LAUNCHER, ABILITY_NONE, ABILITY_QUICK_DRAW},
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_HELIOPTILE] =
    {
        ...
        .abilities = {ABILITY_DRY_SKIN, ABILITY_SAND_RUSH, ABILITY_PROTOSYNTHESIS},
    ...
    [SPECIES_AMAURA] =
    {
        ...
        .abilities  = {ABILITY_PRISM_ARMOR, ABILITY_GOOD_AS_GOLD, ABILITY_SNOW_WARNING},
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DEDENNE] =
    {
        ...
        .abilities = {ABILITY_FRIEND_GUARD, ABILITY_BATTERY, ABILITY_CHEEK_POUCH},
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_CARBINK] =
    {
        ...
        .abilities = { ABILITY_ZERO_TO_HERO, ABILITY_NONE, ABILITY_WONDER_GUARD },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .abilities  = {ABILITY_GOOEY, ABILITY_SAP_SIPPER, ABILITY_WATER_COMPACTION},
    ...
    [SPECIES_SLIGGOO_HISUI] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities  = {ABILITY_GOOEY, ABILITY_SAP_SIPPER, ABILITY_SHELL_ARMOR},
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Sliggoo"),
        .cryId = CRY_SLIGGOO,
        .natDexNum = NATIONAL_DEX_SLIGGOO,
    ...
    [SPECIES_TREVENANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS, EGG_GROUP_AMORPHOUS),
        .abilities = {ABILITY_NATURAL_CURE, ABILITY_STAKEOUT, ABILITY_HARVEST},
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PUMPKABOO_AVERAGE] =
    {
        ...
        .abilities  = {ABILITY_PICKUP, ABILITY_FLASH_FIRE, ABILITY_RIPEN},
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_BERGMITE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_AVALUGG, CONDITIONS({IF_NOT_REGION, REGION_HISUI})},
                                {EVO_ITEM, ITEM_DAWN_STONE, SPECIES_AVALUGG_HISUI, CONDITIONS({IF_REGION, REGION_HISUI})}),
    },
    ...
    [SPECIES_NOIBAT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
    #endif
        .abilities  = {ABILITY_WIND_RIDER, ABILITY_INFILTRATOR, ABILITY_PUNK_ROCK},
        .bodyColor = BODY_COLOR_PURPLE,
