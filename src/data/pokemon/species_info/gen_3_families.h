...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_BLAZIKEN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_IRON_FIST, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_POOCHYENA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 15, SPECIES_MIGHTYENA}),
    },
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_RIVALRY, ABILITY_MARVEL_SCALE },
    ...
    [SPECIES_DUSTOX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_SWARM, ABILITY_COMPOUND_EYES },
        .bodyColor = BODY_COLOR_GREEN,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_SHEDINJA] =
    {
        ...
        .abilities = { ABILITY_WONDER_GUARD, ABILITY_NONE, ABILITY_SAND_STREAM },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_NOSEPASS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_PROBOPASS, CONDITIONS({IF_IN_MAPSEC, MAPSEC_NEW_MAUVILLE})},
                                {EVO_ITEM, ITEM_METAL_COAT, SPECIES_PROBOPASS}),
    #endif
    },
    ...
    [SPECIES_DELCATTY] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_NORMALIZE, ABILITY_FUR_COAT },
    #else
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_NONE, ABILITY_WONDER_SKIN },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_PLUSLE] =
    {
        ...
        .abilities = { ABILITY_PLUS, ABILITY_LIGHTNING_ROD, ABILITY_MAGNET_PULL },
    #else
    ...
    [SPECIES_VOLBEAT] =
    {
        ...
        .abilities = { ABILITY_PRANKSTER, ABILITY_SWARM, ABILITY_ILLUMINATE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_BUDEW] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_ROSELIA, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD})}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_WAILORD] =
    {
        ...
        .growthRate = GROWTH_FLUCTUATING,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_WATER_2),
        .abilities = { ABILITY_WATER_VEIL, ABILITY_OBLIVIOUS, ABILITY_THICK_FAT },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CACNEA] =
    {
        ...
        .abilities = { ABILITY_SAND_VEIL, ABILITY_WATER_ABSORB, ABILITY_IRON_BARBS },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_ZANGOOSE] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_IMMUNITY, ABILITY_TOUGH_CLAWS , ABILITY_GUTS },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_SEVIPER] =
    {
        ...
        .abilities = { ABILITY_SHED_SKIN, ABILITY_INFILTRATOR, ABILITY_MULTISCALE },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_TRADE, 0, SPECIES_DUSKNOIR, CONDITIONS({IF_HOLD_ITEM, ITEM_LINKING_CORD})},
    ...
    [SPECIES_CHINGLING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_CHIMECHO, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD})}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_GLALIE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_ICE_BODY, ABILITY_PRESSURE },
    #else
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_NONE, ABILITY_MOODY },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_FROSLASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SNOW_CLOAK, ABILITY_ICE_BODY, ABILITY_CURSED_BODY },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_WALREIN] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_THICK_FAT, ABILITY_ICE_BODY, ABILITY_SNOW_WARNING },
    #else
        .abilities = { ABILITY_THICK_FAT, ABILITY_NONE, ABILITY_OBLIVIOUS },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GOREBYSS] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_DAZZLING, ABILITY_NONE, ABILITY_SWIFT_SWIM },
        .bodyColor = BODY_COLOR_PINK,
