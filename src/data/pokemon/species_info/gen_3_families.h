...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_WURMPLE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 5, SPECIES_SILCOON},
                                {EVO_LEVEL, 5, SPECIES_CASCOON}),
    },
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_VOLBEAT] =
    {
        ...
        .baseSpeed     = 101,
        .baseSpAttack  = 87,
        .baseSpDefense = P_UPDATED_STATS >= GEN_7 ? 75 : 75,
    ...
    [SPECIES_ILLUMISE] =
    {
        ...
        .baseSpeed     = 101,
        .baseSpAttack  = 70,
        .baseSpDefense = P_UPDATED_STATS >= GEN_7 ? 87 : 75,
        .types = MON_TYPES(TYPE_BUG, TYPE_ELECTRIC),
        .catchRate = 150,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 151,
