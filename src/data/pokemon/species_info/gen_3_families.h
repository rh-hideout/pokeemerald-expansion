...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_TREECKO] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 55,
        .types = MON_TYPES(TYPE_DARK, TYPE_WIND, TYPE_UNDEAD),
        .catchRate = 45,
    ...
    [SPECIES_SCEPTILE_MEGA] =
    {
        ...
        .baseSpAttack  = 145,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_PLANT, TYPE_DRAGON),
        .catchRate = 45,
    ...
    [SPECIES_COMBUSKEN] =
    {
        ...
        .baseSpAttack  = 85,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_FIRE, TYPE_COMBAT),
        .catchRate = 45,
        .expYield = 142,
        .evYield_Attack = 1,
        .evYield_SpAttack = 1,
    ...
    [SPECIES_ZIGZAGOON_GALAR] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 41,
        .types = MON_TYPES(TYPE_DARK, TYPE_NULL),
        .catchRate = 255,
        .expYield = ZIGZAGOON_EXP_YIELD,
        .evYield_Speed = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_INSECT, TYPE_WIND),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 198,
    ...
    [SPECIES_DUSTOX] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 90,
        .types = MON_TYPES(TYPE_INSECT, TYPE_FILTH),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 193,
    #elif P_UPDATED_EXP_YIELDS >= GEN_7
    ...
    [SPECIES_LOTAD] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_WATER, TYPE_PLANT),
        .catchRate = 255,
    ...
    [SPECIES_NUZLEAF] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 40,
        .types = MON_TYPES(TYPE_PLANT, TYPE_DARK),
        .catchRate = 120,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 119 : 141,
        .evYield_Attack = 2,
        .itemRare = ITEM_POWER_HERB,
...
#if P_FAMILY_RALTS
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_PUPPET : TYPE_PSYCHIC)
    ...
    [SPECIES_GALLADE] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 115,
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_COMBAT),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 259,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_SURSKIT] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 52,
        .types = MON_TYPES(TYPE_INSECT, TYPE_WATER),
        .catchRate = 200,
    ...
    [SPECIES_BRELOOM] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_PLANT, TYPE_COMBAT),
        .catchRate = 90,
    ...
    [SPECIES_NINCADA] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 30,
        .types = MON_TYPES(TYPE_INSECT, TYPE_EARTH),
        .catchRate = 255,
    ...
    [SPECIES_SHEDINJA] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 30,
        .types = MON_TYPES(TYPE_INSECT, TYPE_UNDEAD),
        .catchRate = 45,
    ...
    [SPECIES_PROBOPASS] =
    {
        ...
        .baseSpAttack  = 75,
        .baseSpDefense = 150,
        .types = MON_TYPES(TYPE_BEAST, TYPE_MACHINE),
        .catchRate = 60,
    ...
    #define MAWILE_TYPES { TYPE_MACHINE, TYPE_PUPPET }
#else
    #define MAWILE_TYPES { TYPE_MACHINE, TYPE_MACHINE }
#endif
    ...
    [SPECIES_ARON] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 40,
        .types = MON_TYPES(TYPE_MACHINE, TYPE_BEAST),
        .catchRate = 180,
    ...
    [SPECIES_MEDITITE] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 55,
        .types = MON_TYPES(TYPE_COMBAT, TYPE_PSYCHIC),
        .catchRate = 180,
    ...
    [SPECIES_BUDEW] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_PLANT, TYPE_FILTH),
        .catchRate = 255,
    ...
    [SPECIES_VIBRAVA] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_EARTH, TYPE_DRAGON),
        .catchRate = 120,
    ...
    [SPECIES_ALTARIA] =
    {
        ...
        .baseSpAttack  = 70,
        .baseSpDefense = 105,
        .types = MON_TYPES(TYPE_DRAGON, TYPE_WIND),
        .catchRate = 45,
    ...
    [SPECIES_ALTARIA_MEGA] =
    {
        ...
        .baseSpAttack  = 110,
        .baseSpDefense = 105,
        .types = MON_TYPES(TYPE_DRAGON, TYPE_PUPPET),
        .catchRate = 45,
        .expYield = 207,
        .evYield_SpDefense = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_LUNATONE] =
    {
        ...
        .baseSpAttack  = 95,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_BEAST, TYPE_PSYCHIC),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 161,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_BALTOY] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_EARTH, TYPE_PSYCHIC),
        .catchRate = 255,
    ...
    [SPECIES_LILEEP] =
    {
        ...
        .baseSpAttack  = 61,
        .baseSpDefense = 87,
        .types = MON_TYPES(TYPE_BEAST, TYPE_PLANT),
        .catchRate = 45,
    ...
    [SPECIES_ANORITH] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_BEAST, TYPE_INSECT),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_5
        .expYield = 71,
    #elif P_UPDATED_EXP_YIELDS >= GEN_4
    ...
    [SPECIES_TROPIUS] =
    {
        ...
        .baseSpAttack  = 72,
        .baseSpDefense = 87,
        .types = MON_TYPES(TYPE_PLANT, TYPE_WIND),
        .catchRate = 200,
    ...
    [SPECIES_BELDUM] =
    {
        ...
        .baseSpAttack  = 35,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_MACHINE, TYPE_PSYCHIC),
        .catchRate = 3,
