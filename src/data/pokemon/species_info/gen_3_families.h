...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_TORCHIC] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_COMBUSKEN}),
    ...
    [SPECIES_MIGHTYENA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_QUICK_FEET, ABILITY_GUARD_DOG },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_LINOONE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PICKUP, ABILITY_GLUTTONY, ABILITY_SIMPLE },
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_MASQUERAIN] =
    {
        ...
        .baseAttack    = 60,
        .baseDefense   = 79,
        .baseSpeed     = P_UPDATED_STATS >= GEN_7 ? 90 : 60,
    ...
    [SPECIES_SKITTY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 19, SPECIES_DELCATTY}),
    },
...
7    },
    ...
    [SPECIES_TORKOAL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_WHITE_SMOKE, ABILITY_SHELL_ARMOR, ABILITY_MAGMA_ARMOR },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_FLYGON] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #endif
        .abilities = { ABILITY_SAND_FORCE, ABILITY_LEVITATE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_WHISCASH] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_ANTICIPATION, ABILITY_WATER_BUBBLE },
    #else
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_NONE, ABILITY_HYDRATION },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CHIMECHO] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_RATTLED },
        .bodyColor = BODY_COLOR_BLUE,
