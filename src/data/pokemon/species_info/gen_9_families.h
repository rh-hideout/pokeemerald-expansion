...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_TANDEMAUS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_BATTLE_ONLY, 25, SPECIES_MAUSHOLD_FOUR, CONDITIONS({IF_PID_MODULO_100_GT, 0}, {SKIP_ANIM_IF_NOT_SENT_OUT})},
                                {EVO_LEVEL_BATTLE_ONLY, 25, SPECIES_MAUSHOLD_THREE, CONDITIONS({IF_PID_MODULO_100_EQ, 0}, {SKIP_ANIM_IF_NOT_SENT_OUT})}),
    },
