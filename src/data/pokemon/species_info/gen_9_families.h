...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_PAWMO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM_HOLD, ITEM_REVIVE, SPECIES_PAWMOT},
                                {EVO_OVERWORLD_STEPS, 1000, SPECIES_PAWMOT}),
    },
    ...
    [SPECIES_BRAMBLIN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_OVERWORLD_STEPS, 1000, SPECIES_BRAMBLEGHAST},
                                {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_BRAMBLEGHAST}),
    },
    ...
    [SPECIES_RELLOR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_OVERWORLD_STEPS, 1000, SPECIES_RABSCA},
                                {EVO_MOVE, MOVE_ROCK_TOMB, SPECIES_RABSCA}),
    },
    ...
    [SPECIES_GIMMIGHOUL_CHEST] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM_HOLD, ITEM_GIMMIGHOUL_COIN, SPECIES_GHOLDENGO},
                                {EVO_ITEM_COUNT_999, ITEM_GIMMIGHOUL_COIN, SPECIES_GHOLDENGO}),
    },
