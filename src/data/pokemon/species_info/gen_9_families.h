...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_SPIDOPS] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_TINTED_LENS, ABILITY_POISON_POINT, ABILITY_STAKEOUT },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_ESPATHRA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_OPPORTUNIST, ABILITY_COMPOUND_EYES, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_WUGTRIO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_GOOEY, ABILITY_ARENA_TRAP, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_VAROOM] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 29, SPECIES_REVAVROOM}),
    },
