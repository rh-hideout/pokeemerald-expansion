...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_QUAXLY] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_ZEAL, ABILITY_MOXIE },
    ...
    [SPECIES_OINKOLOGNE_M] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_LINGERING_AROMA, ABILITY_THICK_FAT, ABILITY_GLUTTONY },  //give cozy dreams when made
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_TAROUNTULA] =
    {
        ...
        .abilities = { ABILITY_INSOMNIA, ABILITY_SWARM, ABILITY_STAKEOUT },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_SPIDOPS] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_INSOMNIA, ABILITY_BULLY, ABILITY_STAKEOUT },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_NYMBLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_TANGLED_FEET, ABILITY_TINTED_LENS },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_LOKIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_KICKBOXER, ABILITY_TINTED_LENS },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Lokix"),
        .cryId = CRY_LOKIX,
    ...
    [SPECIES_PAWMOT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_OBLIVIOUS, ABILITY_IRON_FIST },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_CERULEDGE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_SERENE_GRACE, ABILITY_WEAK_ARMOR },
    ...
    [SPECIES_TOEDSCOOL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_MYCELIUM_MIGHT, ABILITY_POISON_HEAL, ABILITY_NONE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_SCOVILLAIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_INSOMNIA, ABILITY_UNBURDEN },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_RELLOR] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_COMPOUND_EYES, ABILITY_INNER_FOCUS, ABILITY_SHED_SKIN },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_RABSCA] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_MAGIC_GUARD, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_FLITTLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_ANTICIPATION, ABILITY_FRISK, ABILITY_QUICK_WIT },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_ESPATHRA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_OPPORTUNIST, ABILITY_FRISK, ABILITY_QUICK_WIT },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_TINKATON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_OWN_TEMPO, ABILITY_MYTHIC_BLOOD },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_WUGTRIO] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_WATER, TYPE_GROUND),    //added ground
        .catchRate = 50,
        .expYield = 149,
        .evYield_Speed = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_BOMBIRDIER] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_ROCKY_PAYLOAD, ABILITY_ROCKY_PAYLOAD, ABILITY_UNBURDEN },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_VAROOM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_OVERCOAT, ABILITY_ZEAL, ABILITY_SLOW_START },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_REVAVROOM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_OVERCOAT, ABILITY_QUARK_DRIVE, ABILITY_FILTER },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_CYCLIZAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SHED_SKIN, ABILITY_SCRAPPY, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_VELUZA] =
    {
        ...
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_BULLY, ABILITY_SHARPNESS },
        .bodyColor = BODY_COLOR_GRAY,
