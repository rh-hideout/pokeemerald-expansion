...
static const struct LevelUpMove sPiplupLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_POUND),
    LEVEL_UP_MOVE( 1, MOVE_FLUTTER_FLARE),
    LEVEL_UP_MOVE( 4, MOVE_GROWL),
    LEVEL_UP_MOVE( 6, MOVE_FROST_SPORE),
    LEVEL_UP_MOVE( 6, MOVE_CHILI_POWDER),
    LEVEL_UP_MOVE( 7, MOVE_GRAVITY_WELL),
    LEVEL_UP_MOVE( 7, MOVE_STONE_STORM),
