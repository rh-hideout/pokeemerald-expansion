...
static const struct LevelUpMove sNaughtycootLevelUpLearnset[] = {
   ...
   LEVEL_UP_MOVE(64, MOVE_FLASH_CANNON), //Warhead in a bit
   LEVEL_UP_MOVE(59, MOVE_SEED_FLARE), // Ill add shitpost in a bit and put it here
   LEVEL_UP_END
   };
...
static const struct LevelUpMove sImpfectionLevelUpLearnset[] = {
   ...
   LEVEL_UP_MOVE(35, MOVE_MEDDY_MEDS), // Replace with daily dose later
...
static const struct LevelUpMove sMolterraLevelUpLearnset[] = {
   ...
   LEVEL_UP_MOVE( 1, MOVE_EMBER),//Replace with Scorched earth once coded
   LEVEL_UP_MOVE( 1, MOVE_SMOKESCREEN),
   LEVEL_UP_MOVE( 1, MOVE_RAPID_SPIN),
   LEVEL_UP_MOVE( 6, MOVE_SAND_TOMB),
   LEVEL_UP_MOVE(11, MOVE_BULLDOZE),
   ...
   LEVEL_UP_MOVE(75, MOVE_EARTH_POWER),//Replace by Earth shatter once done
   LEVEL_UP_END
   };
...
static const struct LevelUpMove sYuukiinoLevelUpLearnset[] = {
   ...
   LEVEL_UP_MOVE(20, MOVE_ICY_WIND),
   LEVEL_UP_MOVE(24, MOVE_RAPID_SPIN), // Replace with Mop once coded
   LEVEL_UP_MOVE(27, MOVE_LIGHT_SCREEN),
   LEVEL_UP_MOVE(30, MOVE_AURORA_BEAM),
...
static const struct LevelUpMove sNoxiliumLevelUpLearnset[] = {
   LEVEL_UP_MOVE( 1, MOVE_MAGIC_COAT), //Replace with Meme once implemented
   ...
   LEVEL_UP_MOVE(44, MOVE_DRAGON_ASCENT), //Replace with Wings Of Correction once implemented
