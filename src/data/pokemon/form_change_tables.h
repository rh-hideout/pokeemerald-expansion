...
static const struct FormChange sRotomFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_ROTOM,       ITEM_ROTOM_CATALOGUE, 0},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_ROTOM_HEAT,  ITEM_ROTOM_CATALOGUE, 1},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_ROTOM_WASH,  ITEM_ROTOM_CATALOGUE, 2},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_ROTOM_FROST, ITEM_ROTOM_CATALOGUE, 3},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_ROTOM_FAN,   ITEM_ROTOM_CATALOGUE, 4},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_ROTOM_MOW,   ITEM_ROTOM_CATALOGUE, 5},
    {FORM_CHANGE_TERMINATOR},
};
