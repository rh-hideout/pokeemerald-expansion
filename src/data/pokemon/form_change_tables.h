...
static const struct FormChange sNibiruFormChangeTable[] =
{
    {FORM_CHANGE_BEGIN_WILD_ENCOUNTER,       SPECIES_NIBIRU},
    {FORM_CHANGE_BEGIN_BATTLE,               SPECIES_NIBIRU},
    {FORM_CHANGE_BATTLE_HP_PERCENT_SEND_OUT, SPECIES_NIBIRU,                ABILITY_SHIELDS_DOWN, HP_HIGHER_THAN,   50},
    {FORM_CHANGE_BATTLE_HP_PERCENT_SEND_OUT, SPECIES_NIBIRU_MONSTER_FORM,   ABILITY_SHIELDS_DOWN, HP_LOWER_EQ_THAN, 50},
    {FORM_CHANGE_BATTLE_HP_PERCENT_TURN_END, SPECIES_NIBIRU,                ABILITY_SHIELDS_DOWN, HP_HIGHER_THAN,   50},
    {FORM_CHANGE_BATTLE_HP_PERCENT_TURN_END, SPECIES_NIBIRU_MONSTER_FORM,   ABILITY_SHIELDS_DOWN, HP_LOWER_EQ_THAN, 50},
    {FORM_CHANGE_BATTLE_SWITCH_OUT,          SPECIES_NIBIRU_MONSTER_FORM},
    {FORM_CHANGE_FAINT,                      SPECIES_NIBIRU_MONSTER_FORM},
    {FORM_CHANGE_END_BATTLE,                 SPECIES_NIBIRU_MONSTER_FORM},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sFortuneLadyEveryFormChangeTable[] =
{
    {FORM_CHANGE_ITEM_HOLD, SPECIES_FORTUNE_LADY_EVERY,          ITEM_NONE,         ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_FORTUNE_LADY_EVERY_FIGHTING, ITEM_FIST_PLATE,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_FORTUNE_LADY_EVERY_FLYING,   ITEM_SKY_PLATE,    ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_FORTUNE_LADY_EVERY_POISON,   ITEM_TOXIC_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_FORTUNE_LADY_EVERY_ROCK,     ITEM_STONE_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_FORTUNE_LADY_EVERY_GROUND,   ITEM_EARTH_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_FORTUNE_LADY_EVERY_BUG,      ITEM_INSECT_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_FORTUNE_LADY_EVERY_GHOST,    ITEM_SPOOKY_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_FORTUNE_LADY_EVERY_STEEL,    ITEM_IRON_PLATE,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_FORTUNE_LADY_EVERY_FIRE,     ITEM_FLAME_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_FORTUNE_LADY_EVERY_WATER,    ITEM_SPLASH_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_FORTUNE_LADY_EVERY_GRASS,    ITEM_MEADOW_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_FORTUNE_LADY_EVERY_ELECTRIC, ITEM_ZAP_PLATE,    ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_FORTUNE_LADY_EVERY_PSYCHIC,  ITEM_MIND_PLATE,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_FORTUNE_LADY_EVERY_ICE,      ITEM_ICICLE_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_FORTUNE_LADY_EVERY_DRAGON,   ITEM_DRACO_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_FORTUNE_LADY_EVERY_DARK,     ITEM_DREAD_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_TERMINATOR},
};
