...
static const struct FormChange sWishiwashiFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_HP_PERCENT_SEND_OUT, SPECIES_WISHIWASHI_SCHOOL, ABILITY_SCHOOLING, HP_HIGHER_THAN,   25},
    {FORM_CHANGE_BATTLE_HP_PERCENT_SEND_OUT, SPECIES_WISHIWASHI_SOLO,   ABILITY_SCHOOLING, HP_LOWER_EQ_THAN, 25},
    {FORM_CHANGE_BATTLE_HP_PERCENT_TURN_END, SPECIES_WISHIWASHI_SCHOOL, ABILITY_SCHOOLING, HP_HIGHER_THAN,   25},
...
static const struct FormChange sMimikyuFormChangeTable[] = {
    ...
    {FORM_CHANGE_HIT_BY_MOVE,                      SPECIES_MIMIKYU_BUSTED,   ABILITY_DISGUISE},
...
static const struct FormChange sMimikyuTotemFormChangeTable[] = {
    ...
    {FORM_CHANGE_HIT_BY_MOVE,                      SPECIES_MIMIKYU_BUSTED_TOTEM,   ABILITY_DISGUISE},
