...
const u16 gPokedexOrder_Alphabetical[] =
{
    ...
    NATIONAL_DEX_HAZELNAUT,
    NATIONAL_DEX_GINOCCHIO,
    NATIONAL_DEX_MAGMATA,
    NATIONAL_DEX_DELAVA,
    NATIONAL_DEX_SALEZERKER,
    NATIONAL_DEX_FRUDGE,
    NATIONAL_DEX_AQUAOS,
    NATIONAL_DEX_LEMIRETHUN,
    NATIONAL_DEX_BUGGY,
    NATIONAL_DEX_BUGATTI,
    NATIONAL_DEX_BULLEPEDE,
    NATIONAL_DEX_WHIMPLE,
    NATIONAL_DEX_WHIPSCUFFLE,
    NATIONAL_DEX_WHIPSICUFFS,
    NATIONAL_DEX_AFLOOF,
    NATIONAL_DEX_DISBEARY,
    NATIONAL_DEX_HAMSTATIC,
    NATIONAL_DEX_AMPSTAR,
    NATIONAL_DEX_FLORIBEL,
    NATIONAL_DEX_MOGERIA,
    NATIONAL_DEX_KIWI,
    NATIONAL_DEX_IWIK,
    NATIONAL_DEX_LARVITTY,
    NATIONAL_DEX_GRUMPOON,
    NATIONAL_DEX_KONEKOTH,
    NATIONAL_DEX_MONKITE,
    NATIONAL_DEX_KONGLIDE,
    NATIONAL_DEX_YOKITE,
    NATIONAL_DEX_JERMIN,
    //NATIONAL_DEX_JERMIN_SWARM,
    NATIONAL_DEX_SKUBA,
    NATIONAL_DEX_SKUBMARINE,
    NATIONAL_DEX_PEDESTONE,
    NATIONAL_DEX_EROCHRE,
    NATIONAL_DEX_PILLAIA,
    NATIONAL_DEX_TRIACTITE,
    NATIONAL_DEX_WALKALACK,
    NATIONAL_DEX_MOGUMOLE,
    NATIONAL_DEX_BANDICUTE,
    NATIONAL_DEX_NAUGHTYCOOT,
    NATIONAL_DEX_SUBSTRALE,
    NATIONAL_DEX_PERMACEROS,
    NATIONAL_DEX_FRIJOLERO,
    NATIONAL_DEX_PICANTERO,
    NATIONAL_DEX_SHERIFUEGO,
    NATIONAL_DEX_JUANKEY,
    NATIONAL_DEX_EQUUAN,
    NATIONAL_DEX_SHROOMAG,
    NATIONAL_DEX_FUNGNET,
    NATIONAL_DEX_SYCOSECT,
    NATIONAL_DEX_BELIEECH,
    NATIONAL_DEX_ARACHNOTE,
    NATIONAL_DEX_BURNUGGET,
    NATIONAL_DEX_FLARHEA,
    NATIONAL_DEX_DIRTYBIS,
    NATIONAL_DEX_IBASK,
    NATIONAL_DEX_TURTINI,
    NATIONAL_DEX_TURTURRET,
    NATIONAL_DEX_MIMIKRAB,
    NATIONAL_DEX_SPYCRAB,
    NATIONAL_DEX_STOWLET,
    NATIONAL_DEX_STRIXNIGHT,
    NATIONAL_DEX_IMPFECTION,
    NATIONAL_DEX_INKROW,
    NATIONAL_DEX_LIQUILL,
    NATIONAL_DEX_RAVARNISH,
    NATIONAL_DEX_HYDUCK,
    NATIONAL_DEX_BLUDUCK,
    NATIONAL_DEX_PLATYLICS,
    NATIONAL_DEX_KRISSY,
    NATIONAL_DEX_KRACKODEMON,
    NATIONAL_DEX_TRIDERLING,
    NATIONAL_DEX_TARANTAGON,
    NATIONAL_DEX_COMMUTANT,
    NATIONAL_DEX_HYBROTAMUS,
    NATIONAL_DEX_CATOBIRRAFE,
    NATIONAL_DEX_CAMELODUCTOR,
    NATIONAL_DEX_VINEDUP,
    NATIONAL_DEX_RAMBOOM,
    NATIONAL_DEX_VINEBOMB,
    NATIONAL_DEX_FLUBBSTER,
    NATIONAL_DEX_BLUBBASTARD,
    NATIONAL_DEX_POLTIRE,
    NATIONAL_DEX_JUNKGEIST,
    NATIONAL_DEX_FOXCET,
    NATIONAL_DEX_YARDSTEIN,
    NATIONAL_DEX_ONUSALT,
    NATIONAL_DEX_GHASTROPOD,
    NATIONAL_DEX_WEATHERBANE,
    NATIONAL_DEX_CYCLONIAN,
    NATIONAL_DEX_MEATIER,
    NATIONAL_DEX_TUNGHASKA,
    NATIONAL_DEX_BRAXITYTAN,
    NATIONAL_DEX_DOOMTER,
    NATIONAL_DEX_HORNTUBA,
    NATIONAL_DEX_SANICKEL,
    NATIONAL_DEX_SKOXIOUS,
    NATIONAL_DEX_ROOTCHEW,
    NATIONAL_DEX_TOOFGREW,
    NATIONAL_DEX_HOGNAW,
    NATIONAL_DEX_FRYZZLE,
    NATIONAL_DEX_CARPEDIAN,
    NATIONAL_DEX_VOLTOCOR,
    NATIONAL_DEX_VOLBRAT,
    NATIONAL_DEX_VOLIATH,
    NATIONAL_DEX_SEAMAN,
    NATIONAL_DEX_BARABYSS,
    NATIONAL_DEX_STROLLGE,
    NATIONAL_DEX_WINKHULU,
    NATIONAL_DEX_TEMAWRIA,
    NATIONAL_DEX_RETWINA,
    NATIONAL_DEX_HOOKLING,
    NATIONAL_DEX_FRACTYVERN,
    NATIONAL_DEX_DOGAN,
    NATIONAL_DEX_SMOGARS,
    NATIONAL_DEX_BUBBASAUR,
    NATIONAL_DEX_BUNGALOON,
    NATIONAL_DEX_ENVILE,
    NATIONAL_DEX_KAUSTIKROK,
    NATIONAL_DEX_WATTITUDE,
    NATIONAL_DEX_SWINGGLE,
    NATIONAL_DEX_MALEENTIS,
    NATIONAL_DEX_TADPOISON,
    NATIONAL_DEX_BRETKHELM,
    NATIONAL_DEX_BERFGOYLE,
    NATIONAL_DEX_FLUBUNNY,
    NATIONAL_DEX_LEPOOZE,
    NATIONAL_DEX_LUNABBIT,
    NATIONAL_DEX_HELMATA,
    NATIONAL_DEX_PUNKUYU,
    NATIONAL_DEX_CHAMELEE,
    NATIONAL_DEX_CAMEREX,
    NATIONAL_DEX_TAMANAUT,
    NATIONAL_DEX_STARHIRO,
    NATIONAL_DEX_DOUBTLAW,
    NATIONAL_DEX_SHROOMALICE,
    NATIONAL_DEX_SPORESTOOL,
    NATIONAL_DEX_VIRTUITA,
    NATIONAL_DEX_MEOWER,
    NATIONAL_DEX_CATATION,
    NATIONAL_DEX_YUUKIINO,
    NATIONAL_DEX_AQUADIIVA,
    NATIONAL_DEX_FIRVID,
    NATIONAL_DEX_CHOLEFIR,
    NATIONAL_DEX_MAMINI,
    NATIONAL_DEX_MAMMOUNT,
    NATIONAL_DEX_KNITTEN,
    NATIONAL_DEX_SABSUTE,
    NATIONAL_DEX_DOLLGHOST,
    NATIONAL_DEX_PARMIAUSAN,
    NATIONAL_DEX_PIURETTE,
    NATIONAL_DEX_PASCAL,
    NATIONAL_DEX_KOROKAMI,
    NATIONAL_DEX_FLOCKARRION,
    NATIONAL_DEX_SEPULTURE,
    NATIONAL_DEX_MAGGHOST,
    NATIONAL_DEX_COCCURN,
    NATIONAL_DEX_PHAMOTHOM,
    NATIONAL_DEX_GANGLYTHON,
    NATIONAL_DEX_MOBLIN,
    NATIONAL_DEX_FANGSTER,
    NATIONAL_DEX_MAFIADON,
    NATIONAL_DEX_GHARROSTE,
    NATIONAL_DEX_FLEURRIUM,
    NATIONAL_DEX_CRISTANIUM,
    NATIONAL_DEX_TOKOYAKI,
    NATIONAL_DEX_ONSENPURA,
    NATIONAL_DEX_PEASOL,
    NATIONAL_DEX_VAPONOBI,
    NATIONAL_DEX_HAARSHOGUN,
    NATIONAL_DEX_SIMIONACH,
    NATIONAL_DEX_EPIPHEROR,
    NATIONAL_DEX_LEOPAWN,
    NATIONAL_DEX_DEVANTE,
    NATIONAL_DEX_VERGILION,
    NATIONAL_DEX_LARVATRICE,
    NATIONAL_DEX_BRASHALISK,
    NATIONAL_DEX_KOKAIJU,
    NATIONAL_DEX_LEVITITAN,
    NATIONAL_DEX_MEDUSITH,
    NATIONAL_DEX_DISPLACERK,
    NATIONAL_DEX_FABRINNIAL,
    NATIONAL_DEX_CANVELLIA,
    NATIONAL_DEX_GUERTENITY,
    NATIONAL_DEX_FUCKER,
    NATIONAL_DEX_MANTASM,
    NATIONAL_DEX_ORYUGAMI,
    NATIONAL_DEX_TOWHORSE,
    NATIONAL_DEX_DUBSNAKE,
    NATIONAL_DEX_HYDROIL,
    NATIONAL_DEX_COILSPILL,
    NATIONAL_DEX_KRAMBERRY,
    NATIONAL_DEX_FAUSTIVAL,
    NATIONAL_DEX_BAMBUYA,
    NATIONAL_DEX_JUMBLEGORE,
    NATIONAL_DEX_JUMBLINART,
    NATIONAL_DEX_ADENTITY,
    NATIONAL_DEX_POLYBRAWN,
    NATIONAL_DEX_EMEFFYUME,
    NATIONAL_DEX_PEGUI,
    NATIONAL_DEX_PECHIT,
    NATIONAL_DEX_COPOLAR,
    NATIONAL_DEX_WYCERN,
    NATIONAL_DEX_BITTERAGON,
    NATIONAL_DEX_ARCTIGLOBE,
    //NATIONAL_DEX_ARCTIGLOBE_FREED,
    NATIONAL_DEX_VRISKELETON,
    NATIONAL_DEX_COFFERULE,
    NATIONAL_DEX_GAROOKIE,
    NATIONAL_DEX_GARBLE,
    NATIONAL_DEX_GARGARRAMER,
    //NATIONAL_DEX_GARGARRAMER_AWAKEN,
    NATIONAL_DEX_BORKOSMOS,
    NATIONAL_DEX_SKALLAXY,
    NATIONAL_DEX_AIRUITE,
    NATIONAL_DEX_KAQUAPO,
    NATIONAL_DEX_NEBULITE,
    NATIONAL_DEX_ECCOSMIC,
    NATIONAL_DEX_LOBER,
    NATIONAL_DEX_CLOBBER,
    NATIONAL_DEX_SPIRANHA,
    NATIONAL_DEX_SELAGHAST,
    NATIONAL_DEX_KARKUTLASS,
    NATIONAL_DEX_RENDALOPOD,
    NATIONAL_DEX_SACCESTODA,
    NATIONAL_DEX_GLUCURS,
    NATIONAL_DEX_AMALGUM,
    NATIONAL_DEX_VORTRIX,
    NATIONAL_DEX_JAHL,
    NATIONAL_DEX_FUSJAHL,
    NATIONAL_DEX_MOLTAMA,
    NATIONAL_DEX_MOLTERRA,
    NATIONAL_DEX_FETTORCH,
    NATIONAL_DEX_MANICLE,
    NATIONAL_DEX_SHAIKLE,
    NATIONAL_DEX_TRICKLING,
    NATIONAL_DEX_DRAKLOWN,
    NATIONAL_DEX_DRATTEL,
    NATIONAL_DEX_ZILLICHINA,
    NATIONAL_DEX_ICEHUGGER,
    NATIONAL_DEX_XENINTER,
    NATIONAL_DEX_EMOJINN,
    NATIONAL_DEX_BEAREDAZE,
    NATIONAL_DEX_KUMATARO,
    NATIONAL_DEX_OUROBLACK,
    NATIONAL_DEX_REVELOROS,
    NATIONAL_DEX_VENIREAL,
    NATIONAL_DEX_APOCAMISE,
    NATIONAL_DEX_CROLORD,
    NATIONAL_DEX_JARUMITE,
    NATIONAL_DEX_SERPOTINE,
    NATIONAL_DEX_TSEMANI,
    NATIONAL_DEX_VANITWIN,
    //NATIONAL_DEX_VANITWIN_FEMALE,
    NATIONAL_DEX_DREDGOD,
    NATIONAL_DEX_SCHIZSTARF,
    NATIONAL_DEX_QRAKENMARK,
    NATIONAL_DEX_EPILATE,
    NATIONAL_DEX_ULMIRAINT,
    NATIONAL_DEX_NOXILIUM,
    NATIONAL_DEX_INDIGNIFLY,
    NATIONAL_DEX_DINOMIGHT,
    NATIONAL_DEX_COCKEN,
    NATIONAL_DEX_PRIMITOOL,
    NATIONAL_DEX_PRIMITEVE,
    NATIONAL_DEX_MOYALITH,
    NATIONAL_DEX_WAWHO,
    NATIONAL_DEX_REGIRODE,
    NATIONAL_DEX_REGIMELT,
    NATIONAL_DEX_REGIRUST,
    NATIONAL_DEX_REGISHORT,
    NATIONAL_DEX_REGICIDE,
    NATIONAL_DEX_REGIGIGONE,
    //NATIONAL_DEX_COCKEN_MEGA,
    // 870.8 lbs / 395.0 kg
    NATIONAL_DEX_GLACIUN,
    NATIONAL_DEX_GALVADEUX,
    NATIONAL_DEX_PYROTROIS,
    NATIONAL_DEX_ANKHIRA,
    NATIONAL_DEX_ANKHPU,
    NATIONAL_DEX_ANKHURAH,
    NATIONAL_DEX_SQUITHEE,
    NATIONAL_DEX_GOBLAZER,
    NATIONAL_DEX_WARGHORK,
    NATIONAL_DEX_RANRUU,
    NATIONAL_DEX_LOITUMA,
    NATIONAL_DEX_IGNIFATU,
    NATIONAL_DEX_SPENJBAB,
    NATIONAL_DEX_GIGAPUDDI,
    NATIONAL_DEX_EMPIDAE,
    NATIONAL_DEX_PHANTORNEY,
    NATIONAL_DEX_CIRNUMIRU,
    NATIONAL_DEX_SERAPHILL,
    NATIONAL_DEX_SHIRIBIKO,
    //NATIONAL_DEX_SHIRIBIKO_ULTRA,
    NATIONAL_DEX_NYANONITE,
    NATIONAL_DEX_KLASICOPE,
    NATIONAL_DEX_ESSENTION,
    NATIONAL_DEX_TERMAGNIUS,
    NATIONAL_DEX_FORGOTNO,
    NATIONAL_DEX_DOOMSAY,
    NATIONAL_DEX_SABLINI,
    NATIONAL_DEX_DOOMSDAY,
    //NATIONAL_DEX_DOOMSDAY_REVENANT,
    NATIONAL_DEX_MEWTWO,
...
const u16 gPokedexOrder_Weight[] =
{
    ...
    NATIONAL_DEX_XENINTER,
    NATIONAL_DEX_SPHARE,
    NATIONAL_DEX_COSTRIKE,
    NATIONAL_DEX_SPARMOR,
    NATIONAL_DEX_OHMADILLO,
    NATIONAL_DEX_COLOMBOLT,
    NATIONAL_DEX_EMOJINN,
    NATIONAL_DEX_BEAREDAZE,
    NATIONAL_DEX_KUMATARO,
    NATIONAL_DEX_OUROBLACK,
