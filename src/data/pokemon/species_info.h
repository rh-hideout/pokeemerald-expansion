...
const struct SpeciesInfo gSpeciesInfo[] =
{
	...
	[SPECIES_KOROMON] =
    {
        ...
        .description = COMPOUND_STRING(
			...
			"its head. Although it evolved from a\n"
			"reptile, it's classified as a plant. When \n"
			"facing danger, it releases a foul stench."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
	...
	[SPECIES_PALMON] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 30,
        .types = MON_TYPES(TYPE_DATA, TYPE_GRASS),
        .catchRate = 255,
        .expYield = 67,
        .evYield_HP = 1,
        .evYield_Defense = 1,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_OVERGROW, ABILITY_NONE, ABILITY_EFFECT_SPORE },
        ...
        .weight = 0,
        .description = COMPOUND_STRING(
			"A plant digimon with a tropical flower on\n"
			"its head. Although it evolved from a\n"
			"reptile, it's classified as a plant. When \n"
			"facing danger, it releases a foul stench."),
        .pokemonScale = 256,
	...
	[SPECIES_BIYOMON] =	
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 30,
        .types = MON_TYPES(TYPE_VACCINE, TYPE_FLYING),
        .catchRate = 255,
        .expYield = 100,
        .evYield_HP = 0,
        .evYield_Attack = 1,
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BIG_PECKS, ABILITY_NONE, ABILITY_EFFECT_SPORE }, 
        .bodyColor = BODY_COLOR_PINK, 
        ...
        .weight = 0,
        .description = COMPOUND_STRING(
			"A chick digimon whose wings developed\n"
			"to become like arms. It can grip objects\n"
			"but is poor at flying. It sees patamon\n"
			"as its rival. "),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
    ...
    [SPECIES_AGUMON] =
    {
        ...
        .weight = 0,
        .description = COMPOUND_STRING(
			"A reptile digimon that's developed the\n"
			"ability to walk on two legs. It has the\n"
			"potential to evolve into great, powerful\n"
			"digimon."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
    ...
    [SPECIES_SYAKOMON] =
    {
        ...
        .weight = 100,
        .description = COMPOUND_STRING(
			"Because its shell developed rapidly\n"
			"its inner structure has become slime-\n"
			"shaped. When the shell is closed, it can\n"
			" easily deflect attacks."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
	    ...
	    [SPECIES_GOMAMON] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_TORRENT, ABILITY_TORRENT, ABILITY_THICK_FAT },
        ...
        .weight = 200,
        .description = COMPOUND_STRING(
		"A marine beast that has become able\n"
		"to move about on land. The short, white\n"
		"fur grows longer and turns brown as it\n"
		"grows. It plays with everything."),
		        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
	    ...
	    [SPECIES_VEEMON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_IRON_FIST, ABILITY_OWN_TEMPO },
        ...
        .weight = 0,
        .description = COMPOUND_STRING(
			"It digivolved through the Digi-egg\n"
            "of Courage. Its uses its signature\n"
            "move Flaming Fist to pummel its \n"
            "opponents with fists of flame."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
