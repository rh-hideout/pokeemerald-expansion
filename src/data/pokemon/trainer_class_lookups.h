const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_GALACTIC_COMMANDER_MARS]    = TRAINER_PIC_FRONT_GALACTIC_COMMANDER_MARS,
    [FACILITY_CLASS_GALACTIC_COMMANDER_JUPITER] = TRAINER_PIC_FRONT_GALACTIC_COMMANDER_JUPITER,
    [FACILITY_CLASS_GALACTIC_COMMANDER_SATURN]  = TRAINER_PIC_FRONT_GALACTIC_COMMANDER_SATURN,
    [FACILITY_CLASS_GALACTIC_LEADER_CYRUS]      = TRAINER_PIC_FRONT_GALACTIC_LEADER_CYRUS,
};
...
const enum TrainerClassID gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_GALACTIC_COMMANDER_MARS]    = TRAINER_CLASS_GALACTIC_COMMANDER,
    [FACILITY_CLASS_GALACTIC_COMMANDER_JUPITER] = TRAINER_CLASS_GALACTIC_COMMANDER,
    [FACILITY_CLASS_GALACTIC_COMMANDER_SATURN]  = TRAINER_CLASS_GALACTIC_COMMANDER,
    [FACILITY_CLASS_GALACTIC_LEADER_CYRUS]      = TRAINER_CLASS_GALACTIC_LEADER,
};
