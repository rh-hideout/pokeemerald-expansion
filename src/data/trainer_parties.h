...
static const struct TrainerMon sParty_Matt[] = {
    ...
    .moves = {MOVE_ENCORE, MOVE_MUD_SHOT, MOVE_BUBBLE_BEAM, MOVE_HYPNOSIS}
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 38,
    ...
    .moves = {MOVE_GIGA_DRAIN, MOVE_QUICK_STING, MOVE_AIR_CUTTER, MOVE_STICKY_WEB}
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 40,
    ...
    .moves = {MOVE_MEGA_KICK, MOVE_AIR_SLASH, MOVE_DOUBLE_KICK, MOVE_DETECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 42,
    ...
    .moves = {MOVE_RAZOR_SHELL, MOVE_SWORDS_DANCE, MOVE_PROTECT, MOVE_NIGHT_SLASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 42,
    ...
    .moves = {MOVE_IRON_DEFENSE, MOVE_DRILL_PECK, MOVE_SPIKES, MOVE_STEEL_WING}
    }
};
...
static const struct TrainerMon sParty_ShellyWeatherInstitute[] = {
    ...
    .ability = ABILITY_DRIZZLE,
    .moves = {MOVE_AMNESIA, MOVE_AQUA_RING, MOVE_WATER_PULSE, MOVE_WING_ATTACK}
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 32,
    ...
    .moves = {MOVE_SCREECH, MOVE_ICE_FANG, MOVE_AQUA_JET, MOVE_BITE}
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 30,
    ...
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_BITE, MOVE_FACADE, MOVE_LOW_KICK, MOVE_THUNDER_FANG}
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 32,
    ...
    .moves = {MOVE_COIL, MOVE_SLEEP_POWDER, MOVE_BULLET_SEED, MOVE_KNOCK_OFF}
    },
};
...
static const struct TrainerMon sParty_Takao[] = {
    ...
    .moves = {MOVE_FLAME_CHARGE, MOVE_QUICK_ATTACK, MOVE_DOUBLE_KICK, MOVE_DETECT}
    }
};
...
static const struct TrainerMon sParty_Kirk[] = {
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 16, 12, 12, 16),
    .lvl = 20,
    .species = SPECIES_WIGGLYTUFF,
    .ability = ABILITY_PUNK_ROCK,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_REST, MOVE_SING, MOVE_DISARMING_VOICE, MOVE_THUNDER_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 22,
    ...
    .ability = ABILITY_PUNK_ROCK,
    .moves = {MOVE_SING, MOVE_GROWL, MOVE_POUNCE, MOVE_ENCORE}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 21,
    ...
    .moves = {MOVE_ACID, MOVE_FLAIL, MOVE_SPARK, MOVE_GROWL}
    }
};
...
static const struct TrainerMon sParty_Shawn[] = {
    ...
    .moves = {MOVE_FLAME_CHARGE, MOVE_SHOCK_WAVE, MOVE_THUNDER_WAVE, MOVE_QUICK_ATTACK}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 21,
    ...
    .moves = {MOVE_SPARK, MOVE_BITE, MOVE_CHARGE, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_Axle[] = {
    ...
    .moves = {MOVE_DOUBLE_TEAM, MOVE_THUNDER_WAVE, MOVE_SHOCK_WAVE, MOVE_HEX}
    }
};
...
static const struct TrainerMon sParty_Keegan[] = {
    ...
    .moves = {MOVE_SCARY_FACE, MOVE_FIRE_PUNCH, MOVE_CONFUSE_RAY, MOVE_CLEAR_SMOG}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 25,
    .species = SPECIES_CASTFORM,
    .moves = {MOVE_WEATHER_BALL, MOVE_SUNNY_DAY, MOVE_SOLAR_FLARE, MOVE_HEADBUTT}
    }
};
...
static const struct TrainerMon sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHRAPNEL}
    //.moves = {MOVE_TACKLE, MOVE_HARDEN, MOVE_ROCK_THROW, MOVE_ROCK_POLISH}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 12,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CHARGE, MOVE_DEFENSE_CURL, MOVE_SPARK, MOVE_ROCK_TOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 13,
    ...
    .moves = {MOVE_POWDER_SNOW, MOVE_GROWL, MOVE_AURORA_VEIL, MOVE_ANCIENT_POWER}
    },
	{
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 13,
...
static const struct TrainerMon sParty_Brawly1[] = {
    ...
    .moves = {MOVE_FACADE, MOVE_LOW_KICK, MOVE_SAND_ATTACK, MOVE_COUNTER}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 17,
    ...
    .moves = {MOVE_FORCE_PALM, MOVE_LIGHT_SCREEN, MOVE_REFLECT, MOVE_BULK_UP}
    },
	{
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 18,
    ...
    .moves = {MOVE_ARM_THRUST, MOVE_NUZZLE, MOVE_DIG, MOVE_SWEET_KISS}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 19,
...
static const struct TrainerMon sParty_Wattson1[] = {
    ...
    .moves = {MOVE_THUNDER_WAVE, MOVE_SHOCK_WAVE, MOVE_FLAME_CHARGE, MOVE_EERIE_IMPULSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 22,
    ...
    .moves = {MOVE_WATER_GUN, MOVE_SPARK, MOVE_FURY_ATTACK, MOVE_CHARGE}
    },
    {
    ...
    .nature = NATURE_SASSY,
    .moves = {MOVE_TRI_ATTACK, MOVE_CHARGE_BEAM, MOVE_EERIE_IMPULSE, MOVE_GYRO_BALL}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 25,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = ABILITY_LIGHTNING_ROD,
    .moves = {MOVE_DISCHARGE, MOVE_THUNDER_WAVE, MOVE_SWIFT, MOVE_ICE_FANG}
    }
};
...
static const struct TrainerMon sParty_Flannery1[] = {
    ...
    .moves = {MOVE_OVERHEAT, MOVE_BODY_SLAM, MOVE_ATTRACT, MOVE_CLEAR_SMOG}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 28,
    ...
    .moves = {MOVE_HOWL, MOVE_FIRE_FANG, MOVE_MORNING_SUN, MOVE_THUNDER_FANG}
    },
     {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 28,
    ...
    .moves = {MOVE_GROWTH, MOVE_BULLET_SEED, MOVE_FLAMETHROWER, MOVE_LEECH_SEED}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 30,
    ...
    .moves = {MOVE_OVERHEAT, MOVE_ROCK_SLIDE, MOVE_SUNNY_DAY, MOVE_EARTH_POWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 29,
    ...
    .ability = ABILITY_INTIMIDATE,
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_CURSE, MOVE_HORN_ATTACK, MOVE_RAGING_BULL, MOVE_DOUBLE_KICK}
    }
};
...
static const struct TrainerMon sParty_Norman1[] = {
    ...
    .moves = {MOVE_TEETER_DANCE, MOVE_PSYBEAM, MOVE_BODY_SLAM, MOVE_ENCORE}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 32,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_QUICK_ATTACK, MOVE_TWISTER, MOVE_FEATHER_DANCE, MOVE_RAZOR_WIND}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 32,
    ...
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_BULLET_SEED, MOVE_TAIL_SLAP, MOVE_TIDY_UP, MOVE_CHARM}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 30,
    ...
    .moves = {MOVE_PSYBEAM, MOVE_ELECTROWEB, MOVE_ICY_WIND, MOVE_TAKE_DOWN}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 34,
...
static const struct TrainerMon sParty_Winona1[] = {
    ...
    .heldItem = ITEM_MAGNET,
    .ability = ABILITY_LIGHTNING_ROD,
    .moves = {MOVE_CHARGE_BEAM, MOVE_AIR_CUTTER, MOVE_TAILWIND, MOVE_THUNDER_WAVE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 36,
    ...
    .moves = {MOVE_CONFUSE_RAY, MOVE_AIR_SLASH, MOVE_CALM_MIND, MOVE_EXPANDING_FORCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .moves = {MOVE_BONE_RUSH, MOVE_IRON_DEFENSE, MOVE_ROOST, MOVE_TOXIC}
    },
    {
    .iv = TRAINER_PARTY_IVS(26, 26, 26, 26, 26, 26),
    .lvl = 36,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_CRUNCH, MOVE_DUAL_WINGBEAT, MOVE_ROCK_SLIDE, MOVE_TAUNT}
    },
    {
    .iv = TRAINER_PARTY_IVS(26, 26, 26, 26, 26, 26),
    .lvl = 35,
    ...
    .moves = {MOVE_LIFE_DEW, MOVE_EXTRASENSORY, MOVE_ANCIENT_POWER, MOVE_YAWN}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 38,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_DRAGON_DASH, MOVE_DRAGON_DANCE, MOVE_AERIAL_ACE}
    }
};
...
static const struct TrainerMon sParty_TateAndLiza1[] = {
    ...
    .moves = {MOVE_MEGAHORN, MOVE_MORNING_SUN, MOVE_LINK_PULSE, MOVE_HYPNOSIS}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 43,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_MINDSTORM, MOVE_DARK_VOID, MOVE_DRAIN_PUNCH, MOVE_DREAM_EATER}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 44,
    ...
    .moves = {MOVE_TWIN_BEAM, MOVE_TRICK_ROOM, MOVE_CRUNCH, MOVE_WISH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 44,
    ...
    .heldItem = ITEM_COVERT_CLOAK,
    .ability = ABILITY_MAGIC_BOUNCE,
    .moves = {MOVE_ALLURING_VOICE, MOVE_EXPANDING_FORCE, MOVE_MORNING_SUN, MOVE_YAWN}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 43,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_YAWN, MOVE_DREAM_EATER, MOVE_SHADOW_BALL, MOVE_REFLECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 45,
    .species = SPECIES_CLAYDOL,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SCORCHING_SANDS, MOVE_EXPANDING_FORCE, MOVE_COSMIC_POWER, MOVE_ANCIENT_POWER}
    },
};
...
static const struct TrainerMon sParty_Juan1[] = {
    ...
    .moves = {MOVE_SURF, MOVE_MORTAL_SPIN, MOVE_ACID_ARMOR, MOVE_CONFUSE_RAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 45,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = ABILITY_ADAPTABILITY,
    .moves = {MOVE_WAVE_CRASH, MOVE_CRUNCH, MOVE_AQUA_JET, MOVE_PHANTOM_FORCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 46,
    ...
    .moves = {MOVE_LIFE_DEW, MOVE_CONFUSE_RAY, MOVE_FREEZE_DRY, MOVE_MUDDY_WATER}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 47,
    ...
    .moves = {MOVE_ENCORE, MOVE_HYPER_VOICE, MOVE_ICY_WIND, MOVE_ALLURING_VOICE}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 47,
    ...
    .heldItem = ITEM_WIDE_LENS,
    .moves = {MOVE_MUDDY_WATER, MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_FLIP_TURN}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 48,
    ...
    .ability = ABILITY_SWIFT_SWIM,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_SCALE_RAIN, MOVE_SCALD, MOVE_ICE_BEAM, MOVE_DRACO_METEOR}
    }
};
...
static const struct TrainerMon sParty_Josh[] = {
    ...
    .moves = {MOVE_BITE, MOVE_HOWL, MOVE_EMBER, MOVE_LEER}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 10,
    .species = SPECIES_ROLYCOLY,
    .moves = {MOVE_SMACK_DOWN, MOVE_SMOKESCREEN, MOVE_RAPID_SPIN, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 10,
    .species = SPECIES_BONSLY,
    .moves = {MOVE_FLAIL, MOVE_FAKE_TEARS, MOVE_COPYCAT, MOVE_ROCK_THROW}
    }
};
...
static const struct TrainerMon sParty_Tommy[] = {
    ...
    .moves = {MOVE_SMACK_DOWN, MOVE_PROTECT, MOVE_AQUA_JET, MOVE_WITHDRAW}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 10,
    .species = SPECIES_ROCKRUFF,
    .moves = {MOVE_TACKLE, MOVE_ROCK_THROW, MOVE_DOUBLE_TEAM, MOVE_LEER}
    }
};
...
static const struct TrainerMon sParty_Ben[] = {
    ...
    .moves = {MOVE_HYPNOSIS, MOVE_DISABLE, MOVE_PSYBEAM, MOVE_THUNDER_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 20,
    .species = SPECIES_VOLTORB,
    .moves = {MOVE_EERIE_IMPULSE, MOVE_ROLLOUT, MOVE_CHARGE_BEAM, MOVE_SWIFT}
    }
};
...
static const struct TrainerMon sParty_Jocelyn[] = {
    ...
    .lvl = 17,
    .species = SPECIES_BRELOOM,
    .moves = {MOVE_CHILI_POWDER, MOVE_MACH_PUNCH, MOVE_GROWTH, MOVE_HEADBUTT}
    }
};
...
static const struct TrainerMon sParty_Laura[] = {
    ...
    .moves = {MOVE_COVET, MOVE_LOW_KICK, MOVE_LEER, MOVE_FOCUS_ENERGY}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 14,
    .species = SPECIES_STUFFUL,
    .moves = {MOVE_BRUTAL_SWING, MOVE_BABY_DOLL_EYES, MOVE_PAYBACK, MOVE_LEER}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 14,
    .species = SPECIES_RIOLU,
    .moves = {MOVE_WORK_UP, MOVE_COUNTER, MOVE_METAL_CLAW, MOVE_QUICK_ATTACK}
    }
};
...
static const struct TrainerMon sParty_Eli[] = {
    ...
    .moves = {MOVE_DRAIN_PUNCH, MOVE_FIRE_PUNCH, MOVE_POWER_UP_PUNCH, MOVE_FOCUS_ENERGY}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 25,
    .species = SPECIES_FLAREON,
    .moves = {MOVE_FIRE_FANG, MOVE_QUICK_ATTACK, MOVE_SIZZLY_SLIDE, MOVE_BITE}
    }
};
...
static const struct TrainerMon sParty_Marc[] = {
    ...
    .moves = {MOVE_STRUGGLE_BUG, MOVE_ROLLOUT, MOVE_WITHDRAW, MOVE_WRAP}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 10,
    .species = SPECIES_SHIELDON,
    .moves = {MOVE_TAUNT, MOVE_ROCK_THROW, MOVE_DEFENSE_CURL, MOVE_PROTECT}
    }
};
...
static const struct TrainerMon sParty_Brenden[] = {
    ...
    .ability = ABILITY_BULLY,
    .heldItem = ITEM_BLACK_SLUDGE,
    .moves = {MOVE_LOW_KICK, MOVE_FLATTER, MOVE_MUD_SLAP, MOVE_TAUNT}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 15,
    .species = SPECIES_PANCHAM,
    .moves = {MOVE_COACHING, MOVE_ARM_THRUST, MOVE_LEER, MOVE_LOW_SWEEP}
    }
};
...
static const struct TrainerMon sParty_Lilith[] = {
    ...
    .moves = {MOVE_ROCK_SMASH, MOVE_BIND, MOVE_LEER, MOVE_DETECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 15,
    ...
    .moves = {MOVE_WING_ATTACK, MOVE_DOUBLE_KICK, MOVE_COPYCAT, MOVE_DETECT}
    }
};
...
static const struct TrainerMon sParty_Cristian[] = {
    ...
    .moves = {MOVE_QUICK_ATTACK, MOVE_ROCK_SMASH, MOVE_LEER, MOVE_TAUNT}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 15,
    ...
    .heldItem = ITEM_LEEK,
    .moves = {MOVE_ROCK_SMASH, MOVE_FURY_CUTTER, MOVE_LEER, MOVE_SAND_ATTACK}
    }
};
...
static const struct TrainerMon sParty_TabithaMtChimney[] = {
    ...
    .species = SPECIES_MIGHTYENA,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_BITE, MOVE_SWAGGER, MOVE_FIRE_FANG, MOVE_ROAR}
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 27,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_STOMP, MOVE_RAZOR_LEAF, MOVE_GROWTH, MOVE_AIR_SLASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 28,
    ...
    .ability = ABILITY_MAGMA_ARMOR,
    .heldItem = ITEM_CHARCOAL,
    .moves = {MOVE_ROCK_SLIDE, MOVE_AMNESIA, MOVE_EARTH_POWER, MOVE_LAVA_PLUME}
    }
};
...
static const struct TrainerMon sParty_MaxieMagmaHideout[] = {
    ...
    .ability = ABILITY_SCRAPPY,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PARTING_SHOT, MOVE_CRUNCH, MOVE_ROAR, MOVE_STOMP}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 38,
    .species = SPECIES_CROBAT,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_CROSS_POISON, MOVE_BITE, MOVE_AIR_CUTTER, MOVE_CONFUSE_RAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 38,
    ...
    .moves = {MOVE_EARTH_POWER, MOVE_BUG_BUZZ, MOVE_SCREECH, MOVE_DRAGON_TAIL}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 37,
    ...
    .moves = {MOVE_FLASH_CANNON, MOVE_THUNDER_WAVE, MOVE_SCREECH, MOVE_THUNDERBOLT}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 37,
    ...
    .moves = {MOVE_EARTH_POWER, MOVE_ANCIENT_POWER, MOVE_COSMIC_POWER, MOVE_EXTRASENSORY}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 39,
    ...
    .ability = ABILITY_MAGMA_ARMOR,
    .heldItem = ITEM_CHARCOAL,
    .moves = {MOVE_YAWN, MOVE_EARTH_POWER, MOVE_ROCK_SLIDE, MOVE_FLAMETHROWER}
    }
};
...
static const struct TrainerMon sParty_Gerald[] = {
    ...
    .moves = {MOVE_FLAMETHROWER, MOVE_CHAMELEE, MOVE_FEINT_ATTACK, MOVE_ANCIENT_POWER}
    }
};
...
static const struct TrainerMon sParty_Vivian[] = {
    ...
    .lvl = 20,
    .species = SPECIES_MEDITITE,
    .moves = {MOVE_WORK_UP, MOVE_DETECT, MOVE_PSYBEAM, MOVE_THUNDER_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(16, 16, 16, 16, 16, 16),
    .lvl = 20,
    .species = SPECIES_MORPEKO,
    .moves = {MOVE_QUICK_ATTACK, MOVE_FLATTER, MOVE_THUNDER_SHOCK, MOVE_BITE}
    }
};
...
static const struct TrainerMon sParty_Danielle[] = {
    ...
    .moves = {MOVE_ZEN_HEADBUTT, MOVE_DETECT, MOVE_FORCE_PALM, MOVE_FIRE_PUNCH}
    }
};
...
static const struct TrainerMon sParty_WallyVR2[] = {
    ...
    .lvl = 50,
    .species = SPECIES_PINSIR,
    .heldItem = ITEM_TOXIN_BOOSTER,
    .moves = {MOVE_EXO_BASH, MOVE_CLOSE_COMBAT, MOVE_KNOCK_OFF, MOVE_BULK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 51,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = ABILITY_WATER_ABSORB,
    .moves = {MOVE_REST, MOVE_FREEZE_DRY, MOVE_SLEEP_TALK, MOVE_LIQUIDATION}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 50,
    ...
    .moves = {MOVE_DAZZLING_GLEAM, MOVE_SLUDGE_BOMB, MOVE_GIGA_DRAIN, MOVE_TOXIC}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 51,
    ...
    .heldItem = ITEM_AIR_BALLOON,
    .ability = ABILITY_ANALYTIC,
    .moves = {MOVE_IRON_DEFENSE, MOVE_THUNDERBOLT, MOVE_TRI_ATTACK, MOVE_BODY_PRESS}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 52,
    ...
    .moves = {MOVE_DOUBLE_TEAM, MOVE_CALM_MIND, MOVE_PSYCHIC, MOVE_DAZZLING_GLEAM}
    }
};
...
static const struct TrainerMon sParty_TabithaMagmaHideout[] = {
    ...
    .ability = ABILITY_INTIMIDATE,
    .heldItem = ITEM_MUSCLE_BAND,
    .moves = {MOVE_FIRE_FANG, MOVE_HOWL, MOVE_CRUNCH, MOVE_TAUNT}
    },
    {
    .iv = TRAINER_PARTY_IVS(9, 9, 9, 9, 9, 9),
    .lvl = 33,
    ...
    .ability = ABILITY_HARVEST,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_AIR_SLASH, MOVE_SUNNY_DAY, MOVE_GROWTH, MOVE_RAZOR_LEAF}
    },
    {
    .iv = TRAINER_PARTY_IVS(9, 9, 9, 9, 9, 9),
    .lvl = 35,
    ...
    .ability = ABILITY_MAGMA_ARMOR,
    .heldItem = ITEM_CHARCOAL,
    .moves = {MOVE_ROCK_SLIDE, MOVE_EARTH_POWER, MOVE_CURSE, MOVE_LAVA_PLUME}
    },
    {
    .iv = TRAINER_PARTY_IVS(9, 9, 9, 9, 9, 9),
    .lvl = 34,
    ...
    .moves = {MOVE_BULLDOZE, MOVE_IRON_HEAD, MOVE_SMACK_DOWN, MOVE_HARDEN}
    }
};
...
static const struct TrainerMon sParty_Angelo[] = {
    ...
    .species = SPECIES_ILLUMISE,
    .heldItem = ITEM_MAGNET,
    .moves = {MOVE_SHOCK_WAVE, MOVE_QUICK_ATTACK, MOVE_CHARM, MOVE_THUNDER_WAVE}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 19,
    ...
    .moves = {MOVE_SHOCK_WAVE, MOVE_QUICK_ATTACK, MOVE_CONFUSE_RAY, MOVE_THUNDER_WAVE}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 21,
    .species = SPECIES_VESPIQUEN,
    .moves = {MOVE_CONFUSE_RAY, MOVE_STRUGGLE_BUG, MOVE_GUST, MOVE_SHOCK_WAVE}
    }
};
