...
extern const struct SpriteTemplate gFieldEffectObjectTemplate_TallGrass_OverworldEncounter;
extern const struct SpriteTemplate gFieldEffectObjectTemplate_LongGrass_OverworldEncounter;
