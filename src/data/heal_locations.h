static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_TEST_CAMP - 1] = {MAP_GROUP(TEST_CAMP), MAP_NUM(TEST_CAMP), 3, 7},
    [HEAL_LOCATION_TOWN_SPRAGHOLT - 1] = {MAP_GROUP(TOWN_SPRAGHOLT), MAP_NUM(TOWN_SPRAGHOLT), 16, 16},
    [HEAL_LOCATION_TOWN_BRAKSTRAND - 1] = {MAP_GROUP(TOWN_BRAKSTRAND), MAP_NUM(TOWN_BRAKSTRAND), 10, 10},
    [HEAL_LOCATION_ROUTE02 - 1] = {MAP_GROUP(ROUTE02), MAP_NUM(ROUTE02), 22, 10},
};
