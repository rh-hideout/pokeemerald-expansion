#define DEFAULT_POKEMON_CENTRE_COORDS .x = 7, .y = 4

static const struct HealLocation sHealLocationsPokemonCentre[HEAL_LOCATION_COUNT - 1] =
{
    ...
    {
        .group = MAP_GROUP(PETALBURG_CITY_POKEMON_CENTRE_1F),
        .map = MAP_NUM(PETALBURG_CITY_POKEMON_CENTRE_1F),
        DEFAULT_POKEMON_CENTRE_COORDS,
    },
    [HEAL_LOCATION_SLATEPORT_CITY - 1] =
    {
        .group = MAP_GROUP(SLATEPORT_CITY_POKEMON_CENTRE_1F),
        .map = MAP_NUM(SLATEPORT_CITY_POKEMON_CENTRE_1F),
        DEFAULT_POKEMON_CENTRE_COORDS,
    },
    [HEAL_LOCATION_MAUVILLE_CITY - 1] =
    {
        .group = MAP_GROUP(MAUVILLE_CITY_POKEMON_CENTRE_1F),
        .map = MAP_NUM(MAUVILLE_CITY_POKEMON_CENTRE_1F),
        DEFAULT_POKEMON_CENTRE_COORDS,
    },
    [HEAL_LOCATION_RUSTBORO_CITY - 1] =
    {
        .group = MAP_GROUP(RUSTBORO_CITY_POKEMON_CENTRE_1F),
        .map = MAP_NUM(RUSTBORO_CITY_POKEMON_CENTRE_1F),
        DEFAULT_POKEMON_CENTRE_COORDS,
    },
    [HEAL_LOCATION_FORTREE_CITY - 1] =
    {
        .group = MAP_GROUP(FORTREE_CITY_POKEMON_CENTRE_1F),
        .map = MAP_NUM(FORTREE_CITY_POKEMON_CENTRE_1F),
        DEFAULT_POKEMON_CENTRE_COORDS,
    },
    [HEAL_LOCATION_LILYCOVE_CITY - 1] =
    {
        .group = MAP_GROUP(LILYCOVE_CITY_POKEMON_CENTRE_1F),
        .map = MAP_NUM(LILYCOVE_CITY_POKEMON_CENTRE_1F),
        DEFAULT_POKEMON_CENTRE_COORDS,
    },
    [HEAL_LOCATION_MOSSDEEP_CITY - 1] =
    {
        .group = MAP_GROUP(MOSSDEEP_CITY_POKEMON_CENTRE_1F),
        .map = MAP_NUM(MOSSDEEP_CITY_POKEMON_CENTRE_1F),
        DEFAULT_POKEMON_CENTRE_COORDS,
    },
    [HEAL_LOCATION_SOOTOPOLIS_CITY - 1] =
    {
        .group = MAP_GROUP(SOOTOPOLIS_CITY_POKEMON_CENTRE_1F),
        .map = MAP_NUM(SOOTOPOLIS_CITY_POKEMON_CENTRE_1F),
        DEFAULT_POKEMON_CENTRE_COORDS,
    },
    [HEAL_LOCATION_EVER_GRANDE_CITY - 1] =
    {
        .group = MAP_GROUP(EVER_GRANDE_CITY_POKEMON_CENTRE_1F),
        .map = MAP_NUM(EVER_GRANDE_CITY_POKEMON_CENTRE_1F),
        DEFAULT_POKEMON_CENTRE_COORDS,
    },
    ...
    {
        .group = MAP_GROUP(OLDALE_TOWN_POKEMON_CENTRE_1F),
        .map = MAP_NUM(OLDALE_TOWN_POKEMON_CENTRE_1F),
        DEFAULT_POKEMON_CENTRE_COORDS,
    },
    [HEAL_LOCATION_DEWFORD_TOWN - 1] =
    {
        .group = MAP_GROUP(DEWFORD_TOWN_POKEMON_CENTRE_1F),
        .map = MAP_NUM(DEWFORD_TOWN_POKEMON_CENTRE_1F),
        DEFAULT_POKEMON_CENTRE_COORDS,
    },
    [HEAL_LOCATION_LAVARIDGE_TOWN - 1] =
    {
        .group = MAP_GROUP(LAVARIDGE_TOWN_POKEMON_CENTRE_1F),
        .map = MAP_NUM(LAVARIDGE_TOWN_POKEMON_CENTRE_1F),
        DEFAULT_POKEMON_CENTRE_COORDS,
    },
    [HEAL_LOCATION_FALLARBOR_TOWN - 1] =
    {
        .group = MAP_GROUP(FALLARBOR_TOWN_POKEMON_CENTRE_1F),
        .map = MAP_NUM(FALLARBOR_TOWN_POKEMON_CENTRE_1F),
        DEFAULT_POKEMON_CENTRE_COORDS,
    },
    [HEAL_LOCATION_VERDANTURF_TOWN - 1] =
    {
        .group = MAP_GROUP(VERDANTURF_TOWN_POKEMON_CENTRE_1F),
        .map = MAP_NUM(VERDANTURF_TOWN_POKEMON_CENTRE_1F),
        DEFAULT_POKEMON_CENTRE_COORDS,
    },
    [HEAL_LOCATION_PACIFIDLOG_TOWN - 1] =
    {
        .group = MAP_GROUP(PACIFIDLOG_TOWN_POKEMON_CENTRE_1F),
        .map = MAP_NUM(PACIFIDLOG_TOWN_POKEMON_CENTRE_1F),
        DEFAULT_POKEMON_CENTRE_COORDS,
    },
    ...
    {
        .group = MAP_GROUP(BATTLE_FRONTIER_POKEMON_CENTRE_1F),
        .map = MAP_NUM(BATTLE_FRONTIER_POKEMON_CENTRE_1F),
        DEFAULT_POKEMON_CENTRE_COORDS,
    },
};

#undef DEFAULT_POKEMON_CENTRE_COORDS

// localIds can be found in the generated events.inc file for the specific heal location map
// e.g. for OldaleTown_PokemonCentre1F/events.inc the following entry gets generated:
// object_event 1, OBJ_EVENT_GFX_NURSE, 7, 2, 3, MOVEMENT_TYPE_FACE_DOWN, 0, 0, TRAINER_TYPE_NONE, 0, OldaleTown_PokemonCentre_1F_EventScript_Nurse, 0
