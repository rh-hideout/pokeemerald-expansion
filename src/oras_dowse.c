...
const u32 gFieldEffectObjectPic_ORASDowsingBrendan[] = INCGFX_U32("graphics/field_effects/pics/oras_dowsing_brendan.png", ".4bpp");
const u32 gFieldEffectObjectPic_ORASDowsingMay[] = INCGFX_U32("graphics/field_effects/pics/oras_dowsing_may.png", ".4bpp");
