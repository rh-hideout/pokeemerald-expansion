...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNPROTECTEDBYMIST]                  = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} is protected by the mist!"),
    ...
    [STRINGID_PKMNPREVENTSSTATLOSSWITH]             = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} prevents stat loss!"), //not in gen 5+, ability popup
    ...
    [STRINGID_STATROSE]                             = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}'s {B_BUFF1} {B_BUFF2}rose!"),
    ...
    [STRINGID_STATFELL]                             = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}'s {B_BUFF1} {B_BUFF2}fell!"),
    ...
    [STRINGID_CLEARAMULETWONTLOWERSTATS]            = COMPOUND_STRING("The effects of the {B_LAST_ITEM} held by {B_EFF_NAME_WITH_PREFIX2} prevents its stats from being lowered!"),
...
const u16 gStatUpStringIds[] =
{
    ...
    [B_MSG_BATTLER_STAT_CHANGED]  = STRINGID_STATROSE,
...
const u16 gStatDownStringIds[] =
{
    ...
    [B_MSG_BATTLER_STAT_CHANGED]  = STRINGID_STATFELL,
