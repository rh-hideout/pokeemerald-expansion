...
{
    [WEATHER_NONE]               = STRINGID_DARKNESSSTARTS,
    [WEATHER_SUNNY_CLOUDS]       = STRINGID_DARKNESSSTARTS,
    [WEATHER_SUNNY]              = STRINGID_DARKNESSSTARTS,
    ...
    [WEATHER_SHADE]              = STRINGID_DARKNESSSTARTS,
    [WEATHER_DROUGHT]            = STRINGID_SUNLIGHTISHARSH,
    [WEATHER_DOWNPOUR]           = STRINGID_ITISRAINING,
    [WEATHER_UNDERWATER_BUBBLES] = STRINGID_ITISRAINING,
    [WEATHER_ABNORMAL]           = STRINGID_ITISRAINING,
    [WEATHER_DARKNESS]           = STRINGID_DARKNESSSTARTS
};
