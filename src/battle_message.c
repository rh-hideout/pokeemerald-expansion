...
static const u8 sText_GotchaPkmnCaughtTrainer[] = _("Gotcha! {B_DEF_NAME} was caught!{WAIT_SE}\p");
...
static const u8 sText_ShadowPkmnNotice[] = _("Oh! A Shadow Pokémon!\p");
static const u8 sText_TrainerCallToMon[] = _("{B_ATK_TRAINER_NAME} called out to {B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnStoredEXP[] = _("{B_BUFF1} stored{B_BUFF2} {B_BUFF3} EXP. Points!\p");
static const u8 sText_PkmnHeartValueUpdate[] = _("The door to {B_BUFF1}'s heart opened a little!\p");
static const u8 sText_ReverseModeEnter[] = _("{B_ATK_NAME_WITH_PREFIX}'s emotions rose to a fever pitch! It entered Reverse Mode!");
