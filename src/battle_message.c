...
const u16 gAbilityWeatherChangeStringId[] =
{
    ...
    [B_MSG_STARTED_DESOLATE_LAND]  = STRINGID_HEAVYRAIN,
    [B_MSG_STARTED_PRIMORDIAL_SEA] = STRINGID_EXTREMELYHARSHSUNLIGHT,
    [B_MSG_STARTED_STRONG_WINDS]   = STRINGID_ATTACKWEAKENEDBSTRONGWINDS,
};
