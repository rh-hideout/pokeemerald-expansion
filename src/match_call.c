...
{
    { .text = MatchCall_PersonalizedText1,  .stringVarFuncIds = STRS_BATTLE_REQUEST },
    ...
    { .text = MatchCall_PersonalizedText13, .stringVarFuncIds = STRS_WILD_BATTLE },
    ...
    { .text = MatchCall_PersonalizedText18, .stringVarFuncIds = STRS_BATTLE_POSITIVE },
    ...
    { .text = MatchCall_PersonalizedText28, .stringVarFuncIds = STRS_BATTLE_POSITIVE },
    { .text = MatchCall_PersonalizedText29, .stringVarFuncIds = STRS_BATTLE_POSITIVE },
    ...
    { .text = MatchCall_PersonalizedText42, .stringVarFuncIds = STRS_BATTLE_POSITIVE },
    { .text = MatchCall_PersonalizedText43, .stringVarFuncIds = STRS_NORMAL_MSG },
    { .text = MatchCall_PersonalizedText44, .stringVarFuncIds = STRS_BATTLE_POSITIVE },
    ...
    { .text = MatchCall_PersonalizedText51, .stringVarFuncIds = STRS_BATTLE_REQUEST },
    { .text = MatchCall_PersonalizedText52, .stringVarFuncIds = STRS_BATTLE_POSITIVE },
    ...
    { .text = MatchCall_PersonalizedText55, .stringVarFuncIds = STRS_BATTLE_REQUEST },
