...
static bool32 DoesLeadingMonHaveAbilityEffect(const enum Ability *abilityArray)
{
...
static bool32 DoesPartyMemberMonHaveAbilityEffect(const enum Ability *abilityArray)
{
