...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(HAZELNAUT),
    HOENN_TO_NATIONAL(GINOCCHIO),
    HOENN_TO_NATIONAL(MAGMATA),
    HOENN_TO_NATIONAL(DELAVA),
    HOENN_TO_NATIONAL(SALEZERKER),
    HOENN_TO_NATIONAL(FRUDGE),
    HOENN_TO_NATIONAL(AQUAOS),
    HOENN_TO_NATIONAL(LEMIRETHUN),
    HOENN_TO_NATIONAL(BUGGY),
    HOENN_TO_NATIONAL(BUGATTI),
    HOENN_TO_NATIONAL(BULLEPEDE),
    HOENN_TO_NATIONAL(WHIMPLE),
    HOENN_TO_NATIONAL(WHIPSCUFFLE),
    HOENN_TO_NATIONAL(WHIPSICUFFS),
    HOENN_TO_NATIONAL(AFLOOF),
    HOENN_TO_NATIONAL(DISBEARY),
    HOENN_TO_NATIONAL(HAMSTATIC),
    HOENN_TO_NATIONAL(AMPSTAR),
    HOENN_TO_NATIONAL(FLORIBEL),
    HOENN_TO_NATIONAL(MOGERIA),
    HOENN_TO_NATIONAL(KIWI),
    HOENN_TO_NATIONAL(IWIK),
    HOENN_TO_NATIONAL(LARVITTY),
    HOENN_TO_NATIONAL(GRUMPOON),
    HOENN_TO_NATIONAL(KONEKOTH),
    HOENN_TO_NATIONAL(MONKITE),
    HOENN_TO_NATIONAL(KONGLIDE),
    HOENN_TO_NATIONAL(YOKITE),
    HOENN_TO_NATIONAL(JERMIN),
    HOENN_TO_NATIONAL(SKUBA),
    HOENN_TO_NATIONAL(SKUBMARINE),
    HOENN_TO_NATIONAL(PEDESTONE),
    HOENN_TO_NATIONAL(EROCHRE),
    HOENN_TO_NATIONAL(PILLAIA),
    HOENN_TO_NATIONAL(TRIACTITE),
    HOENN_TO_NATIONAL(WALKALACK),
    HOENN_TO_NATIONAL(MOGUMOLE),
    HOENN_TO_NATIONAL(BANDICUTE),
    HOENN_TO_NATIONAL(NAUGHTYCOOT),
    HOENN_TO_NATIONAL(SUBSTRALE),
    HOENN_TO_NATIONAL(PERMACEROS),
    HOENN_TO_NATIONAL(FRIJOLERO),
    HOENN_TO_NATIONAL(PICANTERO),
    HOENN_TO_NATIONAL(SHERIFUEGO),
    HOENN_TO_NATIONAL(JUANKEY),
    HOENN_TO_NATIONAL(EQUUAN),
    HOENN_TO_NATIONAL(SHROOMAG),
    HOENN_TO_NATIONAL(FUNGNET),
    HOENN_TO_NATIONAL(SYCOSECT),
    HOENN_TO_NATIONAL(BELIEECH),
    HOENN_TO_NATIONAL(ARACHNOTE),
    HOENN_TO_NATIONAL(BURNUGGET),
    HOENN_TO_NATIONAL(FLARHEA),
    HOENN_TO_NATIONAL(DIRTYBIS),
    HOENN_TO_NATIONAL(IBASK),
    HOENN_TO_NATIONAL(TURTINI),
    HOENN_TO_NATIONAL(TURTURRET),
    HOENN_TO_NATIONAL(MIMIKRAB),
    HOENN_TO_NATIONAL(SPYCRAB),
    HOENN_TO_NATIONAL(STOWLET),
    HOENN_TO_NATIONAL(STRIXNIGHT),
    HOENN_TO_NATIONAL(IMPFECTION),
    HOENN_TO_NATIONAL(INKROW),
    HOENN_TO_NATIONAL(LIQUILL),
    HOENN_TO_NATIONAL(RAVARNISH),
    HOENN_TO_NATIONAL(HYDUCK),
    HOENN_TO_NATIONAL(BLUDUCK),
    HOENN_TO_NATIONAL(PLATYLICS),
    HOENN_TO_NATIONAL(KRISSY),
    HOENN_TO_NATIONAL(KRACKODEMON),
    HOENN_TO_NATIONAL(TRIDERLING),
    HOENN_TO_NATIONAL(TARANTAGON),
    HOENN_TO_NATIONAL(COMMUTANT),
    HOENN_TO_NATIONAL(HYBROTAMUS),
    HOENN_TO_NATIONAL(CATOBIRRAFE),
    HOENN_TO_NATIONAL(CAMELODUCTOR),
    HOENN_TO_NATIONAL(VINEDUP),
    HOENN_TO_NATIONAL(RAMBOOM),
    HOENN_TO_NATIONAL(VINEBOMB),
    HOENN_TO_NATIONAL(FLUBBSTER),
    HOENN_TO_NATIONAL(BLUBBASTARD),
    HOENN_TO_NATIONAL(POLTIRE),
    HOENN_TO_NATIONAL(JUNKGEIST),
    HOENN_TO_NATIONAL(FOXCET),
    HOENN_TO_NATIONAL(YARDSTEIN),
    HOENN_TO_NATIONAL(ONUSALT),
    HOENN_TO_NATIONAL(GHASTROPOD),
    HOENN_TO_NATIONAL(WEATHERBANE),
    HOENN_TO_NATIONAL(CYCLONIAN),
    HOENN_TO_NATIONAL(MEATIER),
    HOENN_TO_NATIONAL(TUNGHASKA),
    HOENN_TO_NATIONAL(BRAXITYTAN),
    HOENN_TO_NATIONAL(DOOMTER),
    HOENN_TO_NATIONAL(HORNTUBA),
    HOENN_TO_NATIONAL(SANICKEL),
    HOENN_TO_NATIONAL(SKOXIOUS),
    HOENN_TO_NATIONAL(ROOTCHEW),
    HOENN_TO_NATIONAL(TOOFGREW),
    HOENN_TO_NATIONAL(HOGNAW),
    HOENN_TO_NATIONAL(FRYZZLE),
    HOENN_TO_NATIONAL(CARPEDIAN),
    HOENN_TO_NATIONAL(VOLTOCOR),
    HOENN_TO_NATIONAL(VOLBRAT),
    HOENN_TO_NATIONAL(VOLIATH),
    HOENN_TO_NATIONAL(SEAMAN),
    HOENN_TO_NATIONAL(BARABYSS),
    HOENN_TO_NATIONAL(STROLLGE),
    HOENN_TO_NATIONAL(WINKHULU),
    HOENN_TO_NATIONAL(TEMAWRIA),
    HOENN_TO_NATIONAL(RETWINA),
    HOENN_TO_NATIONAL(HOOKLING),
    HOENN_TO_NATIONAL(FRACTYVERN),
    HOENN_TO_NATIONAL(DOGAN),
    HOENN_TO_NATIONAL(SMOGARS),
    HOENN_TO_NATIONAL(BUBBASAUR),
    HOENN_TO_NATIONAL(BUNGALOON),
    HOENN_TO_NATIONAL(ENVILE),
    HOENN_TO_NATIONAL(KAUSTIKROK),
    HOENN_TO_NATIONAL(WATTITUDE),
    HOENN_TO_NATIONAL(SWINGGLE),
    HOENN_TO_NATIONAL(MALEENTIS),
    HOENN_TO_NATIONAL(TADPOISON),
    HOENN_TO_NATIONAL(BRETKHELM),
    HOENN_TO_NATIONAL(BERFGOYLE),
    HOENN_TO_NATIONAL(FLUBUNNY),
    HOENN_TO_NATIONAL(LEPOOZE),
    HOENN_TO_NATIONAL(LUNABBIT),
    HOENN_TO_NATIONAL(HELMATA),
    HOENN_TO_NATIONAL(PUNKUYU),
    HOENN_TO_NATIONAL(CHAMELEE),
    HOENN_TO_NATIONAL(CAMEREX),
    HOENN_TO_NATIONAL(TAMANAUT),
    HOENN_TO_NATIONAL(STARHIRO),
    HOENN_TO_NATIONAL(DOUBTLAW),
    HOENN_TO_NATIONAL(SHROOMALICE),
    HOENN_TO_NATIONAL(SPORESTOOL),
    HOENN_TO_NATIONAL(VIRTUITA),
    HOENN_TO_NATIONAL(MEOWER),
    HOENN_TO_NATIONAL(CATATION),
    HOENN_TO_NATIONAL(YUUKIINO),
    HOENN_TO_NATIONAL(AQUADIIVA),
    HOENN_TO_NATIONAL(FIRVID),
    HOENN_TO_NATIONAL(CHOLEFIR),
    HOENN_TO_NATIONAL(MAMINI),
    HOENN_TO_NATIONAL(MAMMOUNT),
    HOENN_TO_NATIONAL(KNITTEN),
    HOENN_TO_NATIONAL(SABSUTE),
    HOENN_TO_NATIONAL(DOLLGHOST),
    HOENN_TO_NATIONAL(PARMIAUSAN),
    HOENN_TO_NATIONAL(PIURETTE),
    HOENN_TO_NATIONAL(PASCAL),
    HOENN_TO_NATIONAL(KOROKAMI),
    HOENN_TO_NATIONAL(FLOCKARRION),
    HOENN_TO_NATIONAL(SEPULTURE),
    HOENN_TO_NATIONAL(MAGGHOST),
    HOENN_TO_NATIONAL(COCCURN),
    HOENN_TO_NATIONAL(PHAMOTHOM),
    HOENN_TO_NATIONAL(GANGLYTHON),
    HOENN_TO_NATIONAL(MOBLIN),
    HOENN_TO_NATIONAL(FANGSTER),
    HOENN_TO_NATIONAL(MAFIADON),
    HOENN_TO_NATIONAL(GHARROSTE),
    HOENN_TO_NATIONAL(FLEURRIUM),
    HOENN_TO_NATIONAL(CRISTANIUM),
    HOENN_TO_NATIONAL(TOKOYAKI),
    HOENN_TO_NATIONAL(ONSENPURA),
    HOENN_TO_NATIONAL(PEASOL),
    HOENN_TO_NATIONAL(VAPONOBI),
    HOENN_TO_NATIONAL(HAARSHOGUN),
    HOENN_TO_NATIONAL(SIMIONACH),
    HOENN_TO_NATIONAL(EPIPHEROR),
    HOENN_TO_NATIONAL(LEOPAWN),
    HOENN_TO_NATIONAL(DEVANTE),
    HOENN_TO_NATIONAL(VERGILION),
    HOENN_TO_NATIONAL(LARVATRICE),
    HOENN_TO_NATIONAL(BRASHALISK),
    HOENN_TO_NATIONAL(KOKAIJU),
    HOENN_TO_NATIONAL(LEVITITAN),
    HOENN_TO_NATIONAL(MEDUSITH),
    HOENN_TO_NATIONAL(DISPLACERK),
    HOENN_TO_NATIONAL(FABRINNIAL),
    HOENN_TO_NATIONAL(CANVELLIA),
    HOENN_TO_NATIONAL(GUERTENITY),
    HOENN_TO_NATIONAL(FUCKER),
    HOENN_TO_NATIONAL(MANTASM),
    HOENN_TO_NATIONAL(ORYUGAMI),
    HOENN_TO_NATIONAL(TOWHORSE),
    HOENN_TO_NATIONAL(DUBSNAKE),
    HOENN_TO_NATIONAL(HYDROIL),
    HOENN_TO_NATIONAL(COILSPILL),
    HOENN_TO_NATIONAL(KRAMBERRY),
    HOENN_TO_NATIONAL(FAUSTIVAL),
    HOENN_TO_NATIONAL(BAMBUYA),
    HOENN_TO_NATIONAL(JUMBLEGORE),
    HOENN_TO_NATIONAL(JUMBLINART),
    HOENN_TO_NATIONAL(ADENTITY),
    HOENN_TO_NATIONAL(POLYBRAWN),
    HOENN_TO_NATIONAL(EMEFFYUME),
    HOENN_TO_NATIONAL(PEGUI),
    HOENN_TO_NATIONAL(PECHIT),
    HOENN_TO_NATIONAL(COPOLAR),
    HOENN_TO_NATIONAL(WYCERN),
    HOENN_TO_NATIONAL(BITTERAGON),
    HOENN_TO_NATIONAL(ARCTIGLOBE),
    HOENN_TO_NATIONAL(VRISKELETON),
    HOENN_TO_NATIONAL(COFFERULE),
    HOENN_TO_NATIONAL(GAROOKIE),
    HOENN_TO_NATIONAL(GARBLE),
    HOENN_TO_NATIONAL(GARGARRAMER),
    HOENN_TO_NATIONAL(BORKOSMOS),
    HOENN_TO_NATIONAL(SKALLAXY),
    HOENN_TO_NATIONAL(AIRUITE),
    HOENN_TO_NATIONAL(KAQUAPO),
    HOENN_TO_NATIONAL(NEBULITE),
    HOENN_TO_NATIONAL(ECCOSMIC),
    HOENN_TO_NATIONAL(LOBER),
    HOENN_TO_NATIONAL(CLOBBER),
    HOENN_TO_NATIONAL(SPIRANHA),
    HOENN_TO_NATIONAL(SELAGHAST),
    HOENN_TO_NATIONAL(KARKUTLASS),
    HOENN_TO_NATIONAL(RENDALOPOD),
    HOENN_TO_NATIONAL(SACCESTODA),
    HOENN_TO_NATIONAL(GLUCURS),
    HOENN_TO_NATIONAL(AMALGUM),
    HOENN_TO_NATIONAL(VORTRIX),
    HOENN_TO_NATIONAL(JAHL),
    HOENN_TO_NATIONAL(FUSJAHL),
    HOENN_TO_NATIONAL(MOLTAMA),
    HOENN_TO_NATIONAL(MOLTERRA),
    HOENN_TO_NATIONAL(FETTORCH),
    HOENN_TO_NATIONAL(MANICLE),
    HOENN_TO_NATIONAL(SHAIKLE),
    HOENN_TO_NATIONAL(TRICKLING),
    HOENN_TO_NATIONAL(DRAKLOWN),
    HOENN_TO_NATIONAL(DRATTEL),
    HOENN_TO_NATIONAL(ZILLICHINA),
    HOENN_TO_NATIONAL(ICEHUGGER),
    HOENN_TO_NATIONAL(XENINTER),
    HOENN_TO_NATIONAL(SPHARE),
    HOENN_TO_NATIONAL(COSTRIKE),
    HOENN_TO_NATIONAL(SPARMOR),
    HOENN_TO_NATIONAL(OHMADILLO),
    HOENN_TO_NATIONAL(COLOMBOLT),
    HOENN_TO_NATIONAL(EMOJINN),
    HOENN_TO_NATIONAL(BEAREDAZE),
    HOENN_TO_NATIONAL(KUMATARO),
    HOENN_TO_NATIONAL(OUROBLACK),
    HOENN_TO_NATIONAL(REVELOROS),
    HOENN_TO_NATIONAL(VENIREAL),
    HOENN_TO_NATIONAL(APOCAMISE),
    HOENN_TO_NATIONAL(CROLORD),
    HOENN_TO_NATIONAL(JARUMITE),
    HOENN_TO_NATIONAL(SERPOTINE),
    HOENN_TO_NATIONAL(TSEMANI),
    HOENN_TO_NATIONAL(VANITWIN),
    HOENN_TO_NATIONAL(DREDGOD),
    HOENN_TO_NATIONAL(SCHIZSTARF),
    HOENN_TO_NATIONAL(QRAKENMARK),
    HOENN_TO_NATIONAL(EPILATE),
    HOENN_TO_NATIONAL(ULMIRAINT),
    HOENN_TO_NATIONAL(NOXILIUM),
    HOENN_TO_NATIONAL(INDIGNIFLY),
    HOENN_TO_NATIONAL(DINOMIGHT),
    HOENN_TO_NATIONAL(COCKEN),
    HOENN_TO_NATIONAL(PRIMITOOL),
    HOENN_TO_NATIONAL(PRIMITEVE),
    HOENN_TO_NATIONAL(MOYALITH),
    HOENN_TO_NATIONAL(WAWHO),
    //HOENN_TO_NATIONAL(REGIRODE),
    //HOENN_TO_NATIONAL(REGIMELT),
    //HOENN_TO_NATIONAL(REGIRUST),
    HOENN_TO_NATIONAL(REGISHORT),
    HOENN_TO_NATIONAL(REGICIDE),
    HOENN_TO_NATIONAL(REGIGIGONE),
    HOENN_TO_NATIONAL(GLACIUN),
    HOENN_TO_NATIONAL(GALVADEUX),
    HOENN_TO_NATIONAL(PYROTROIS),
    HOENN_TO_NATIONAL(ANKHIRA),
    HOENN_TO_NATIONAL(ANKHPU),
    HOENN_TO_NATIONAL(ANKHURAH),
    HOENN_TO_NATIONAL(SQUITHEE),
    HOENN_TO_NATIONAL(GOBLAZER),
    HOENN_TO_NATIONAL(WARGHORK),
    HOENN_TO_NATIONAL(RANRUU),
    HOENN_TO_NATIONAL(LOITUMA),
    HOENN_TO_NATIONAL(IGNIFATU),
    HOENN_TO_NATIONAL(SPENJBAB),
    HOENN_TO_NATIONAL(GIGAPUDDI),
    HOENN_TO_NATIONAL(EMPIDAE),
    HOENN_TO_NATIONAL(PHANTORNEY),
    HOENN_TO_NATIONAL(CIRNUMIRU),
    HOENN_TO_NATIONAL(SERAPHILL),
    HOENN_TO_NATIONAL(SHIRIBIKO),
    HOENN_TO_NATIONAL(NYANONITE),
    HOENN_TO_NATIONAL(KLASICOPE),
    HOENN_TO_NATIONAL(ESSENTION),
    HOENN_TO_NATIONAL(TERMAGNIUS),
    HOENN_TO_NATIONAL(FORGOTNO),
    HOENN_TO_NATIONAL(DOOMSAY),
    HOENN_TO_NATIONAL(SABLINI),
    HOENN_TO_NATIONAL(THEFOREST),
    HOENN_TO_NATIONAL(DOOMSDAY),
    HOENN_TO_NATIONAL(REGIRODE),
    HOENN_TO_NATIONAL(REGIMELT),
    HOENN_TO_NATIONAL(REGIRUST),
};
