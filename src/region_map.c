...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_SEVII_ISLE_6] = {MAP_GROUP(MAP_PROTOTYPE_SEVII_ISLE_6), MAP_NUM(MAP_PROTOTYPE_SEVII_ISLE_6), HEAL_LOCATION_NONE},
    [MAPSEC_SEVII_ISLE_7] = {MAP_GROUP(MAP_PROTOTYPE_SEVII_ISLE_7), MAP_NUM(MAP_PROTOTYPE_SEVII_ISLE_7), HEAL_LOCATION_NONE},
    [MAPSEC_SEVII_ISLE_8] = {MAP_GROUP(MAP_PROTOTYPE_SEVII_ISLE_8), MAP_NUM(MAP_PROTOTYPE_SEVII_ISLE_8), HEAL_LOCATION_NONE},
    [MAPSEC_SEVII_ISLE_9] = {MAP_GROUP(MAP_PROTOTYPE_SEVII_ISLE_9), MAP_NUM(MAP_PROTOTYPE_SEVII_ISLE_9), HEAL_LOCATION_NONE},
