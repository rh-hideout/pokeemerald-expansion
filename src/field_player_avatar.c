...
static const u16 sJustinAvatarGfxIds[] =
{
    [PLAYER_AVATAR_STATE_NORMAL] = OBJ_EVENT_GFX_JUSTIN_NORMAL,
    [PLAYER_AVATAR_STATE_MACH_BIKE] = OBJ_EVENT_GFX_JUSTIN_MACH_BIKE,
    [PLAYER_AVATAR_STATE_ACRO_BIKE] = OBJ_EVENT_GFX_JUSTIN_ACRO_BIKE,
    [PLAYER_AVATAR_STATE_SURFING] = OBJ_EVENT_GFX_JUSTIN_SURFING,
    [PLAYER_AVATAR_STATE_UNDERWATER] = OBJ_EVENT_GFX_JUSTIN_UNDERWATER,
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = OBJ_EVENT_GFX_JUSTIN_FIELD_MOVE,
    [PLAYER_AVATAR_STATE_FISHING] = OBJ_EVENT_GFX_JUSTIN_FISHING,
    [PLAYER_AVATAR_STATE_WATERING] = OBJ_EVENT_GFX_JUSTIN_WATERING,
    [PLAYER_AVATAR_STATE_VSSEEKER] = OBJ_EVENT_GFX_JUSTIN_FIELD_MOVE,
};

static const u16 sLexyAvatarGfxIds[] =
{
    [PLAYER_AVATAR_STATE_NORMAL] = OBJ_EVENT_GFX_LEXY_NORMAL,
    [PLAYER_AVATAR_STATE_MACH_BIKE] = OBJ_EVENT_GFX_LEXY_MACH_BIKE,
    [PLAYER_AVATAR_STATE_ACRO_BIKE] = OBJ_EVENT_GFX_LEXY_ACRO_BIKE,
    [PLAYER_AVATAR_STATE_SURFING] = OBJ_EVENT_GFX_LEXY_SURFING,
    [PLAYER_AVATAR_STATE_UNDERWATER] = OBJ_EVENT_GFX_LEXY_UNDERWATER,
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = OBJ_EVENT_GFX_LEXY_FIELD_MOVE,
    [PLAYER_AVATAR_STATE_FISHING] = OBJ_EVENT_GFX_LEXY_FISHING,
    [PLAYER_AVATAR_STATE_WATERING] = OBJ_EVENT_GFX_LEXY_WATERING,
    [PLAYER_AVATAR_STATE_VSSEEKER] = OBJ_EVENT_GFX_LEXY_FIELD_MOVE,
};

static const u16 sMaamAvatarGfxIds[] =
{
    [PLAYER_AVATAR_STATE_NORMAL] = OBJ_EVENT_GFX_MAAM_NORMAL,
    [PLAYER_AVATAR_STATE_MACH_BIKE] = OBJ_EVENT_GFX_MAAM_MACH_BIKE,
    [PLAYER_AVATAR_STATE_ACRO_BIKE] = OBJ_EVENT_GFX_MAAM_ACRO_BIKE,
    [PLAYER_AVATAR_STATE_SURFING] = OBJ_EVENT_GFX_MAAM_SURFING,
    [PLAYER_AVATAR_STATE_UNDERWATER] = OBJ_EVENT_GFX_MAAM_UNDERWATER,
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = OBJ_EVENT_GFX_MAAM_FIELD_MOVE,
    [PLAYER_AVATAR_STATE_FISHING] = OBJ_EVENT_GFX_MAAM_FISHING,
    [PLAYER_AVATAR_STATE_WATERING] = OBJ_EVENT_GFX_MAAM_WATERING,
    [PLAYER_AVATAR_STATE_VSSEEKER] = OBJ_EVENT_GFX_MAAM_FIELD_MOVE,
};

static const u16 sSirAvatarGfxIds[] =
{
    [PLAYER_AVATAR_STATE_NORMAL] = OBJ_EVENT_GFX_SIR_NORMAL,
    [PLAYER_AVATAR_STATE_MACH_BIKE] = OBJ_EVENT_GFX_SIR_MACH_BIKE,
    [PLAYER_AVATAR_STATE_ACRO_BIKE] = OBJ_EVENT_GFX_SIR_ACRO_BIKE,
    [PLAYER_AVATAR_STATE_SURFING] = OBJ_EVENT_GFX_SIR_SURFING,
    [PLAYER_AVATAR_STATE_UNDERWATER] = OBJ_EVENT_GFX_SIR_UNDERWATER,
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = OBJ_EVENT_GFX_SIR_FIELD_MOVE,
    [PLAYER_AVATAR_STATE_FISHING] = OBJ_EVENT_GFX_SIR_FISHING,
    [PLAYER_AVATAR_STATE_WATERING] = OBJ_EVENT_GFX_SIR_WATERING,
    [PLAYER_AVATAR_STATE_VSSEEKER] = OBJ_EVENT_GFX_SIR_FIELD_MOVE,
};
...
u16 GetPlayerAvatarGraphicsIdByStateId(u8 state)
{
    ...
    {
    case 1:
        return sJustinAvatarGfxIds[state];

    case 3:
        return sMaamAvatarGfxIds[state];

    case 4:
        return sSirAvatarGfxIds[state];

    case 5:
        return sLexyAvatarGfxIds[state];
...
enum Gender GetPlayerAvatarGenderByGraphicsId(u16 gfxId)
{
   ...
   case OBJ_EVENT_GFX_MAAM_NORMAL:
   case OBJ_EVENT_GFX_MAAM_MACH_BIKE:
   case OBJ_EVENT_GFX_MAAM_ACRO_BIKE:
   case OBJ_EVENT_GFX_MAAM_SURFING:
   case OBJ_EVENT_GFX_MAAM_FIELD_MOVE:
   case OBJ_EVENT_GFX_MAAM_UNDERWATER:
   case OBJ_EVENT_GFX_MAAM_FISHING:
   case OBJ_EVENT_GFX_MAAM_WATERING:
   case OBJ_EVENT_GFX_LEXY_NORMAL:
   case OBJ_EVENT_GFX_LEXY_MACH_BIKE:
   case OBJ_EVENT_GFX_LEXY_ACRO_BIKE:
   case OBJ_EVENT_GFX_LEXY_SURFING:
   case OBJ_EVENT_GFX_LEXY_FIELD_MOVE:
   case OBJ_EVENT_GFX_LEXY_UNDERWATER:
   case OBJ_EVENT_GFX_LEXY_FISHING:
   case OBJ_EVENT_GFX_LEXY_WATERING:
    return FEMALE;
        return FEMALE;
    default:
        return MALE;
