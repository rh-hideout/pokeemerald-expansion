...
{
    [ITEM_NONE]                                 = {gBerryPic_Enigma, gBerryPalette_Enigma},
    [ITEM_TO_BERRY(ITEM_CHERI_BERRY)]           = {gBerryPic_Cheri,  gBerryPalette_Cheri},
    [ITEM_TO_BERRY(ITEM_CHESTO_BERRY)]          = {gBerryPic_Chesto, gBerryPalette_Chesto},
    [ITEM_TO_BERRY(ITEM_PECHA_BERRY)]           = {gBerryPic_Pecha,  gBerryPalette_Pecha},
    [ITEM_TO_BERRY(ITEM_RAWST_BERRY)]           = {gBerryPic_Rawst,  gBerryPalette_Rawst},
    [ITEM_TO_BERRY(ITEM_ASPEAR_BERRY)]          = {gBerryPic_Aspear, gBerryPalette_Aspear},
    [ITEM_TO_BERRY(ITEM_LEPPA_BERRY)]           = {gBerryPic_Leppa,  gBerryPalette_Leppa},
    [ITEM_TO_BERRY(ITEM_ORAN_BERRY)]            = {gBerryPic_Oran,   gBerryPalette_Oran},
    [ITEM_TO_BERRY(ITEM_PERSIM_BERRY)]          = {gBerryPic_Persim, gBerryPalette_Persim},
    [ITEM_TO_BERRY(ITEM_LUM_BERRY)]             = {gBerryPic_Lum,    gBerryPalette_Lum},
    [ITEM_TO_BERRY(ITEM_SITRUS_BERRY)]          = {gBerryPic_Sitrus, gBerryPalette_Sitrus},
    [ITEM_TO_BERRY(ITEM_FIGY_BERRY)]            = {gBerryPic_Figy,   gBerryPalette_Figy},
    [ITEM_TO_BERRY(ITEM_WIKI_BERRY)]            = {gBerryPic_Wiki,   gBerryPalette_Wiki},
    [ITEM_TO_BERRY(ITEM_MAGO_BERRY)]            = {gBerryPic_Mago,   gBerryPalette_Mago},
    [ITEM_TO_BERRY(ITEM_AGUAV_BERRY)]           = {gBerryPic_Aguav,  gBerryPalette_Aguav},
    [ITEM_TO_BERRY(ITEM_IAPAPA_BERRY)]          = {gBerryPic_Iapapa, gBerryPalette_Iapapa},
    [ITEM_TO_BERRY(ITEM_RAZZ_BERRY)]            = {gBerryPic_Razz,   gBerryPalette_Razz},
    [ITEM_TO_BERRY(ITEM_BLUK_BERRY)]            = {gBerryPic_Bluk,   gBerryPalette_Bluk},
    [ITEM_TO_BERRY(ITEM_NANAB_BERRY)]           = {gBerryPic_Nanab,  gBerryPalette_Nanab},
    [ITEM_TO_BERRY(ITEM_WEPEAR_BERRY)]          = {gBerryPic_Wepear, gBerryPalette_Wepear},
    [ITEM_TO_BERRY(ITEM_PINAP_BERRY)]           = {gBerryPic_Pinap,  gBerryPalette_Pinap},
    [ITEM_TO_BERRY(ITEM_POMEG_BERRY)]           = {gBerryPic_Pomeg,  gBerryPalette_Pomeg},
    [ITEM_TO_BERRY(ITEM_KELPSY_BERRY)]          = {gBerryPic_Kelpsy, gBerryPalette_Kelpsy},
    [ITEM_TO_BERRY(ITEM_QUALOT_BERRY)]          = {gBerryPic_Qualot, gBerryPalette_Qualot},
    [ITEM_TO_BERRY(ITEM_HONDEW_BERRY)]          = {gBerryPic_Hondew, gBerryPalette_Hondew},
    [ITEM_TO_BERRY(ITEM_GREPA_BERRY)]           = {gBerryPic_Grepa,  gBerryPalette_Grepa},
    [ITEM_TO_BERRY(ITEM_TAMATO_BERRY)]          = {gBerryPic_Tamato, gBerryPalette_Tamato},
    [ITEM_TO_BERRY(ITEM_CORNN_BERRY)]           = {gBerryPic_Cornn,  gBerryPalette_Cornn},
    [ITEM_TO_BERRY(ITEM_MAGOST_BERRY)]          = {gBerryPic_Magost, gBerryPalette_Magost},
    [ITEM_TO_BERRY(ITEM_RABUTA_BERRY)]          = {gBerryPic_Rabuta, gBerryPalette_Rabuta},
    [ITEM_TO_BERRY(ITEM_NOMEL_BERRY)]           = {gBerryPic_Nomel,  gBerryPalette_Nomel},
    [ITEM_TO_BERRY(ITEM_SPELON_BERRY)]          = {gBerryPic_Spelon, gBerryPalette_Spelon},
    [ITEM_TO_BERRY(ITEM_PAMTRE_BERRY)]          = {gBerryPic_Pamtre, gBerryPalette_Pamtre},
    [ITEM_TO_BERRY(ITEM_WATMEL_BERRY)]          = {gBerryPic_Watmel, gBerryPalette_Watmel},
    [ITEM_TO_BERRY(ITEM_DURIN_BERRY)]           = {gBerryPic_Durin,  gBerryPalette_Durin},
    [ITEM_TO_BERRY(ITEM_BELUE_BERRY)]           = {gBerryPic_Belue,  gBerryPalette_Belue},
    [ITEM_TO_BERRY(ITEM_CHILAN_BERRY)]          = {gBerryPic_Chilan, gBerryPalette_Chilan},
    [ITEM_TO_BERRY(ITEM_OCCA_BERRY)]            = {gBerryPic_Occa, gBerryPalette_Occa},
    [ITEM_TO_BERRY(ITEM_PASSHO_BERRY)]          = {gBerryPic_Passho, gBerryPalette_Passho},
    [ITEM_TO_BERRY(ITEM_WACAN_BERRY)]           = {gBerryPic_Wacan, gBerryPalette_Wacan},
    [ITEM_TO_BERRY(ITEM_RINDO_BERRY)]           = {gBerryPic_Rindo, gBerryPalette_Rindo},
    [ITEM_TO_BERRY(ITEM_YACHE_BERRY)]           = {gBerryPic_Yache, gBerryPalette_Yache},
    [ITEM_TO_BERRY(ITEM_CHOPLE_BERRY)]          = {gBerryPic_Chople, gBerryPalette_Chople},
    [ITEM_TO_BERRY(ITEM_KEBIA_BERRY)]           = {gBerryPic_Kebia, gBerryPalette_Kebia},
    [ITEM_TO_BERRY(ITEM_SHUCA_BERRY)]           = {gBerryPic_Shuca, gBerryPalette_Shuca},
    [ITEM_TO_BERRY(ITEM_COBA_BERRY)]            = {gBerryPic_Coba, gBerryPalette_Coba},
    [ITEM_TO_BERRY(ITEM_PAYAPA_BERRY)]          = {gBerryPic_Payapa, gBerryPalette_Payapa},
    [ITEM_TO_BERRY(ITEM_TANGA_BERRY)]           = {gBerryPic_Tanga, gBerryPalette_Tanga},
    [ITEM_TO_BERRY(ITEM_CHARTI_BERRY)]          = {gBerryPic_Charti, gBerryPalette_Charti},
    [ITEM_TO_BERRY(ITEM_KASIB_BERRY)]           = {gBerryPic_Kasib, gBerryPalette_Kasib},
    [ITEM_TO_BERRY(ITEM_HABAN_BERRY)]           = {gBerryPic_Haban, gBerryPalette_Haban},
    [ITEM_TO_BERRY(ITEM_COLBUR_BERRY)]          = {gBerryPic_Colbur, gBerryPalette_Colbur},
    [ITEM_TO_BERRY(ITEM_BABIRI_BERRY)]          = {gBerryPic_Babiri, gBerryPalette_Babiri},
    [ITEM_TO_BERRY(ITEM_ROSELI_BERRY)]          = {gBerryPic_Roseli, gBerryPalette_Roseli},
    [ITEM_TO_BERRY(ITEM_LIECHI_BERRY)]          = {gBerryPic_Liechi, gBerryPalette_Liechi},
    [ITEM_TO_BERRY(ITEM_GANLON_BERRY)]          = {gBerryPic_Ganlon, gBerryPalette_Ganlon},
    [ITEM_TO_BERRY(ITEM_SALAC_BERRY)]           = {gBerryPic_Salac,  gBerryPalette_Salac},
    [ITEM_TO_BERRY(ITEM_PETAYA_BERRY)]          = {gBerryPic_Petaya, gBerryPalette_Petaya},
    [ITEM_TO_BERRY(ITEM_APICOT_BERRY)]          = {gBerryPic_Apicot, gBerryPalette_Apicot},
    [ITEM_TO_BERRY(ITEM_LANSAT_BERRY)]          = {gBerryPic_Lansat, gBerryPalette_Lansat},
    [ITEM_TO_BERRY(ITEM_STARF_BERRY)]           = {gBerryPic_Starf,  gBerryPalette_Starf},
    [ITEM_TO_BERRY(ITEM_ENIGMA_BERRY)]          = {gBerryPic_Enigma, gBerryPalette_Enigma},
    [ITEM_TO_BERRY(ITEM_MICLE_BERRY)]           = {gBerryPic_Micle, gBerryPalette_Micle},
    [ITEM_TO_BERRY(ITEM_CUSTAP_BERRY)]          = {gBerryPic_Custap, gBerryPalette_Custap},
    [ITEM_TO_BERRY(ITEM_JABOCA_BERRY)]          = {gBerryPic_Jaboca, gBerryPalette_Jaboca},
    [ITEM_TO_BERRY(ITEM_ROWAP_BERRY)]           = {gBerryPic_Rowap, gBerryPalette_Rowap},
    [ITEM_TO_BERRY(ITEM_KEE_BERRY)]             = {gBerryPic_Kee, gBerryPalette_Kee},
    [ITEM_TO_BERRY(ITEM_MARANGA_BERRY)]         = {gBerryPic_Maranga, gBerryPalette_Maranga},
    [ITEM_TO_BERRY(ITEM_ENIGMA_BERRY_E_READER)] = {gBerryPic_Enigma, gBerryPalette_Enigma},
};
