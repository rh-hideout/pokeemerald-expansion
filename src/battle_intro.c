...
static void BattleIntroNoSlide(u8 taskId)
{
    ...
    case 3:
        ...
        SetGpuReg(REG_OFFSET_BG1CNT, BGCNT_PRIORITY(0) | BGCNT_CHARBASE(0) | BGCNT_16COLOUR | BGCNT_SCREENBASE(28) | BGCNT_TXT256x512);
        SetGpuReg(REG_OFFSET_BG2CNT, BGCNT_PRIORITY(0) | BGCNT_CHARBASE(0) | BGCNT_16COLOUR | BGCNT_SCREENBASE(30) | BGCNT_TXT512x256);
        break;
    case 4:
...
static void BattleIntroSlidePartner(u8 taskId)
{
    ...
    case 1:
        ...
        {
            gTasks[taskId].tState++;
            SetGpuReg(REG_OFFSET_BG1CNT, BGCNT_PRIORITY(2) | BGCNT_CHARBASE(2) | BGCNT_16COLOUR | BGCNT_SCREENBASE(28) | BGCNT_TXT512x256);
            SetGpuReg(REG_OFFSET_BG2CNT, BGCNT_PRIORITY(2) | BGCNT_CHARBASE(2) | BGCNT_16COLOUR | BGCNT_SCREENBASE(30) | BGCNT_TXT512x256);
