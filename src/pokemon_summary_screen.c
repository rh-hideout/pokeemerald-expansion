...
static void CB2_ReturnToSummaryScreenFromNamingScreen(void)
{
    SetMonData(&gParties[B_TRAINER_0][gSpecialVar_0x8004], MON_DATA_NICKNAME, gStringVar2);
...
static void CB2_PssChangePokemonNickname(void)
{
    GetMonData(&gParties[B_TRAINER_0][gSpecialVar_0x8004], MON_DATA_NICKNAME, gStringVar3);
    GetMonData(&gParties[B_TRAINER_0][gSpecialVar_0x8004], MON_DATA_NICKNAME, gStringVar2);
    DoNamingScreen(NAMING_SCREEN_NICKNAME, gStringVar2, GetMonData(&gParties[B_TRAINER_0][gSpecialVar_0x8004], MON_DATA_SPECIES, NULL), 
                    GetMonGender(&gParties[B_TRAINER_0][gSpecialVar_0x8004]), GetMonData(&gParties[B_TRAINER_0][gSpecialVar_0x8004], MON_DATA_PERSONALITY, NULL), 
