...
static void BufferStat(u8 *dst, u8 natureMod, u32 stat, u32 strId, u32 n);
...
static void BufferIvOrEvStats(u8 mode)
{
    ...
    default:
        ...
        BufferStat(gStringVar2, STAT_ATK, ModifyStatByNature(sMonSummaryScreen->summary.nature, atk, STAT_ATK), 2, 7);
        BufferStat(gStringVar3, STAT_DEF, ModifyStatByNature(sMonSummaryScreen->summary.nature, def, STAT_DEF), 3, 7);
        DynamicPlaceholderTextUtil_ExpandPlaceholders(gStringVar4, sStatsLeftColumnLayout);
        PrintLeftColumnStats();

        BufferStat(gStringVar1, STAT_SPATK, ModifyStatByNature(sMonSummaryScreen->summary.nature, spA, STAT_SPATK), 0, 3);
        BufferStat(gStringVar2, STAT_SPDEF, ModifyStatByNature(sMonSummaryScreen->summary.nature, spD, STAT_SPDEF), 1, 3);
        BufferStat(gStringVar3, STAT_SPEED, ModifyStatByNature(sMonSummaryScreen->summary.nature, spe, STAT_SPEED), 2, 3);
