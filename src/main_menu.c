 ...
 * Task_NewGameBirchSpeech_StartBirchPsyduckPlatformFade
 * Task_NewGameBirchSpeech_StartBirchPsyduckPlatformFade
 ...
 * Task_NewGameBirchSpeech_ReshowBirchPsyduck
 ...
 *  - Advances to Task_NewGameBirchSpeechSub_WaitForPsyduck
 * Task_NewGameBirchSpeechSub_WaitForPsyduck
...
static void Task_NewGameBirchSpeechSub_WaitForPsyduck(u8);
static void Task_NewGameBirchSpeech_StartBirchPsyduckPlatformFade(u8);
...
static void Task_NewGameBirchSpeech_ReshowBirchPsyduck(u8);
...
{
    u8 spriteId = gTasks[sBirchSpeechMainTaskId].tPsyduckSpriteId;
    ...
    gTasks[taskId].func = Task_NewGameBirchSpeechSub_WaitForPsyduck;
    gTasks[sBirchSpeechMainTaskId].tTimer = 0;
}

static void Task_NewGameBirchSpeechSub_WaitForPsyduck(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    struct Sprite *sprite = &gSprites[gTasks[sBirchSpeechMainTaskId].tPsyduckSpriteId];
...
static void Task_NewGameBirchSpeech_AndYouAre(u8 taskId)
{
    if (!RunTextPrintersAndIsPrinter0Active())
    {
        ...
        AddTextPrinterForMessage(TRUE);
        gTasks[taskId].func = Task_NewGameBirchSpeech_StartBirchPsyduckPlatformFade;
    }
}

static void Task_NewGameBirchSpeech_StartBirchPsyduckPlatformFade(u8 taskId)
{
    if (!RunTextPrintersAndIsPrinter0Active())
    {
...
static void Task_NewGameBirchSpeech_StartPlayerFadeIn(u8 taskId)
{
    if (gTasks[taskId].tIsDoneFadingSprites)
    {
        ...
        gSprites[gTasks[taskId].tPsyduckSpriteId].invisible = TRUE;
        if (gTasks[taskId].tTimer)
        {
            gTasks[taskId].tTimer--;
        }
...
static void Task_NewGameBirchSpeech_SlidePlatformAway2(u8 taskId)
{
    ...
    {
        gTasks[taskId].func = Task_NewGameBirchSpeech_ReshowBirchPsyduck;
    }
}

static void Task_NewGameBirchSpeech_ReshowBirchPsyduck(u8 taskId)
{
    u8 spriteId;
    ...
    if (gTasks[taskId].tIsDoneFadingSprites)
    {
        ...
        gSprites[spriteId].invisible = FALSE;
        gSprites[spriteId].oam.objMode = ST_OAM_OBJ_BLEND;
        spriteId = gTasks[taskId].tPsyduckSpriteId;
        gSprites[spriteId].x = 100;
        gSprites[spriteId].y = 75;
        gSprites[spriteId].invisible = FALSE;
        gSprites[spriteId].oam.objMode = ST_OAM_OBJ_BLEND;
...
static void Task_NewGameBirchSpeech_WaitForSpriteFadeInAndTextPrinter(u8 taskId)
{
    ...
    {
        gSprites[gTasks[taskId].tBirchSpriteId].oam.objMode = ST_OAM_OBJ_NORMAL;
        gSprites[gTasks[taskId].tPsyduckSpriteId].oam.objMode = ST_OAM_OBJ_NORMAL;
        if (!RunTextPrintersAndIsPrinter0Active())
        {
            gSprites[gTasks[taskId].tBirchSpriteId].oam.objMode = ST_OAM_OBJ_BLEND;
            gSprites[gTasks[taskId].tPsyduckSpriteId].oam.objMode = ST_OAM_OBJ_BLEND;
...
static u8 NewGameBirchSpeech_CreatePsyduckSprite(u8 x, u8 y)
{
...
static void AddBirchSpeechObjects(u8 taskId)
{
    ...
    psyduckSpriteId = NewGameBirchSpeech_CreatePsyduckSprite(100, 0x4B);
    gSprites[psyduckSpriteId].callback = SpriteCB_Null;
    gSprites[psyduckSpriteId].oam.priority = 0;
    gSprites[psyduckSpriteId].invisible = TRUE;
    gTasks[taskId].tPsyduckSpriteId = psyduckSpriteId;
