...
static const union AnimCmd sAnim_Terminal[] =
{
    ANIMCMD_FRAME(0, 0),
    ANIMCMD_END
};
static const union AnimCmd *const sAnimTable_Terminal[] =
{
    sAnim_Terminal
};
...
{
    .tileTag = TAG_BIRCH_SPEECH_TERMINAL,
    .paletteTag = TAG_BIRCH_SPEECH_TERMINAL,
    .oam = &gObjectEventBaseOam_16x32,
    .anims = sAnimTable_Terminal,
    .images = NULL,
