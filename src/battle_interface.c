...
static void PrintHpOnHealthbox(u32 spriteId, s16 currHp, s16 maxHp, u32 bgColor, u8 yOffset)
{
    ...
    *txtPtr++ = CHAR_SLASH;
    ...
    SpriteFillRectWithColor(spriteId, 4, 4, 12, 12, 10);
    //  Clear out old text first
    SpriteFillRectWithColor(spriteId, 32, 24, 32, 8, 2);
    SpriteFillRectWithColor(gSprites[spriteId].oam.affineParam, 0, 24, 32, 8, 2);
...
void UpdateHpTextInHealthbox(u32 healthboxSpriteId, u32 maxOrCurrent, s16 currHp, s16 maxHp)
{
    ...
    case BATTLE_COORDS_SINGLES:
    {
        ...
        {
            PrintHpOnHealthbox(healthboxSpriteId, currHp, maxHp, 0, 16);
        }
        else // Opponent
        {
...
static void UpdateHpTextInHealthboxInDoubles(u32 healthboxSpriteId, u32 maxOrCurrent, s16 currHp, s16 maxHp)
{
    ...
    if (IsOnPlayerSide(gSprites[healthboxSpriteId].hMain_Battler))
    {
        ...
        {
            PrintHpOnHealthbox(barSpriteId, currHp, maxHp, 0, 8);
