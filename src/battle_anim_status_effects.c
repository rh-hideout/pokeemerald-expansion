...
void AnimTask_StatsChange(u8 taskId)
{
    ...
    {
    case STAT_ANIM_PLUS1:  goesDown = FALSE;                 break;
    case STAT_ANIM_PLUS2:  goesDown = FALSE; sharply = TRUE; break;
    case STAT_ANIM_MINUS1: goesDown = TRUE;                  break;
    case STAT_ANIM_MINUS2: goesDown = TRUE; sharply = TRUE;  break;
    default:
        DestroyAnimVisualTask(taskId);
        return;
    }
    switch (gBattleSpritesDataPtr->animationData->animArg)
    {
    case STAT_ATK:        animStatId = STAT_ANIM_PAL_ATK;      break;
    case STAT_DEF:        animStatId = STAT_ANIM_PAL_DEF;      break;
    case STAT_SPEED:      animStatId = STAT_ANIM_PAL_SPEED;    break;
    case STAT_SPATK:      animStatId = STAT_ANIM_PAL_SPATK;    break;
    case STAT_SPDEF:      animStatId = STAT_ANIM_PAL_SPDEF;    break;
    case STAT_ACC:        animStatId = STAT_ANIM_PAL_ACC;      break;
    case STAT_EVASION:    animStatId = STAT_ANIM_PAL_EVASION;  break;
    default:
        DestroyAnimVisualTask(taskId);
        return;
    }
