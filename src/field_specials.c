...
{
    u16 monData;
    CreateMon(&gPlayerParty[0], SPECIES_LILLIPUP, 7, USE_RANDOM_IVS, FALSE, 0, OT_ID_PLAYER_ID, 0);/// species_lillipup
    monData = TRUE;
...
static const u8 *const sScrollableMultichoiceOptions[][MAX_SCROLL_MULTI_LENGTH] =
{
    ...
    {
        COMPOUND_STRING("KISS POSTER{CLEAR_TO 0x5E}2BP"),
        COMPOUND_STRING("KISS CUSHION{CLEAR_TO 0x5E}4BP"),
        COMPOUND_STRING("SMOOCHUM DOLL{CLEAR_TO 0x5E}4BP"),
        COMPOUND_STRING("TOGEPI DOLL{CLEAR_TO 0x5E}6BP"),
        COMPOUND_STRING("MEOWTH DOLL{CLEAR_TO 0x5E}6BP"),
        COMPOUND_STRING("CLEFAIRY DOLL{CLEAR_TO 0x5E}6BP"),
        COMPOUND_STRING("DITTO DOLL{CLEAR_TO 0x5E}6BP"),
        COMPOUND_STRING("CYNDAQUIL DOLL{CLEAR_TO 0x5E}10BP"),
        COMPOUND_STRING("CHIKORITA DOLL{CLEAR_TO 0x5E}10BP"),
        COMPOUND_STRING("TOTODILE DOLL{CLEAR_TO 0x5E}10BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_DECOR_VENDOR_2] =
    {
        COMPOUND_STRING("LAPRAS DOLL{CLEAR_TO 0x58}16BP"),
        COMPOUND_STRING("SNORLAX DOLL{CLEAR_TO 0x58}16BP"),
        COMPOUND_STRING("VENUSAUR DOLL{CLEAR_TO 0x58}32BP"),
        COMPOUND_STRING("CHARIZARD DOLL{CLEAR_TO 0x58}32BP"),
        COMPOUND_STRING("BLASTOISE DOLL{CLEAR_TO 0x58}32BP"),
        gText_Exit
    },
    ...
    {
        COMPOUND_STRING("LEFTOVERS{CLEAR_TO 0x5E}6BP"),
        COMPOUND_STRING("WHITE HERB{CLEAR_TO 0x5E}6BP"),
        COMPOUND_STRING("QUICK CLAW{CLEAR_TO 0x5E}6BP"),
        COMPOUND_STRING("MENTAL HERB{CLEAR_TO 0x5E}6BP"),
        COMPOUND_STRING("BRIGHTPOWDER{CLEAR_TO 0x5E}8BP"),
        COMPOUND_STRING("CHOICE BAND{CLEAR_TO 0x5E}8BP"),
        COMPOUND_STRING("KING'S ROCK{CLEAR_TO 0x5E}8BP"),
        COMPOUND_STRING("FOCUS BAND{CLEAR_TO 0x5E}8BP"),
        COMPOUND_STRING("SCOPE LENS{CLEAR_TO 0x5E}8BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BERRY_POWDER_VENDOR] =
    {
        ...
        COMPOUND_STRING("REVIVAL HERB{CLEAR_TO 108}{FONT_SMALL}200"),
        COMPOUND_STRING("PROTEIN{CLEAR_TO 108}{FONT_SMALL}300"),
        COMPOUND_STRING("IRON{CLEAR_TO 108}{FONT_SMALL}300"),
        COMPOUND_STRING("CARBOS{CLEAR_TO 108}{FONT_SMALL}300"),
        COMPOUND_STRING("CALCIUM{CLEAR_TO 108}{FONT_SMALL}300"),
        COMPOUND_STRING("ZINC{CLEAR_TO 108}{FONT_SMALL}300"),
        COMPOUND_STRING("HP UP{CLEAR_TO 108}{FONT_SMALL}300"),
        COMPOUND_STRING("PP UP{CLEAR_TO 99}{FONT_SMALL}1,000"),
        COMPOUND_STRING("RARE CANDY{CLEAR_TO 99}{FONT_SMALL}1,000"),
        gText_Exit
    },
    ...
    {
        COMPOUND_STRING("SOFTBOILED{CLEAR_TO 0x4E}2BP"),
        COMPOUND_STRING("SEISMIC TOSS{CLEAR_TO 0x4E}3BP"),
        COMPOUND_STRING("DREAM EATER{CLEAR_TO 0x4E}3BP"),
        COMPOUND_STRING("MEGA PUNCH{CLEAR_TO 0x4E}3BP"),
        COMPOUND_STRING("MEGA KICK{CLEAR_TO 0x4E}6BP"),
        COMPOUND_STRING("BODY SLAM{CLEAR_TO 0x4E}6BP"),
        COMPOUND_STRING("ROCK SLIDE{CLEAR_TO 0x4E}6BP"),
        COMPOUND_STRING("COUNTER{CLEAR_TO 0x4E}6BP"),
        COMPOUND_STRING("THUNDER WAVE{CLEAR_TO 0x4E}6BP"),
        COMPOUND_STRING("SWORDS DANCE{CLEAR_TO 0x4E}6BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_MOVE_TUTOR_2] =
    {
        COMPOUND_STRING("DEFENSE CURL{CLEAR_TO 0x4E}2BP"),
        COMPOUND_STRING("SNORE{CLEAR_TO 0x4E}3BP"),
        COMPOUND_STRING("MUD-SLAP{CLEAR_TO 0x4E}3BP"),
        COMPOUND_STRING("SWIFT{CLEAR_TO 0x4E}3BP"),
        COMPOUND_STRING("FROST BREATH{CLEAR_TO 0x4E}6BP"),
        COMPOUND_STRING("ENDURE{CLEAR_TO 0x4E}6BP"),
        COMPOUND_STRING("PSYCH UP{CLEAR_TO 0x4E}6BP"),
        COMPOUND_STRING("ICE PUNCH{CLEAR_TO 0x4E}6BP"),
        COMPOUND_STRING("THUNDERPUNCH{CLEAR_TO 0x4E}6BP"),
        COMPOUND_STRING("FIRE PUNCH{CLEAR_TO 0x4E}6BP"),
        gText_Exit
    },
