...
static void Task_OnSelectedMon(u8 taskId)
{
    ...
    case 2:
        ...
        case MENU_SELECT:
            ...
            if (sInPartyMenu)
            {
                gSpecialVar_Result = GetBoxMonData(&gParties[B_TRAINER_0][sCursorPosition].box, MON_DATA_SPECIES);
                gSpecialVar_MonBoxId = TOTAL_BOXES_COUNT;
                gSpecialVar_0x8005 = GetNumberOfRelearnableMoves(&gParties[B_TRAINER_0][sCursorPosition]);
            }
            else
            {
                ...
                gSpecialVar_0x8005 = GetNumberOfRelearnableMoves(&gParties[B_TRAINER_0][0]);
            }
