...
} sBreedingSpecialMoveItemTable[] =
{
    ...
    { SPECIES_FOXCET, ITEM_MYSTIC_WATER, MOVE_SNIPE_SHOT },
    { SPECIES_MANTASM, ITEM_PRETTY_FEATHER, MOVE_BRAVE_BIRD },
    { SPECIES_ARCTIGLOBE, ITEM_STICKY_BARB, MOVE_SPIKY_SHIELD },
    { SPECIES_NOXILIUM, ITEM_MOLUGANION, MOVE_REFRESH },
    { SPECIES_FUCKER, ITEM_LUCKY_PUNCH, MOVE_CROSS_CHOP },
    { SPECIES_GARGARRAMER, ITEM_HARD_STONE, MOVE_PETRIFY },
    ...
    { SPECIES_FRACTYVERN, ITEM_RED_CARD, MOVE_TRUMP_CARD },
    { SPECIES_MOYALITH, ITEM_KINGS_ROCK , MOVE_PRECIPICE_BLADES },  
    { SPECIES_GANGLYTHON, ITEM_TWISTED_SPOON , MOVE_KINESIS },  
    ...
    { SPECIES_CRISTANIUM, ITEM_GRIP_CLAW , MOVE_MEMENTO }, /////// WHETSTONE
    { SPECIES_VANITWIN, ITEM_SPELL_TAG , MOVE_SPECTRAL_THIEF },
    { SPECIES_YARDSTEIN, ITEM_CELL_BATTERY , MOVE_FINAL_GAMBIT }, 
    { SPECIES_YOKITE, ITEM_PROTECTIVE_PADS , MOVE_DARKEST_LARIAT },
    { SPECIES_DISPLACERK, ITEM_SPELL_TAG , MOVE_SPIRIT_SHACKLE },  
    { SPECIES_MOGERIA, ITEM_GRASSY_SEED , MOVE_SLEEP_POWDER },  
    { SPECIES_COFFERULE, ITEM_QUICK_CLAW , MOVE_ACCELEROCK },  
    { SPECIES_EQUUAN, ITEM_LIGHT_BALL , MOVE_VOLT_TACKLE },  
    { SPECIES_IWIK, ITEM_MIRACLE_SEED , MOVE_JUNGLE_HEALING },
    { SPECIES_KOROKAMI, ITEM_LUXURY_BALL , MOVE_SPIRIT_BREAK },
    { SPECIES_FLARHEA, ITEM_AIR_BALLOON, MOVE_HIGH_JUMP_KICK },
    ...
    { SPECIES_VIRTUITA, ITEM_LOVE_BALL , MOVE_PLAY_ROUGH },
    { SPECIES_ULMIRAINT, ITEM_CELL_BATTERY , MOVE_ZAP_CANNON },
    { SPECIES_BAMBUYA, ITEM_CHARCOAL , MOVE_MIND_BLOWN },
    { SPECIES_BITTERAGON, ITEM_FIRE_GEM, MOVE_ICE_BURN },
    { SPECIES_CHOLEFIR, ITEM_SNOWBALL, MOVE_GLACIAL_LANCE },
    { SPECIES_COLOMBOLT, ITEM_CELL_BATTERY, MOVE_VOLT_TACKLE },
    { SPECIES_VOLIATH, ITEM_ELECTRIC_SEED, MOVE_BOLT_STRIKE },
    { SPECIES_PEDESTONE, ITEM_HARD_STONE, MOVE_ROCK_WRECKER },
    { SPECIES_RAVARNISH, ITEM_SMOKE_BALL, MOVE_GASTRO_ACID }, /// STERILIZING AMPOULE
    { SPECIES_CATATION, ITEM_MENTAL_HERB, MOVE_FLOWER_SHIELD },  
    { SPECIES_MAFIADON, ITEM_CHOICE_BAND, MOVE_DRAGON_HAMMER },  
    { SPECIES_SEPULTURE, ITEM_THROAT_SPRAY, MOVE_SONIC_BOOM }, /////7 PLACEHOLDER
    { SPECIES_SCHIZSTARF, ITEM_STARF_BERRY, MOVE_STUFF_CHEEKS },
    { SPECIES_WAWHO, ITEM_NUGGET, MOVE_MEMENTO },
    { SPECIES_PHAMOTHOM, ITEM_BRIGHT_POWDER, MOVE_BLUE_FLARE },  
    { SPECIES_PERMACEROS, ITEM_NEVER_MELT_ICE, MOVE_GLACIAL_LANCE },
    { SPECIES_MALEENTIS, ITEM_BLACK_BELT, MOVE_CROSS_CHOP },
    ...
    { SPECIES_GHASTROPOD, ITEM_POISON_BARB, MOVE_VENOM_DRENCH },
    { SPECIES_COPOLAR, ITEM_METAL_COAT, MOVE_SHARPEN }, // REPLACE ITEM WITH WHETSTONE,
    { SPECIES_CLOBBER, ITEM_GRIP_CLAW, MOVE_CRUSH_GRIP }, 
    { SPECIES_BRAXITYTAN, ITEM_HARD_STONE, MOVE_ANCIENT_POWER },
    { SPECIES_KAUSTIKROK, ITEM_SHED_SHELL, MOVE_JAW_LOCK },
    { SPECIES_SEPULTURE, ITEM_DESTINY_KNOT, MOVE_PERISH_SONG },
    { SPECIES_WEATHERBANE, ITEM_WACAN_BERRY, MOVE_GUILLOTINE }, 
    { SPECIES_CYCLONIAN, ITEM_CELL_BATTERY, MOVE_SHIFT_GEAR },
    { SPECIES_DUBSNAKE, ITEM_BLACK_SLUDGE, MOVE_RECOVER }, 
    { SPECIES_LEOPAWN, ITEM_FAIRY_GEM, MOVE_GEOMANCY },
    { SPECIES_POLYBRAWN, ITEM_SHOCK_DRIVE, MOVE_FINAL_GAMBIT }, 
    { SPECIES_ADENTITY, ITEM_PSYCHIC_GEM, MOVE_PRISMATIC_LASER }, 
    { SPECIES_ONSENPURA, ITEM_ROCK_INCENSE, MOVE_SHORE_UP }, 
    // { SPECIES_LUNABBIT, ITEM_, MOVE_ }, 
};
