...
{
    static const u16 egggatcha_species[] = { SPECIES_ZORUA_HISUIAN, SPECIES_RIOLU, SPECIES_SPRIGATITO, SPECIES_FUECOCO, 
    SPECIES_QUAXLY, SPECIES_CHESPIN, SPECIES_FENNEKIN, SPECIES_PHIONE, SPECIES_FROAKIE, SPECIES_GROWLITHE_HISUIAN, 
    SPECIES_MAGIKARP, SPECIES_BUDEW, SPECIES_COMBEE, SPECIES_TURTWIG, SPECIES_PIPLUP, SPECIES_CHIMCHAR, SPECIES_EEVEE, 
    SPECIES_ALT_ABSOL, SPECIES_ABSOL, SPECIES_ABRA, SPECIES_RALTS, SPECIES_LARVITAR, SPECIES_ZIGZAGOON, 
    SPECIES_ZIGZAGOON_GALARIAN, SPECIES_POOCHYENA, SPECIES_TAILLOW, SPECIES_WINGULL, SPECIES_WATTREL, SPECIES_SEEDOT, 
    SPECIES_LOTAD, SPECIES_RATTATA, SPECIES_RATTATA_ALOLAN, SPECIES_PICHU, SPECIES_HATENNA, SPECIES_TINKATINK, 
    SPECIES_MILCERY, SPECIES_FALINKS, SPECIES_SNOM, SPECIES_INDEEDEE, SPECIES_LECHONK, SPECIES_NYMBLE, SPECIES_PAWMI, 
    SPECIES_TANDEMAUS, SPECIES_FIDOUGH, SPECIES_SMOLIV, SPECIES_SQUAWKABILLY_BLUE_PLUMAGE, SPECIES_BELDUM, SPECIES_BAGON, 
    SPECIES_GIBLE, SPECIES_NACLI, SPECIES_LUVDISC, SPECIES_TYRUNT, SPECIES_VULPIX_ALOLAN, SPECIES_ALT_RALTS, SPECIES_SIGILYPH,
    SPECIES_TRAPINCH, SPECIES_DRATINI, SPECIES_SCORBUNNY, SPECIES_JANGMO_O, SPECIES_TREECKO, SPECIES_BIDOOF, SPECIES_ARON,
    SPECIES_ROGGENROLA, SPECIES_TIMBURR, SPECIES_TYMPOLE, SPECIES_GASTLY, SPECIES_HAPPINY, SPECIES_YANMA, SPECIES_SNORUNT, 
    SPECIES_TOEDSCOOL, SPECIES_HOUNDOUR, SPECIES_MISDREAVUS, SPECIES_SHUCKLE, SPECIES_STANTLER, SPECIES_AIPOM, SPECIES_MAREEP,
    SPECIES_PINECO, SPECIES_AMAURA, SPECIES_MAGBY, SPECIES_TEDDIURSA, SPECIES_SEVIPER, SPECIES_PHANPY, SPECIES_ROCKRUFF, 
    SPECIES_CHATOT, SPECIES_PIDGEY, SPECIES_PORYGON, SPECIES_KOFFING, SPECIES_VOLTORB_HISUIAN, SPECIES_SNEASEL, SPECIES_SNEASEL_HISUIAN, 
    SPECIES_GOOMY, SPECIES_SALANDIT, SPECIES_GRIMER_ALOLAN, SPECIES_CYCLIZAR, SPECIES_FOMANTIS, SPECIES_BOMBIRDIER, SPECIES_DEERLING_WINTER,
    SPECIES_BLIPBUG, SPECIES_GLIGAR, SPECIES_PONYTA_GALARIAN };
    u16 randomSpeciesidx = Random() % ARRAY_COUNT(egggatcha_species);
    return egggatcha_species[randomSpeciesidx];
}

u16 ChooseRandomEggSpeciesIII(void)
{
    static const u16 egggatchacha_species[] = { SPECIES_ZORUA_HISUIAN, SPECIES_SPRIGATITO, SPECIES_FUECOCO,
    SPECIES_QUAXLY, SPECIES_CHESPIN, SPECIES_FENNEKIN, SPECIES_FROAKIE, SPECIES_PHIONE, SPECIES_TURTWIG, SPECIES_PIPLUP, SPECIES_CHIMCHAR, 
    SPECIES_EEVEE, SPECIES_LARVITAR, SPECIES_BELDUM, SPECIES_BAGON, SPECIES_GIBLE, SPECIES_VULPIX_ALOLAN, SPECIES_ALT_RALTS, SPECIES_DRATINI, 
    SPECIES_SCORBUNNY, SPECIES_JANGMO_O, SPECIES_TREECKO, SPECIES_SNEASEL_HISUIAN, SPECIES_GOOMY, SPECIES_PONYTA_GALARIAN, SPECIES_CHARMANDER,
    SPECIES_BULBASAUR, SPECIES_SQUIRTLE, SPECIES_CHIKORITA, SPECIES_CYNDAQUIL, SPECIES_TOTODILE, SPECIES_TORCHIC, SPECIES_MUDKIP, SPECIES_SNIVY,
    SPECIES_TEPIG, SPECIES_OSHAWOTT, SPECIES_ROWLET, SPECIES_LITTEN, SPECIES_POPPLIO, SPECIES_GROOKEY, SPECIES_SOBBLE, SPECIES_DEINO, 
    SPECIES_DREEPY, SPECIES_FRIGIBAX, SPECIES_SANDSHREW_ALOLAN, SPECIES_MEOWTH_GALARIAN, SPECIES_GROWLITHE_HISUIAN, SPECIES_GEODUDE_ALOLAN,
    SPECIES_SLOWPOKE_GALARIAN, SPECIES_FARFETCHD_GALARIAN, SPECIES_SNEASEL_HISUIAN, SPECIES_QWILFISH_HISUIAN, SPECIES_CORSOLA_GALARIAN, 
    SPECIES_DARUMAKA_GALARIAN, SPECIES_YAMASK_GALARIAN };
    u16 randomSpeciesidx = Random() % ARRAY_COUNT(egggatchacha_species);
    return egggatchacha_species[randomSpeciesidx];
}
