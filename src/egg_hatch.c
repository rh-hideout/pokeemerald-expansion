...
{
    static const u16 egggatcha_species[] = { SPECIES_ZORUA_HISUI, SPECIES_RIOLU, SPECIES_SPRIGATITO, SPECIES_FUECOCO, 
    SPECIES_QUAXLY, SPECIES_CHESPIN, SPECIES_FENNEKIN, SPECIES_PHIONE, SPECIES_FROAKIE, SPECIES_GROWLITHE_HISUI, 
    ...
    SPECIES_ZIGZAGOON_GALAR, SPECIES_POOCHYENA, SPECIES_TAILLOW, SPECIES_WINGULL, SPECIES_WATTREL, SPECIES_SEEDOT, 
    SPECIES_LOTAD, SPECIES_RATTATA, SPECIES_RATTATA_ALOLA, SPECIES_PICHU, SPECIES_HATENNA, SPECIES_TINKATINK, 
    SPECIES_MILCERY, SPECIES_FALINKS, SPECIES_SNOM, SPECIES_INDEEDEE, SPECIES_LECHONK, SPECIES_NYMBLE, SPECIES_PAWMI, 
    SPECIES_TANDEMAUS, SPECIES_FIDOUGH, SPECIES_SMOLIV, SPECIES_SQUAWKABILLY_BLUE, SPECIES_BELDUM, SPECIES_BAGON, 
    SPECIES_GIBLE, SPECIES_NACLI, SPECIES_LUVDISC, SPECIES_TYRUNT, SPECIES_VULPIX_ALOLA, SPECIES_ALT_RALTS, SPECIES_SIGILYPH,
    ...
    SPECIES_CHATOT, SPECIES_PIDGEY, SPECIES_PORYGON, SPECIES_KOFFING, SPECIES_VOLTORB_HISUI, SPECIES_SNEASEL, SPECIES_SNEASEL_HISUI, 
    SPECIES_GOOMY, SPECIES_SALANDIT, SPECIES_GRIMER_ALOLA, SPECIES_CYCLIZAR, SPECIES_FOMANTIS, SPECIES_BOMBIRDIER, SPECIES_DEERLING_WINTER,
    SPECIES_BLIPBUG, SPECIES_GLIGAR, SPECIES_PONYTA_GALAR };
...
{
    static const u16 egggatchacha_species[] = { SPECIES_ZORUA_HISUI, SPECIES_SPRIGATITO, SPECIES_FUECOCO,
    ...
    SPECIES_EEVEE, SPECIES_LARVITAR, SPECIES_BELDUM, SPECIES_BAGON, SPECIES_GIBLE, SPECIES_VULPIX_ALOLA, SPECIES_ALT_RALTS, SPECIES_DRATINI, 
    SPECIES_SCORBUNNY, SPECIES_JANGMO_O, SPECIES_TREECKO, SPECIES_SNEASEL_HISUI, SPECIES_GOOMY, SPECIES_PONYTA_GALAR, SPECIES_CHARMANDER,
    ...
    SPECIES_DREEPY, SPECIES_FRIGIBAX, SPECIES_SANDSHREW_ALOLA, SPECIES_MEOWTH_GALAR, SPECIES_GROWLITHE_HISUI, SPECIES_GEODUDE_ALOLA,
    SPECIES_SLOWPOKE_GALAR, SPECIES_FARFETCHD_GALAR, SPECIES_SNEASEL_HISUI, SPECIES_QWILFISH_HISUI, SPECIES_CORSOLA_GALAR, 
    SPECIES_DARUMAKA_GALAR, SPECIES_YAMASK_GALAR };
