...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_UNOWN_CAVERN] = MAPPOPUP_THEME_STONE,
    [MAPSEC_LITTLEROOT_CAVE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_RUSTURF_CAVERN] = MAPPOPUP_THEME_STONE,
    [MAPSEC_METEOR_CAVE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_PETALBURG_CAVE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_DEWFORD_CAVE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_SLATECOVE_CAVE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_MT_PYRE_CATACOMB] = MAPPOPUP_THEME_STONE,
    [MAPSEC_GALARIAN_CAVE] = MAPPOPUP_THEME_STONE,
