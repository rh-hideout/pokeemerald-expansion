...
bool32 CanBeParalyzed(u32 battler, u32 battlerDef, u32 abilityDef);
...
bool32 CanSetNonVolatileStatus(u32 battlerAtk, u32 battlerDef, u32 abilityDef, enum MoveEffects secondaryMoveEffect, enum NonVolatileStatus option);
