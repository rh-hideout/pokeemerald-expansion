...
enum
{
    ...
    #define POKENAV_SUBSTRUCT_COUNT (POKENAV_SUBSTRUCT_MON_LIST + 1)
};
...
enum
{
    ...
    #define POKENAV_MENU_TYPE_COUNT (POKENAV_MENU_TYPE_CONDITION_SEARCH + 1)
};
...
enum
{
    ...
    #define HELPBAR_COUNT (HELPBAR_RIBBONS_CHECK + 1)
};
...
enum
{
    ...
    MC_HEADER_DRAKE,
    MC_HEADER_WALLACE
    #define MC_HEADER_COUNT (MC_HEADER_WALLACE + 1)
};
...
enum
{
    ...
    #define MATCH_CALL_OPTION_COUNT (MATCH_CALL_OPTION_CANCEL + 1)
};
...
enum
{
    ...
    CHECK_PAGE_INTRO_1,
    CHECK_PAGE_INTRO_2
    #define CHECK_PAGE_ENTRY_COUNT (CHECK_PAGE_INTRO_2 + 1)
};
