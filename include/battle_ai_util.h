...
enum ShouldChangeStats BattlerShouldChangeStats(enum BattlerId battlerAtk, enum BattlerId battlerDef, enum Move statMove, u32 dmgMoveIndex, enum ChangeStatContext context, s16 atkStatChanges[NUM_BATTLE_STATS], s16 defStatChanges[NUM_BATTLE_STATS]);
