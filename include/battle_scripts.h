...
extern const u8 BattleScript_FlingConsumeBerry[];
...
extern const u8 BattleScript_EffBattlerAtFullHp[];
...
extern const u8 BattleScript_AbilityCuredInfatuationAndTaunt[];
...
extern const u8 BattleScript_TryRoomServiceLoop[];
...
extern const u8 BattleScript_SwitchInNeutralizingGas[];
...
extern const u8 BattleScript_MoveUsedHealBlockPreventsRet[];
...
extern const u8 BattleScript_EffBattlerAvoidedAttack[];
...
extern const u8 BattleScript_AbilityPopUpOverwriteThenNormal[];
...
extern const u8 BattleScript_MoveEffectRest[];
...
extern const u8 BattleScript_ShedTailSwitch[];
...
extern const u8 BattleScript_Bestow[];
extern const u8 BattleScript_Instruct[];
extern const u8 BattleScript_StuffCheeks[];
extern const u8 BattleScript_MoveEffectIonDeluge[];
extern const u8 BattleScript_MoveEffectSetStatus[];
extern const u8 BattleScript_MoveEffectTeatime[];
extern const u8 BattleScript_RestoreHpEffectBattler[];
extern const u8 BattleScript_Purify[];
extern const u8 BattleScript_PurifyCureStatus[];
extern const u8 BattleScript_MoveEffectTrick[];
extern const u8 BattleScript_MoveEffectSkillSwap[];
extern const u8 BattleScript_MoveEffectSkillSwapAfterAbilityPopUp[];
...
extern const u8 BattleScript_RevivalBlessing[];
extern const u8 BattleScript_MoveEffectCorrosiveGas[];
