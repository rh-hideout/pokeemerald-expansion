...
extern const u16 gPartyMenuGreatball_Pal[];
extern const u32 gPartyMenuUltraball_Gfx[];
extern const u16 gPartyMenuUltraball_Pal[];
extern const u32 gPartyMenuMasterball_Gfx[];
extern const u16 gPartyMenuMasterball_Pal[];
extern const u32 gPartyMenuSafariball_Gfx[];
extern const u16 gPartyMenuSafariball_Pal[];
extern const u32 gPartyMenuNetball_Gfx[];
extern const u16 gPartyMenuNetball_Pal[];
extern const u32 gPartyMenuDiveball_Gfx[];
extern const u16 gPartyMenuDiveball_Pal[];
extern const u32 gPartyMenuNestball_Gfx[];
extern const u16 gPartyMenuNestball_Pal[];
extern const u32 gPartyMenuRepeatball_Gfx[];
extern const u16 gPartyMenuRepeatball_Pal[];
extern const u32 gPartyMenuTimerball_Gfx[];
extern const u16 gPartyMenuTimerball_Pal[];
extern const u32 gPartyMenuLuxuryball_Gfx[];
extern const u16 gPartyMenuLuxuryball_Pal[];
extern const u32 gPartyMenuPremierball_Gfx[];
extern const u16 gPartyMenuPremierball_Pal[];
