...
extern const u32 gPokeblockGrey_Pal[];
...
extern const u32 gDecorIcon_ColourfulPlant[];
extern const u32 gDecorIconPalette_ColourfulPlant[];
...
// rayquaza scene gfx
extern const u32 greySceneDuoFight_Groudon_Gfx[];
extern const u32 greySceneDuoFight_GroudonShoulder_Gfx[];
extern const u32 greySceneDuoFight_GroudonClaw_Gfx[];
extern const u32 greySceneDuoFight_Kyogre_Gfx[];
extern const u32 greySceneDuoFight_KyogrePectoralFin_Gfx[];
extern const u32 greySceneDuoFight_KyogreDorsalFin_Gfx[];
extern const u32 greySceneDuoFight_Groudon_Pal[];
extern const u32 greySceneDuoFight_Kyogre_Pal[];
extern const u32 greySceneDuoFight_Clouds_Gfx[];
extern const u32 greySceneDuoFight_Clouds_Pal[];
extern const u32 greySceneDuoFight_Clouds1_Tilemap[];
extern const u32 greySceneDuoFight_Clouds2_Tilemap[];
extern const u32 greySceneDuoFight_Clouds3_Tilemap[];
extern const u32 greySceneTakesFlight_Smoke_Gfx[];
extern const u32 greySceneTakesFlight_Smoke_Pal[];
extern const u32 greySceneTakesFlight_Rayquaza_Pal[];
extern const u32 greySceneTakesFlight_Bg_Gfx[];
extern const u32 greySceneTakesFlight_Bg_Tilemap[];
extern const u32 greySceneTakesFlight_Rayquaza_Gfx[];
extern const u32 greySceneTakesFlight_Rayquaza_Tilemap[];
extern const u32 greySceneDescends_Rayquaza_Gfx[];
extern const u32 greySceneDescends_RayquazaTail_Gfx[];
extern const u32 greySceneDescends_Light_Gfx[];
extern const u32 greySceneDescends_Light_Tilemap[];
extern const u32 greySceneDescends_Bg_Gfx[];
extern const u32 greySceneDescends_Bg_Tilemap[];
extern const u32 greySceneDescends_Bg_Pal[];
extern const u32 greySceneCharges_Rayquaza_Gfx[];
extern const u32 greySceneCharges_Streaks_Gfx[];
extern const u32 greySceneCharges_Bg_Gfx[];
extern const u32 greySceneCharges_Orbs_Tilemap[];
extern const u32 greySceneCharges_Rayquaza_Tilemap[];
extern const u32 greySceneCharges_Streaks_Tilemap[];
extern const u32 greySceneCharges_Bg_Tilemap[];
extern const u32 greySceneCharges_Bg_Pal[];
extern const u32 greySceneChasesAway_Groudon_Gfx[];
extern const u32 greySceneChasesAway_GroudonTail_Gfx[];
extern const u32 greySceneChasesAway_Kyogre_Gfx[];
extern const u32 greySceneChasesAway_Rayquaza_Gfx[];
extern const u32 greySceneChasesAway_RayquazaTail_Gfx[];
extern const u32 greySceneChasesAway_KyogreSplash_Gfx[];
extern const u32 greySceneChasesAway_Groudon_Pal[];
extern const u32 greySceneChasesAway_Kyogre_Pal[];
extern const u32 greySceneChasesAway_Rayquaza_Pal[];
extern const u32 greySceneChasesAway_KyogreSplash_Pal[];
extern const u32 greySceneChasesAway_Bg_Tilemap[];
extern const u32 greySceneChasesAway_Light_Tilemap[];
extern const u32 greySceneChasesAway_Ring_Tilemap[];
extern const u32 greySceneChasesAway_Bg_Pal[];
extern const u32 greySceneChasesAway_Light_Gfx[];
extern const u32 greySceneChasesAway_Ring_Gfx[];
...
extern const u32 gItemIcon_HarbourMail[];
extern const u32 gItemIconPalette_HarbourMail[];
...
extern const u32 gItemIcon_RotomCatalogue[];
extern const u32 gItemIconPalette_RotomCatalogue[];
...
extern const u32 gBattleAnimSpriteGfx_GreySmoke[];
...
extern const u32 gBattleAnimSpriteGfx_GreyOrb[];
extern const u32 gBattleAnimSpriteGfx_GreyOrb[];
extern const u32 gBattleAnimSpriteGfx_GreyOrb[];
...
extern const u32 gBattleAnimSpriteGfx_ColouredOrbs[];
...
extern const u32 gBattleAnimSpritePal_GreySmoke[];
...
extern const u32 gBattleAnimSpritePal_GreyLightWall[];
...
extern const u32 gBattleAnimSpritePal_GreyOrb[];
...
extern const u32 gBattleAnimSpritePal_ColouredOrbs[];
...
extern const u32 gBerryBlenderCentre_Gfx[];
...
extern const u32 gRouletteCentre_Gfx[];
...
extern const u16 gMailPalette_Harbour[];
...
extern const u8 gMailTiles_Harbour[];
extern const u8 gMailTilemap_Harbour[];
