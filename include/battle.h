...
struct AiLogicData
{
    ...
    u8 shouldConsiderExplosion:1; // Determines whether AI should consider explosion moves this turn
    u8 shouldSwitch:4; // Stores result of ShouldSwitch, which decides whether a mon should be switched out
    u8 shouldConsiderFinalGambit:1; // Determines whether AI should consider Final Gambit this turn
    u8 padding2:3;
