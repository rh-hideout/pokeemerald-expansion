...
extern const u8 MatchCall_HNS_Joey_General[];
extern const u8 MatchCall_HNS_Joey_Battle[];
extern const u8 MatchCall_HNS_Wade_General[];
extern const u8 MatchCall_HNS_Wade_Battle[];
extern const u8 MatchCall_HNS_Ralph_General[];
extern const u8 MatchCall_HNS_Ralph_Battle[];
extern const u8 MatchCall_HNS_Liz_General[];
extern const u8 MatchCall_HNS_Liz_Battle[];
extern const u8 MatchCall_HNS_Anthony_General[];
extern const u8 MatchCall_HNS_Anthony_Battle[];
extern const u8 MatchCall_HNS_Todd_General[];
extern const u8 MatchCall_HNS_Todd_Battle[];
extern const u8 MatchCall_HNS_Gina_General[];
extern const u8 MatchCall_HNS_Gina_Battle[];
extern const u8 MatchCall_HNS_Irwin_General[];
extern const u8 MatchCall_HNS_Irwin_Battle[];
extern const u8 MatchCall_HNS_Arnie_General[];
extern const u8 MatchCall_HNS_Arnie_Battle[];
extern const u8 MatchCall_HNS_Alan_General[];
extern const u8 MatchCall_HNS_Alan_Battle[];
extern const u8 MatchCall_HNS_Dana_General[];
extern const u8 MatchCall_HNS_Dana_Battle[];
extern const u8 MatchCall_HNS_Chad_General[];
extern const u8 MatchCall_HNS_Chad_Battle[];
extern const u8 MatchCall_HNS_Derek_General[];
extern const u8 MatchCall_HNS_Derek_Battle[];
extern const u8 MatchCall_HNS_Tully_General[];
extern const u8 MatchCall_HNS_Tully_Battle[];
extern const u8 MatchCall_HNS_Brent_General[];
extern const u8 MatchCall_HNS_Brent_Battle[];
extern const u8 MatchCall_HNS_Tiffany_General[];
extern const u8 MatchCall_HNS_Tiffany_Battle[];
extern const u8 MatchCall_HNS_Vance_General[];
extern const u8 MatchCall_HNS_Vance_Battle[];
extern const u8 MatchCall_HNS_Wilton_General[];
extern const u8 MatchCall_HNS_Wilton_Battle[];
extern const u8 MatchCall_HNS_Kenji_General[];
extern const u8 MatchCall_HNS_Kenji_Battle[];
extern const u8 MatchCall_HNS_Parry_General[];
extern const u8 MatchCall_HNS_Parry_Battle[];
extern const u8 MatchCall_HNS_Erin_General[];
extern const u8 MatchCall_HNS_Erin_Battle[];
extern const u8 MatchCall_HNS_Jack_General[];
extern const u8 MatchCall_HNS_Jack_Battle[];
extern const u8 MatchCall_HNS_Beverly_General[];
extern const u8 MatchCall_HNS_Beverly_Battle[];
extern const u8 MatchCall_HNS_Huey_General[];
extern const u8 MatchCall_HNS_Huey_Battle[];
extern const u8 MatchCall_HNS_Gaven_General[];
extern const u8 MatchCall_HNS_Gaven_Battle[];
extern const u8 MatchCall_HNS_Beth_General[];
extern const u8 MatchCall_HNS_Beth_Battle[];
extern const u8 MatchCall_HNS_Jose_General[];
extern const u8 MatchCall_HNS_Jose_Battle[];
extern const u8 MatchCall_HNS_Reena_General[];
