...
extern const u8 MauvilleCity_PokemonCentre_1F_Text_SavedGameTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_SavedGameAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_SavedGameStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_TrendsStartedTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_TrendsStartedAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_TrendsStartedStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_BerriesPlantedTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_BerriesPlantedAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_BerriesPlantedStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_BikeTradesTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_BikeTradesAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_BikeTradesStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_InterviewsTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_InterviewsAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_InterviewsStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_TrainerBattlesTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_TrainerBattlesAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_TrainerBattlesStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_PokemonCaughtTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_PokemonCaughtAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_PokemonCaughtStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_FishingPokemonCaughtTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_FishingPokemonCaughtAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_FishingPokemonCaughtStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_EggsHatchedTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_EggsHatchedAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_EggsHatchedStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_PokemonEvolvedTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_PokemonEvolvedAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_PokemonEvolvedStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_UsedPokemonCentreTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_UsedPokemonCentreAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_UsedPokemonCentreStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_RestedAtHomeTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_RestedAtHomeAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_RestedAtHomeStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_SafariGamesTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_SafariGamesAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_SafariGamesStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_UsedCutTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_UsedCutAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_UsedCutStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_UsedRockSmashTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_UsedRockSmashAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_UsedRockSmashStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_MovedBasesTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_MovedBasesAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_MovedBasesStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_UsedSplashTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_UsedSplashAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_UsedSplashStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_UsedStruggleTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_UsedStruggleAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_UsedStruggleStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_SlotJackpotsTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_SlotJackpotsAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_SlotJackpotsStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_RouletteWinsTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_RouletteWinsAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_RouletteWinsStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_BattleTowerChallengesTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_BattleTowerChallengesAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_BattleTowerChallengesStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_MadePokeblocksTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_MadePokeblocksAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_MadePokeblocksStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_EnteredContestsTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_EnteredContestsAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_EnteredContestsStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_WonContestsTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_WonContestsAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_WonContestsStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_TimesShoppedTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_TimesShoppedAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_TimesShoppedStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_UsedItemFinderTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_UsedItemFinderAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_UsedItemFinderStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_TimesRainedTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_TimesRainedAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_TimesRainedStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_CheckedPokedexTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_CheckedPokedexAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_CheckedPokedexStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_ReceivedRibbonsTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_ReceivedRibbonsAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_ReceivedRibbonsStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_LedgesJumpedTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_LedgesJumpedAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_LedgesJumpedStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_TVWatchedTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_TVWatchedAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_TVWatchedStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_CheckedClockTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_CheckedClockAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_CheckedClockStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_WonLotteryTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_WonLotteryAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_WonLotteryStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_UsedDaycareTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_UsedDaycareAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_UsedDaycareStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_RodeCableCarTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_RodeCableCarAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_RodeCableCarStory[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_HotSpringsTitle[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_HotSpringsAction[];
extern const u8 MauvilleCity_PokemonCentre_1F_Text_HotSpringsStory[];
...
extern const u8 EventScript_PokemonCentreBookShelf[];
...
extern const u8 MossdeepCity_SpaceCentre_2F_EventScript_RivalRayquazaCall[];
...
extern const u8 CableClub_EventScript_ReadTrainerCardColoured[];
...
extern const u8 EventScript_RecordCentre_Spot0[];
extern const u8 EventScript_RecordCentre_Spot1[];
extern const u8 EventScript_RecordCentre_Spot2[];
extern const u8 EventScript_RecordCentre_Spot3[];
extern const u8 EventScript_BattleColosseum_2P_PlayerSpot0[];
extern const u8 EventScript_BattleColosseum_2P_PlayerSpot1[];
extern const u8 EventScript_TradeCentre_Chair1[];
extern const u8 EventScript_TradeCentre_Chair0[];
...
extern const u8 Common_EventScript_ShowPokemonCentreSign[];
