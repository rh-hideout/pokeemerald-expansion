...
#define B_FLAG_VICTORY_CATCH_RANDOM     0          // If set, you will be promted to throw a ball after the encounter has been killed, catch rate is random. You can't capture the encounter in any other way
#define B_FLAG_VICTORY_CATCH_GUARANTEED FLAG_UNUSED_0x020          // If set, you will be promted to throw a ball after the encounter has been killed, guaranteed to catch. You can't capture the encounter in any other way
