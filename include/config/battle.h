...
#define B_MULTI_FULL_TEAMS              TRUE       // If FALSE, trainers will be capped at 3 Pokémon each when there are 2 trainers on one side in a battle. If TRUE, per-battle capping may still be set using `Multi Party: Half` in `trainers.party`
