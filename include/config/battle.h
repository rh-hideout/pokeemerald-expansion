...
#define B_ENCORE_TURNS              GEN_LATEST // Encore's turns. See Cmd_trysetencore.
...
#define B_PP_REDUCED_BY_SPITE       GEN_LATEST // In Gen4+, Spite reduces the foe's last move's PP by 4, instead of 2-5.
...
#define B_SHEER_COLD_ACC            GEN_LATEST // In Gen7+, Sheer Cold's base accuracy is reduced to 20% if the user isn't Ice-type.
...
#define B_ABILITY_TRIGGER_CHANCE    GEN_LATEST // In Gen3, Shed Skin, Cute Charm, Flame Body, Static and Poison Point have a 1/3 chance to trigger. In Gen 4+ it's 30%.
                                               // In Gen3, Effect Spore has a 10% chance to sleep, poison or paralyze, with an equal chance. In Gen4, it's 30%. In Gen5+, it has 11% to sleep, 9% chance to poison and 10% chance to paralyze.
...
#define B_LOVE_BALL_MODIFIER        GEN_LATEST // In Gen2, Love Ball works on species of the same gender, rather than those of the opposite gender.
