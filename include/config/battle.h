...
#define B_RAMPAGE_CONFUSION         GEN_LATEST // In Gen5+, Rampge is cancled after the move (as opposed to End Turn) and a failed rampage move will cancel the counter unless it is the last turn
