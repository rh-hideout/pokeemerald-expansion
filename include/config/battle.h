...
//#define B_SLEEP_TURNS             GEN_LATEST    Sleep Turns last for 2-3 turns
...
#define B_PP_REDUCED_BY_SPITE       GEN_LATEST // In Gen4+, Spite reduces the foe's last move's PP by 5, instead of 2 to 5.
...
#define B_BLIZZARD_HAIL             GEN_LATEST // In Gen4+, Blizzard bypasses accuracy checks if it's hailing or snowing.
...
#define B_GROWTH_STAT_RAISE         GEN_LATEST // In Gen5+, Growth raises Attack and Special Attack by 1 stage. Under the sun, it raises them by 2 stages instead.
...
#define B_DRAGONS_MAW_BOOST         GEN_LATEST // In this Romhack (Gen 9+) Dragon's Maw gets the same nerg as transistor
