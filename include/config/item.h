...
#define I_EXP_SHARE_FLAG        FLAG_RECEIVED_EXP_SHARE_MUM        // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
