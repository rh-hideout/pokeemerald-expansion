...
#define OW_OBJECT_VANILLA_SHADOWS      TRUE     // When TRUE, every object in the overworld has a shadow. WARNING: This means every object will take up two sprites instead of one. When FALSE, an object's shadow is only shown when jumping.
