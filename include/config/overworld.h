...
#define OW_ROCK_SMASH_ITEMS             GEN_LATEST // In Gen4 or Gen6, breakable rocks will yield items based on those generations' mechanics Configure this in fldeff_rocksmash.c. Note that gen 6 mechanics completely ignore encounter chance, which can be configured in wild_encounter.c
