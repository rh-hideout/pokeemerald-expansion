...
// Learnsets
#define P_LVL_UP_LEARNSETS          GEN_9  // Choose which set of Level Up Learnsets to use.
...
#define P_FLAG_FORCE_SHINY               FLAG_UNUSED_0x025  // If this flag is set, all wild and gift Pokémon will forced into being Shiny.
