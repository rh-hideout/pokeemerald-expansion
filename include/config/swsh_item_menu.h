...
#define SWSH_ITEM_MENU_BERRY_INFO         (SWSH_ITEM_MENU && TRUE)  // Show berry info in the item menu
#define SWSH_ITEM_MENU_BERRY_TAG          (SWSH_ITEM_MENU && FALSE) // Keep or turn off the vanilla berry tag check
#define SWSH_ITEM_MENU_SCROLLING_BG       (SWSH_ITEM_MENU && TRUE)  // Enable scrolling background
...
#define SWSH_ITEM_MENU_PARTY_ITEM_REUSE   (SWSH_ITEM_MENU_ACTION_IN_BAG && TRUE)  // Keep party cursor after use/give if the item remains in the bag
...
#define SWSH_ITEM_MENU_PYRAMID_ACTION     (SWSH_ITEM_MENU_PYRAMID_BAG && SWSH_ITEM_MENU_ACTION_IN_BAG)  // Perform inline Use/Give in the pyramid bag
