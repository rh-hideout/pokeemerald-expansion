...
// Pokédex Plus HGSS
#define SORT_TMS_BY_NUM              FALSE   // If TRUE, sorts the TMS in HGSS Dex by TM number, rather than alphabetically.
#define SHOW_EGG_MOVES_FOR_EVOS      FALSE   // If TRUE, shows Egg Moves for evolved Pokémon too.
#define TUTOR_MOVES_ARRAY            FALSE   // If TRUE, uses an autogenerated array for Tutor moves.
