...
#define AI_FLAG_ATTACKS_PARTNER_FOCUSES_PARTNER  FALSE  // if TRUE, AI_FLAG_ATTACKS_PARTNER prefers the partner over the ally.
                                                        // This is treated as true during wild battles with AI.
