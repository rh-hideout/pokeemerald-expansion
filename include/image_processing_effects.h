...
enum
{
    ...
    IMAGE_EFFECT_GREYSCALE_LIGHT = 6,
    IMAGE_EFFECT_BLUR = 8,
    IMAGE_EFFECT_OUTLINE_COLOURED = 9,
...
enum
{
    ...
    QUANTIZE_EFFECT_STANDARD_LIMITED_COLOURS,
    QUANTIZE_EFFECT_PRIMARY_COLOURS,
    QUANTIZE_EFFECT_GREYSCALE,
    QUANTIZE_EFFECT_GREYSCALE_SMALL,
