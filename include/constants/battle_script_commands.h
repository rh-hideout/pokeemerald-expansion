...
#define sMOVEEND_STATE               (gBattleScripting + 0x0C) // moveendState
#define sSAVED_STAT_CHANGER          (gBattleScripting + 0x0D) // savedStatChanger
#define sSHIFT_SWITCHED              (gBattleScripting + 0x0E) // shiftSwitched
#define sBATTLER                     (gBattleScripting + 0x0F) // battler
#define sB_ANIM_TURN                 (gBattleScripting + 0x10) // animTurn
#define sB_ANIM_TARGETS_HIT          (gBattleScripting + 0x11) // animTargetsHit
#define sSTATCHANGER                 (gBattleScripting + 0x12) // statChanger
#define sSTAT_ANIM_PLAYED            (gBattleScripting + 0x13) // statAnimPlayed
#define sGIVEEXP_STATE               (gBattleScripting + 0x14) // getexpState
#define sBATTLE_STYLE                (gBattleScripting + 0x15) // battleStyle
#define sLVLBOX_STATE                (gBattleScripting + 0x16) // drawlvlupboxState
#define sLEARNMOVE_STATE             (gBattleScripting + 0x17) // learnMoveState
#define sSAVED_BATTLER               (gBattleScripting + 0x18) // savedBattler
#define sRESHOW_MAIN_STATE           (gBattleScripting + 0x19) // reshowMainState
#define sRESHOW_HELPER_STATE         (gBattleScripting + 0x1A) // reshowHelperState
#define sLVLUP_HP                    (gBattleScripting + 0x1B) // levelUpHP
#define sWINDOWS_TYPE                (gBattleScripting + 0x1C) // windowsType
#define sMULTIPLAYER_ID              (gBattleScripting + 0x1D) // multiplayerId
#define sSPECIAL_TRAINER_BATTLE_TYPE (gBattleScripting + 0x1E) // specialTrainerBattleType
#define sMON_CAUGHT                  (gBattleScripting + 0x1F) // monCaught
#define sSAVED_DMG                   (gBattleScripting + 0x20) // savedDmg
#define sSAVED_MOVE_EFFECT           (gBattleScripting + 0x24) // savedMoveEffect
#define sMOVE_EFFECT                 (gBattleScripting + 0x26) // moveEffect
#define sMULTIHIT_EFFECT             (gBattleScripting + 0x28) // multihitMoveEffect
#define sILLUSION_NICK_HACK          (gBattleScripting + 0x2A) // illusionNickHack
#define sFIXED_ABILITY_POPUP         (gBattleScripting + 0x2B) // fixedPopup
