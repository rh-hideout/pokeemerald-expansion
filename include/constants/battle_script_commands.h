...
enum CmdVarious
{
    ...
    // capriccio various script macros
    VARIOUS_SET_MIRAGE_VEIL,
    VARIOUS_MEME_PUNCH,
    VARIOUS_SOUL_CRUSHER,
    VARIOUS_TRY_TRICK_STAB_ILLUSION_OFF,
    VARIOUS_TRY_BURY_SELF,
    VARIOUS_TRY_TEMP_TRAP,
    VARIOUS_JUMP_IF_FROZEN_BUNKER_PROTECTED,
};
...
enum MoveEndEffects
{
    ...
    BEAR_HUG_END_ABILITIES_ATTACKER,
    MOVEEND_COUNT,
};
