...
#define sSTATCHANGER_STRING_KEY      (gBattleScripting + 0x08) // statChangerStringKey
#define sEXP_CATCH                   (gBattleScripting + 0x09) // expOnCatch
...
#define sUNUSED2                     (gBattleScripting + 0x15) // unused2
