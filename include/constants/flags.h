...
#define STARTER_BALL_ONE     0x20 // Starter 1
#define STARTER_BALL_TWO     0x21 // Starter 2
#define STARTER_BALL_THREE   0x22 // Starter 3
#define RIVAL_STARTER_BATTLE 0x23 // First Rival Battle
