...
#define TESTING_FLAGS_END                       TESTING_FLAG_UNUSED_7
#endif // TESTING

#define PSEUDO_FLAGS_START  0x6000
#define FLAG_ALWAYS_FALSE   (PSEUDO_FLAGS_START + 0x0)
#define FLAG_ALWAYS_TRUE    (PSEUDO_FLAGS_START + 0x1)
