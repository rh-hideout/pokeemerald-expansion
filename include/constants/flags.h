...
#define FLAG_ITEM_RUNNING_SHOES                                     0x465 // Received Running Shoes on house
...
#define FLAG_SKIP_INTRO                                             0x499 // Set when the player skips the intro sequence. This is used to prevent the intro from playing again.
