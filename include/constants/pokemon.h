...
enum EvolutionConditions {
    ...
    //Non condition parameters
    SKIP_ANIM_IF_NOT_SENT_OUT,          // If this pokemon evolves in battle without having been sent out (through xp share), the evolution scene will not occur
    CONDITIONS_END
};
