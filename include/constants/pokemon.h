...
// Body colours for Pokédex search
#define BODY_COLOUR_RED      0
#define BODY_COLOUR_BLUE     1
#define BODY_COLOUR_YELLOW   2
#define BODY_COLOUR_GREEN    3
#define BODY_COLOUR_BLACK    4
#define BODY_COLOUR_BROWN    5
#define BODY_COLOUR_PURPLE   6
#define BODY_COLOUR_GREY     7
#define BODY_COLOUR_WHITE    8
#define BODY_COLOUR_PINK     9
