...
#define AI_FLAG_DEFAULT_TRAINER_BASIC (AI_FLAG_SMART_TRAINER | AI_FLAG_HP_AWARE | AI_FLAG_TRY_TO_2HKO | AI_FLAG_PREDICT_MOVE | AI_FLAG_PREFER_HIGHEST_DAMAGE_MOVE)
