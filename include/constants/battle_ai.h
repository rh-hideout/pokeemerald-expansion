...
#define AI_FLAG_DEFAULT_TRAINER_BASIC (AI_FLAG_SMART_TRAINER  | AI_FLAG_PREFER_HIGHEST_DAMAGE_MOVE)
#define AI_FLAG_DEFAULT_ASSUME_BASIC  (AI_FLAG_BASIC_TRAINER | AI_FLAG_ASSUMPTIONS | AI_FLAG_PREFER_HIGHEST_DAMAGE_MOVE| AI_FLAG_SMART_SWITCHING | AI_FLAG_SMART_MON_CHOICES | AI_FLAG_PP_STALL_PREVENTION | AI_FLAG_SMART_TERA )
