...
#define AI_FLAG_RANDOMIZE_SWITCHIN          AI_FLAG(32)  // AI will randomly choose between eligible switchin candidates of a given type instead of picking the last one in the party. Does nothing without AI_FLAG_SMART_MON_CHOICES
