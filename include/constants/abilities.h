...
enum __attribute__((packed)) Ability
{
    ...
    // Custom Abilities
    ABILITY_DESERT_SPIRIT = ABILITIES_COUNT_GEN9,
    ABILITY_FULL_MOON = 312,
    ABILITY_CRUEL_SUN = 313,
    ABILITY_AERODYNAMIC = 314,
    ABILITY_COMBUSTION = 315,
    ABILITY_MIME_BARRIER = 316,
    ABILITY_EFFECT_DUST = 317,
    ABILITY_NOXIOUS_GAS = 318,
    ABILITY_HELLFIRE = 319,
    ABILITY_MAGNETIC_RISE = 320,
    ABILITY_SLUDGE_BODY = 321,
    ABILITY_HYPNOTISER = 322,
    ABILITY_SPIRIT_GUARDIAN = 323,
    ABILITY_FARADAY_CAGE = 324,
    ABILITY_RAPID_FIST = 325,
    ABILITY_GEM_OF_THE_SEA = 326,
    ABILITY_MAGMA_AURA = 327,
    ABILITY_SHADOW_AURA = 328,
    ABILITY_SILENT_HUNTER = 329,
    ABILITY_NOCTURNAL = 330,
    ABILITY_ECLIPSE = 331,
    ABILITY_STAR_POWER = 332,
    ABILITY_SPIDER_FANGS = 333,
    ABILITY_CHRONOVISION = 334,
    ABILITY_GUIDING_LIGHT = 335,
    ABILITY_COTTON_DRIFT = 336,
    ABILITY_DEFLECTOR = 337,
    ABILITY_SOLAR_FORCE = 338,
    ABILITY_BAD_LUCK_OMEN = 339,
    ABILITY_MURKROW_SHIELD = 340,
    ABILITY_JUMP_SCARE = 341,
    ABILITY_SHADOW_STEP = 342,
    ABILITY_CURSED_CHANT = 343,
    ABILITY_SHELL_BURST = 344,
    ABILITY_STEEL_COAT = 345,
    ABILITY_VENOM_GLANDS = 346,
    ABILITY_POISON_BARBS = 347,
    ABILITY_INTENSE_BLAZE = 348,
    ABILITY_FLAME_ABSORB = 349,
    ABILITY_ICE_TUSKS = 350,
    ABILITY_BATTLE_READY = 351,
    ABILITY_MISTY_STEP = 352,
    ABILITY_FOREST_BLESSING = 353,
    ABILITY_POWER_KICKER = 354,
    ABILITY_LEECH = 355,
    ABILITY_TOXIC_AURA = 356,
    ABILITY_STORM_BRINGER = 357,
    ABILITY_ARMOR_BREAK = 358,
    ABILITY_REVERBERATION = 359,
    ABILITY_DARKVISION = 360,
    ABILITY_GEM_FIEND = 361,
    ABILITY_OVERCHARGE = 362,
    ABILITY_FROST_FIEND = 363,
    ABILITY_SEA_DWELLER = 364,
    ABILITY_SHADOW_CLONE = 365,
    ABILITY_LIFE_GUARD = 366,
    ABILITY_BATTLE_AURA = 367,
    ABILITY_SCORPION = 368,
    ABILITY_FEROCITY = 369,
    ABILITY_TRICK_REALM = 370,
    ABILITY_WONDER_REALM = 371,
    ABILITY_ANTIFREEZE = 372,
    ABILITY_FAE_TOUCHED = 373,
    ABILITY_WEB_PREDATOR = 374,
    ABILITY_WATER_FORM = 375,
    ABILITY_GRASS_GRAZER = 376,
    ABILITY_NIGHT_PREDATOR = 377,
    ABILITY_WEREWOLF = 378,
    ABILITY_PSYCHIC_BREAK = 379,
