...
#define ABILITY_DEMONIZE                  315  //Dark
...
#define ABILITY_PROPHETIZE                323  //Psychic
...
*/
#define ABILITY_FLY_TRAP                  324 //Bug
/*
Boost Stat
    Preexisting
        Fire - Flash Fire
        Elecric - Motor Drive / Lightning Rod
        Grass - Sap Sipper 
        Water - Storm Drain
        Wind Type - Wind Rider
Flat Immunities
    Preexisting 
        Ground - Levitate
        Wonder Guard
