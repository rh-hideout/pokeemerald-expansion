...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_RUFFIAN = 312,
    ABILITY_PSYLATE = 313,
    ABILITY_LIQUIDATE = 314,
    ABILITY_IMMOLATE = 315,
    ABILITY_CHLORATE = 316,
    ABILITY_FOSSILIZE = 317,
    ABILITY_TERRAMORPH = 318,
    ABILITY_CORRODE = 319,
    ABILITY_ENTOMIZE = 320,
    ABILITY_METALLIZE = 321,
    ABILITY_SPIRITIZE = 322,
    ABILITY_PUMMELATE = 323,
