...
//Stage 4 NTM
#define ABILITY_FAIRY_SPIRIT 367 //Hadron engine for Misty Terrain for legendary paradox
#define ABILITY_STORM_CONVERTER 368 //Hadron Engine for Snow for legendary paradox
