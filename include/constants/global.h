...
#if I_EXPANDED_BAG
// Expanded capacities
#define BAG_ITEMS_COUNT ((BAG_ITEMS_BASE_COUNT * 3 / 2) + (I_USE_PC_SLOTS_TO_EXPAND_ITEMS_POCKET ? (PC_ITEMS_COUNT / 2) : 0))
#define BAG_KEYITEMS_COUNT ((BAG_KEYITEMS_BASE_COUNT * 2) - I_KEY_ITEM_SLOTS_SIPHONED_FOR_TMS_HMS)
#define BAG_POKEBALLS_COUNT (BAG_POKEBALLS_BASE_COUNT * 3 / 2)
#define BAG_TMHM_COUNT ((BAG_TMHM_BASE_COUNT * 3 / 2) + I_KEY_ITEM_SLOTS_SIPHONED_FOR_TMS_HMS)
#define BAG_BERRIES_COUNT (BAG_BERRIES_BASE_COUNT * 3 / 2)
#else
#define BAG_ITEMS_COUNT BAG_ITEMS_BASE_COUNT
#define BAG_KEYITEMS_COUNT BAG_KEYITEMS_BASE_COUNT
#define BAG_POKEBALLS_COUNT BAG_POKEBALLS_BASE_COUNT
#define BAG_TMHM_COUNT BAG_TMHM_BASE_COUNT
#define BAG_BERRIES_COUNT BAG_BERRIES_BASE_COUNT
#endif
