...
#if I_EXPANDED_BAG
// Expanded capacities
#define BAG_ITEMS_COUNT ((BAG_ITEMS_BASE_COUNT * 3 / 2) + (USE_PC_SLOTS_TO_EXPAND_ITEMS_POCKET ? (PC_ITEMS_COUNT / 2) : 0))
#define BAG_KEYITEMS_COUNT ((BAG_KEYITEMS_BASE_COUNT * 2) - KEY_ITEM_SLOTS_SIPHONED_FOR_TMS_HMS)
