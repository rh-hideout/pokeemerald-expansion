...
enum __attribute__((packed)) MoveEffect
{
    ...
    MOVE_EFFECT_ATTRACT,
    MOVE_EFFECT_SUBSTITUTE,
    MOVE_EFFECT_SHED_TAIL,
    ...
    MOVE_EFFECT_STAT_SWAP,
    MOVE_EFFECT_OVERWRITE_ABILITY,
    MOVE_EFFECT_SKILL_SWAP,
    MOVE_EFFECT_ROLE_PLAY,
    MOVE_EFFECT_TRICK,
    MOVE_EFFECT_SET_ROOM,
    // MOVE_EFFECT_STEALTH_ROCK,
    MOVE_EFFECT_LUNAR_DANCE,
    MOVE_EFFECT_AVERAGE_STATS,
    ...
    MOVE_EFFECT_SPITE,
    MOVE_EFFECT_PSYCH_UP,
    MOVE_EFFECT_FOLLOW_ME,
    MOVE_EFFECT_TAUNT,
    MOVE_EFFECT_HELPING_HAND,
