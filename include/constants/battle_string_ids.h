...
enum StringID
{
    ...
    #define STRINGID_COUNT (STRINGID_ABILITYSHIELDPROTECTS + 1)
};
...
enum WeatherEndStringID
{
    ...
    #define B_MSG_WEATHER_END_COUNT (B_MSG_WEATHER_END_STRONG_WINDS + 1)
};
...
enum TerrainStringID
{
    ...
    #define B_MSG_TERRAIN_COUNT (B_MSG_TERRAIN_END_GRASSY + 1)
};
...
enum StartingStatusStringID
{
    ...
    B_MSG_SET_SWAMP
    #define B_MSG_STARTING_STATUS_COUNT (B_MSG_SET_SWAMP + 1)
};
...
enum __attribute__((packed)) WrappedStringID
{
    ...
    #define NUM_TRAPPING_MOVES (B_MSG_WRAPPED_THUNDER_CAGE + 1)
};
