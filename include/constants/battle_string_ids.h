...
enum StringID
{
    ...
    STRINGID_PKMNCUTSDEFENSEWITH,
    STRINGID_MAGMAAURAENTERS,
    STRINGID_SHADOWAURAENTERS,
    STRINGID_DARKLIFTED,
    STRINGID_DARKNESSENGULFS,
    STRINGID_DARKNESSSTARTS,
    STRINGID_PKMNSXDARKNESSENGULFS,
    STRINGID_LIGHTRAISESACCURACY,
    STRINGID_DAMPENTERS,
    STRINGID_JUMPSCAREENTERS,
    STRINGID_PKMNCUTSSPATKWITH,
    STRINGID_BATTLEREADYACTIVATES,
    STRINGID_GRASSYTERRAINACTIVATEDABILITY,
    STRINGID_TOXICAURAENTERS,
    STRINGID_BATTLEAURAENTERS,
    STRINGID_MISTYTERRAINACTIVATEDABILITY,
    STRINGID_SNOWACTIVATEDABILITY,
    STRINGID_COUNT
};
...
enum SwitchInAbilityStringID
{
    ...
    B_MSG_SWITCHIN_MAGMAAURA,
    B_MSG_SWITCHIN_SHADOWAURA,
    B_MSG_SWITCHIN_DAMP,
    B_MSG_SWITCHIN_JUMPSCARE,
    B_MSG_SWITCHIN_TOXICAURA,
    B_MSG_SWITCHIN_BATTLEAURA,
};
