...
enum StringID
{
    ...
    STRINGID_ABILITYHEALSSTATUS,
    STRINGID_ABILITYHEALSPARALYSIS,
    STRINGID_ABILITYHEALSPOISON,
    STRINGID_ABILITYHEALSBURN,
    STRINGID_ABILITYHEALSSLEEP,
    STRINGID_ABILITYHEALSFROZEN,
    STRINGID_ABILITYHEALSFROSTBITE,
    STRINGID_COUNT
};
