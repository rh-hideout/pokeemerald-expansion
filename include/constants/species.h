...
enum __attribute__((packed)) Species
{
    ...
    SPECIES_BLACK_DRAGONS_CHICK = 1576,
    SPECIES_RED_EYES_BLACK_DRAGON = 1577,
    ...
    SPECIES_MAN_EATER_BUG = 1582,
    SPECIES_NOBLEMAN_EATER_BUG = 1583,
    SPECIES_PETIT_MOTH = 1584,
    SPECIES_LARVAE_MOTH = 1585,
    SPECIES_COCOON_OF_EVOLUTION = 1586,
    SPECIES_GREAT_MOTH = 1587,
    SPECIES_PERFECTLY_ULTIMATE_GREAT_MOTH = 1588,
    SPECIES_PARASITE_CATERPILLAR = 1589,
    SPECIES_POISON_BUTTERFLY = 1590,
    SPECIES_BEAVER_WARRIOR = 1591,
    SPECIES_KURIBOH = 1592,
    SPECIES_WINGED_KURIBOH = 1593,
    SPECIES_WINGED_KURIBOH_LEVEL10 = 1594,
    SPECIES_KURIBABYLON = 1595,
    SPECIES_LINKURIBOH = 1596,
    SPECIES_KURIBON = 1597,
    SPECIES_SPHERE_KURIBOH = 1598,
    SPECIES_JUNKURIBOH = 1599,
    SPECIES_LITTLE_WINGUARD = 1600,
    SPECIES_ROCKET_WARRIOR = 1601,
    SPECIES_SWORDSMAN_OF_LANDSTAR = 1602,
    SPECIES_GILFORD_THE_LIGHTNING = 1603,
    SPECIES_HAPPY_LOVER = 1604,
    SPECIES_SHINING_FRIENDSHIP = 1605,
    SPECIES_SPEED_WARRIOR = 1606,
    SPECIES_JUNK_SPEEDER = 1607,
    SPECIES_FLAME_MANIPULATOR = 1608,
    SPECIES_FLAME_SWORDSMAN = 1609,
    SPECIES_DARK_FLARE_KNIGHT = 1610,
    SPECIES_FERAL_IMP = 1611,
    SPECIES_DES_FERAL_IMP = 1612,
    SPECIES_KING_OF_THE_FERAL_IMPS = 1613,
    SPECIES_BABY_DRAGON = 1614,
    SPECIES_THOUSAND_DRAGON = 1615,
    SPECIES_JERRY_BEANS_MAN = 1616,
    SPECIES_WITCH_OF_THE_BLACK_FOREST = 1617,
    SPECIES_SANGAN = 1618,
    SPECIES_SANWITCH = 1619,
    SPECIES_INJECTION_FAIRY_LILY = 1620,
    SPECIES_BETA_THE_MAGNET_WARRIOR = 1621,
    SPECIES_VALKYRION = 1622,
    SPECIES_ALPHA_THE_MAGNET_WARRIOR = 1623,
    SPECIES_BERSERKION = 1624,
    SPECIES_GOKIBORE = 1625,
    SPECIES_GOKIPOLE = 1626,
    SPECIES_BERFORMET = 1627,
    SPECIES_CHIMERA_THE_FLYING_MYTHICAL_BEAST = 1628,
    SPECIES_CHIMAERA_THE_MASTER_OF_BEASTS = 1629,
    SPECIES_SWAMP_BATTLEGUARD = 1630,
    SPECIES_LAVA_BATTLEGUARD = 1631,
    SPECIES_KILLER_NEEDLE = 1632,
    SPECIES_ARMORED_BEE = 1633,
    SPECIES_POKI_DRACO = 1634,
    SPECIES_DORA_DRACO = 1635,
    SPECIES_MUKA_MUKA = 1636,
    SPECIES_ENRAGED_MUKA_MUKA = 1637,
    SPECIES_QUILLBOLT_HEDGEHOG = 1638,
    SPECIES_ANCHORBOLT_HEDGEHOG = 1639,
    SPECIES_FROG_THE_JAM = 1640,
    SPECIES_TOADALLY_AWESOME = 1641,
    SPECIES_TREEBORN_FROG = 1642,
    SPECIES_TRADETOAD = 1643,
    SPECIES_SUBSTITOAD = 1644,
    SPECIES_DES_FROG = 1645,
    SPECIES_D3S_FROG = 1646,
    SPECIES_TADPOLE = 1647,
    SPECIES_BEELZE_FROG = 1648,
    SPECIES_SWAP_FROG = 1649,
    SPECIES_RONINTOADIN = 1650,
    SPECIES_DUPE_FROG = 1651,
    SPECIES_LUSTER_DRAGON = 1652,
    SPECIES_LUSTER_DRAGON_TWO = 1653,
    SPECIES_DIAMOND_HEAD_DRAGON = 1654,
    SPECIES_LITTLE_D = 1655,
    SPECIES_URABY = 1656,
    SPECIES_BLACK_TYRANNO = 1657,
    SPECIES_BASIC_INSECT = 1658,
    SPECIES_ARMOURED_BASIC_INSECT = 1659,
    SPECIES_INSECT_PRINCESS = 1660,
    SPECIES_INSECT_QUEEN = 1661,
    SPECIES_TWIN_HEADED_REX = 1662,
    SPECIES_CELTIC_GUARDIAN = 1663,
    SPECIES_OBNOXIOUS_CELTIC_GUARDIAN = 1664,
    SPECIES_CELTIC_GUARDIAN_OF_NOBLE_ARMS = 1665,
    SPECIES_RYU_KISHIN = 1666,
    SPECIES_RYU_KISHIN_POWERED = 1667,
    SPECIES_WATAPON = 1668,
    SPECIES_MARSHMALLON = 1669,
    SPECIES_SPORE = 1670,
    SPECIES_SPORE_THE_FAIRY_SEED = 1671,
    SPECIES_OJAMA_YELLOW = 1672,
    SPECIES_OJAMA_KNIGHT = 1673,
    SPECIES_OJAMA_KING = 1674,
    SPECIES_MYSTICAL_ELF = 1675,
    SPECIES_FLAME_CEREBRUS = 1676,
    SPECIES_ALLIGATOR_SWORD = 1677,
    SPECIES_CYBERTECH_ALLIGATOR = 1678,
    SPECIES_ALLIGATOR_SWORD_DRAGON = 1679,
    SPECIES_AXE_RAIDER = 1680,
    SPECIES_VORSE_RAIDER = 1681,
    SPECIES_WILDHEART = 1682,
    SPECIES_WILD_WINGMAN = 1683,
    SPECIES_WINGED_DRAGON_GUARDIAN_OF_THE_FORTRESS = 1684,
    SPECIES_DARK_MAGICIAN_GIRL = 1685,
    SPECIES_DARK_MAGICIAN_GIRL_THE_DRAGON_KNIGHT = 1686,
    SPECIES_KAIRYU_SHIN = 1687,
    SPECIES_OCEAN_DRAGON_LORD_KAIRYU_SHIN = 1688,
    SPECIES_BLACKWING_GALE_THE_WHIRLWIND = 1689,
    SPECIES_BLACKWING_ARMOR_MASTER = 1690,
    SPECIES_COCKROACH_KNIGHT = 1691,
    SPECIES_INSECT_KNIGHT = 1692,
    SPECIES_ULTIMATE_BASEBALL_KID = 1693,
    SPECIES_HARPIE_LADY = 1694,
    SPECIES_HARPIE_LADY_SISTERS = 1695,
    SPECIES_CYBER_HARPIE_LADY = 1696,
    SPECIES_CYBER_SLASH_HARPIE_LADY = 1697,
    SPECIES_HARPIE_QUEEN = 1698,
    SPECIES_HARPIE_BROTHER = 1699,
    SPECIES_HARPIES_PET_DRAGON = 1700,
    SPECIES_AMAZONESS_BABY_TIGER = 1701,
    SPECIES_AMAZONESS_TIGER = 1702,
    SPECIES_AMAZONESS_PRINCESS = 1703,
    SPECIES_AMAZONESS_QUEEN = 1704,
    SPECIES_REVIVAL_ROSE = 1705,
    SPECIES_REGENERATING_ROSE = 1706,
    SPECIES_ROSE_TENTACLES = 1707,
    SPECIES_DARK_RESONATOR = 1708,
    SPECIES_CRIMSON_RESONATOR = 1709,
    SPECIES_SMALL_PIECE_GOLEM = 1710,
    SPECIES_MEDIUM_PIECE_GOLEM = 1711,
    SPECIES_BIG_PIECE_GOLEM = 1712,
    SPECIES_SUMMONED_SKULL = 1713,
    SPECIES_BLACK_SKULL_DRAGON = 1714,
    SPECIES_ARCHFIENDS_ZOMBIE_SKULL = 1715,
    SPECIES_CURSE_OF_DRAGON = 1716,
    SPECIES_GAIA_THE_DRAGON_CHAMPION = 1717,
    SPECIES_QUEENS_KNIGHT = 1718,
    SPECIES_KINGS_KNIGHT = 1719,
    SPECIES_JACKS_KNIGHT = 1720,
    SPECIES_INFERNITY_ARCHFIEND = 1721,
    SPECIES_INFERNITY_DOOM_ARCHFIEND = 1722,
    SPECIES_RED_ARCHERY_GIRL = 1723,
    SPECIES_SAGGI = 1724,
    SPECIES_PETEN = 1725,
    SPECIES_AGIDO = 1726,
    SPECIES_AGIDO_THE_ANCIENT_SENTINEL = 1727,
    SPECIES_KELDO = 1728,
    SPECIES_KELDO_THE_SACRED_PROTECTOR = 1729,
    SPECIES_BLACK_PTERA = 1730,
    SPECIES_OVERTEX_QOATLUS = 1731,
    SPECIES_LORD_OF_D = 1732,
    SPECIES_KING_OF_D = 1733,
    SPECIES_GEARFRIED_THE_IRON_KNIGHT = 1734,
    SPECIES_GEARFRIED_THE_SWORDMASTER = 1735,
    SPECIES_GIANT_SOLDIER_OF_STONE = 1736,
    SPECIES_GIANT_SOLDIER_OF_STEEL = 1737,
    SPECIES_CRAB_TURTLE = 1738,
    SPECIES_LEGENDARY_FISHERMAN = 1739,
    SPECIES_LEGENDARY_FISHERMAN_TWO = 1740,
    SPECIES_KOUMORI_DRAGON = 1741,
    SPECIES_SERPENT_NIGHT_DRAGON = 1742,
    SPECIES_JUNK_SYNCHRON = 1743,
    SPECIES_JUNK_WARRIOR = 1744,
    SPECIES_JUNK_DESTROYER = 1745,
    SPECIES_JUNK_ARCHER = 1746,
    SPECIES_NITRO_SYNCHRON = 1747,
    SPECIES_NITRO_WARRIOR = 1748,
    SPECIES_TURBO_SYNCHRON = 1749,
    SPECIES_TURBO_WARRIOR = 1750,
    SPECIES_ROAD_SYNCHRON = 1751,
    SPECIES_ROAD_WARRIOR = 1752,
    SPECIES_QUICKDRAW_SYNCHRON = 1753,
    SPECIES_LEVEL_EATER = 1754,
    SPECIES_OUTSTANDING_DOG_MARRON = 1755,
    SPECIES_SKULL_DOG_MARRON = 1756,
    SPECIES_MAD_DOG_OF_DARKNESS = 1757,
    SPECIES_BEHEMOTH_KING_OF_ALL_ANIMALS = 1758,
    SPECIES_INPACHI = 1759,
    SPECIES_BLAZING_INPACHI = 1760,
    SPECIES_CHARCOAL_INPACHI = 1761,
    SPECIES_GAIA_THE_FIERCE_KNIGHT = 1762,
    SPECIES_GAIA_KNIGHT_THE_FORCE_OF_EARTH = 1763,
    SPECIES_DARK_CAVALRY = 1764,
    SPECIES_AVIAN = 1765,
    SPECIES_FLAME_WINGMAN = 1766,
    SPECIES_SHINING_FLARE_WINGMAN = 1767,
    SPECIES_CYBER_PETIT_ANGEL = 1768,
    SPECIES_CYBER_ANGEL_BENTEN = 1769,
    SPECIES_CYBER_ANGEL_DAKINI = 1770,
    SPECIES_WARRIOR_OF_ZERA = 1771,
    SPECIES_ZERA_THE_MANT = 1772,
    SPECIES_MEGAZOWLER = 1773,
    SPECIES_ILLUSIONIST_FACELESS_MAGE = 1774,
    SPECIES_ILLUSIONIST_FACELESS_MAGICIAN = 1775,
    SPECIES_PARROT_DRAGON = 1776,
    SPECIES_TRI_HORNED_DRAGON = 1777,
    SPECIES_MYSTIC_TOMATO = 1778,
    SPECIES_HUNGRY_BURGER = 1779,
    SPECIES_THUNDER_DRAGON = 1780,
    SPECIES_TWIN_HEADED_THUNDER_DRAGON = 1781,
    SPECIES_THUNDER_DRAGON_TITAN = 1782,
    SPECIES_THUNDER_DRAGON_COLOSSUS = 1783,
    SPECIES_PANTHER_WARRIOR = 1784,
    SPECIES_SOLITAIRE_MAGICIAN = 1785,
    SPECIES_FORTUNE_LADY_EVERY = 1786,
    SPECIES_FORTUNE_LADY_EVERY_BUG = 1787,
    SPECIES_FORTUNE_LADY_EVERY_DARK = 1788,
    SPECIES_FORTUNE_LADY_EVERY_DRAGON = 1789,
    SPECIES_FORTUNE_LADY_EVERY_ELECTRIC = 1790,
    SPECIES_FORTUNE_LADY_EVERY_FIGHTING = 1791,
    SPECIES_FORTUNE_LADY_EVERY_FIRE = 1792,
    SPECIES_FORTUNE_LADY_EVERY_FLYING = 1793,
    SPECIES_FORTUNE_LADY_EVERY_GHOST = 1794,
    SPECIES_FORTUNE_LADY_EVERY_GRASS = 1795,
    SPECIES_FORTUNE_LADY_EVERY_GROUND = 1796,
    SPECIES_FORTUNE_LADY_EVERY_ICE = 1797,
    SPECIES_FORTUNE_LADY_EVERY_POISON = 1798,
    SPECIES_FORTUNE_LADY_EVERY_PSYCHIC = 1799,
    SPECIES_FORTUNE_LADY_EVERY_ROCK = 1800,
    SPECIES_FORTUNE_LADY_EVERY_STEEL = 1801,
    SPECIES_FORTUNE_LADY_EVERY_WATER = 1802,
    SPECIES_MUSICIAN_KING = 1803,
    SPECIES_HEAVY_METAL_KING = 1804,
    SPECIES_SLOT_MACHINE = 1805,
    SPECIES_BATTLE_OX = 1806,
    SPECIES_RABID_HORSEMAN = 1807,
    SPECIES_JIRAI_GUMO = 1808,
    SPECIES_LAUNCHER_SPIDER = 1809,
    SPECIES_VAMPIRE_BAT = 1810,
    SPECIES_VAMPIRE_LORD = 1811,
    SPECIES_VAMPIRE_GENESIS = 1812,
    SPECIES_VAMPIRE_LADY = 1813,
    SPECIES_VAMPIRE_GRACE = 1814,
    SPECIES_CLAYMAN = 1815,
    SPECIES_MUDBALLMAN = 1816,
    SPECIES_GRACEFUL_DICE = 1817,
    SPECIES_SKULL_DICE = 1818,
    SPECIES_ORGOTH_THE_RELENTLESS = 1819,
    SPECIES_LA_JINN = 1820,
    SPECIES_LORD_POISON = 1821,
    SPECIES_LAVA_GOLEM = 1822,
    SPECIES_REVIVAL_JAM = 1823,
    SPECIES_HUMANOID_SLIME = 1824,
    SPECIES_HUMANOID_WORM_DRAKE = 1825,
    SPECIES_EGYPTIAN_GOD_SLIME = 1826,
    SPECIES_PENDULUM_MACHINE = 1827,
    SPECIES_SPEAR_DRAGON = 1828,
    SPECIES_SILENT_MAGICIAN_LEVEL4 = 1829,
    SPECIES_SILENT_MAGICIAN_LEVEL8 = 1830,
    SPECIES_SILENT_SWORDSMAN_LEVEL3 = 1831,
    SPECIES_SILENT_SWORDSMAN_LEVEL7 = 1832,
    SPECIES_GANDORA = 1833,
    SPECIES_REAPER_OF_THE_CARDS = 1834,
    SPECIES_KING_OF_YAMIMAKAI = 1835,
    SPECIES_RESCURE_RABBIT = 1836,
    SPECIES_RESCUE_CAT = 1837,
    SPECIES_WARM_WORM = 1838,
    SPECIES_NEEDLE_WORM = 1839,
    SPECIES_DUNGEON_WORM = 1840,
    SPECIES_KARATE_MAN = 1841,
    SPECIES_DES_KANGAROO = 1842,
    SPECIES_MASTER_OF_OZ = 1843,
    SPECIES_BERSERK_GORILLA = 1844,
    SPECIES_SINISTER_SERPENT = 1845,
    SPECIES_THIRTEENTH_GRAVE = 1846,
    SPECIES_SKULL_SERVANT = 1847,
    SPECIES_KING_OF_THE_SKULL_SERVANTS = 1848,
    SPECIES_CATAPULT_TURTLE = 1849,
    SPECIES_ELECTROMAGNETIC_TURTLE = 1850,
    SPECIES_BLOCK_DRAGON = 1851,
    SPECIES_BUSTER_BLADER = 1852,
    SPECIES_DARK_PALADIN = 1853,
    SPECIES_X_CANNON = 1854,
    SPECIES_XY_DRAGON = 1855,
    SPECIES_XYZ_DRAGON_CANNON = 1856,
    SPECIES_JINZO_RETURNER = 1857,
    SPECIES_JINZO = 1858,
    SPECIES_RYU_RAN = 1859,
    SPECIES_MANGA_RYU_RAN = 1860,
    SPECIES_BLUE_EYES_TOON_DRAGON = 1861,
    SPECIES_TOON_ALLIGATOR = 1862,
    SPECIES_TOON_GEMINI_ELF = 1863,
    SPECIES_TOON_DARK_MAGICIAN_GIRL = 1864,
    SPECIES_TOON_SUMMONED_SKULL = 1865,
    SPECIES_TOON_ANCIENT_GEAR_GOLEM = 1866,
    SPECIES_RED_EYES_TOON_DRAGON = 1867,
    SPECIES_TOON_DARK_MAGICIAN = 1868,
    SPECIES_BIG_SHIELD_GARDNA = 1869,
    SPECIES_POT_OF_GREED = 1870,
    SPECIES_AVATAR_OF_THE_POT = 1871,
    SPECIES_PUMPKING = 1872,
    SPECIES_GUARDIAN_EATOS = 1873,
    SPECIES_HYOZANRYU = 1874,
    SPECIES_DARK_NECROFEAR = 1875,
    SPECIES_METEOR_DRAGON = 1876,
    SPECIES_METEOR_BLACK_DRAGON = 1877,
    SPECIES_YATA_GARASU = 1878,
    SPECIES_BLACK_LUSTER_SOLDIER = 1879,
    SPECIES_CHAOS_EMPEROR_DRAGON = 1880,
    SPECIES_DRAGON_MASTER_KNIGHT = 1881,
    SPECIES_NEOS = 1882,
    SPECIES_AQUA_NEOS = 1883,
    SPECIES_FLARE_NEOS = 1884,
    SPECIES_GLOW_NEOS = 1885,
    SPECIES_AIR_NEOS = 1886,
    SPECIES_GRAND_NEOS = 1887,
    SPECIES_DARK_NEOS = 1888,
    SPECIES_HONEST_NEOS = 1889,
    SPECIES_THOUSAND_EYES_IDOL = 1890,
    SPECIES_RELINQUISHED = 1891,
    SPECIES_THOUSAND_EYES_RESTRICT = 1892,
    SPECIES_THE_GREAT_LEVIATHAN = 1893,
    SPECIES_FIVE_GOD_DRAGON = 1894,
    SPECIES_HAMON = 1895,
    SPECIES_RAVIEL = 1896,
    SPECIES_URIA = 1897,
    SPECIES_OBELISK_THE_TORMENTOR = 1898,
    SPECIES_WINGED_DRAGON_OF_RA = 1899,
    SPECIES_SLIFER_THE_SKY_DRAGON = 1900,
    SPECIES_HORUS_LEVEL_FOUR = 1901,
    SPECIES_HORUS_LEVEL_SIX = 1902,
    SPECIES_HORUS_LEVEL_EIGHT = 1903,
    SPECIES_CYBERDARK_HORN = 1904,
    SPECIES_CYBERDARK_DRAGON = 1905,
    SPECIES_CYBER_DRAGON = 1906,
    SPECIES_CYBER_TWIN_DRAGON = 1907,
    SPECIES_CYBER_END_DRAGON = 1908,
    SPECIES_CHIMERATECH_OVERDRAGON = 1909,
    SPECIES_EXODIA_THE_FORBIDDEN_ONE = 1910,
    SPECIES_EXODIA_NECROSS = 1911,
    SPECIES_ARMED_DRAGON_LEVEL3 = 1912,
    SPECIES_ARMED_DRAGON_LEVEL5 = 1913,
    SPECIES_ARMED_DRAGON_LEVEL7 = 1914,
    SPECIES_ARMED_DRAGON_LEVEL10 = 1915,
    SPECIES_MOBIUS = 1916,
    SPECIES_MOKEY_MOKEY = 1917,
    SPECIES_MOKEY_KING = 1918,
    SPECIES_VOLCANIC_SHELL = 1919,
    SPECIES_VOLCANIC_SLICER = 1920,
    SPECIES_VOLCANIC_SCATTERSHOT = 1921,
    SPECIES_VOLCANIC_HAMMERER = 1922,
    SPECIES_VOLCANIC_DOOMFIRE = 1923,
    SPECIES_VOLCANIC_QUEEN = 1924,
    SPECIES_TIME_WIZARD = 1925,
    SPECIES_SNOW_DRAGON = 1926,
    SPECIES_SNOWDUST_DRAGON = 1927,
    SPECIES_WHITE_NIGHT_DRAGON = 1928,
    SPECIES_STEAMROID = 1929,
    SPECIES_STEAM_GYROID = 1930,
    SPECIES_DRILLROID = 1931,
    SPECIES_SUPER_VEHICROID_JUMBO_DRAGON = 1932,
    SPECIES_AMBULANCEROID = 1933,
    SPECIES_AMBULANCE_RESCUEROID = 1934,
    SPECIES_NECROSHADE = 1935,
    SPECIES_NECROID_SHAMAN = 1936,
    SPECIES_SANGA_OF_THE_THUNDER = 1937,
    SPECIES_GATE_GUARDIAN_THUNDER_WIND = 1938,
    SPECIES_GATE_GUARDIAN = 1939,
    SPECIES_SEVEN_COLOURED_FISH = 1940,
    SPECIES_BURSTINATRIX = 1941,
    SPECIES_RAMPART_BLASTER = 1942,
    SPECIES_INFERNO_WING = 1943,
    SPECIES_FORTRESS_WHALE = 1944,
    SPECIES_SEIYARYU = 1945,
    SPECIES_STARRY_NIGHT_STARRY_DRAGON = 1946,
    SPECIES_BREAKER_THE_MAGICAL_WARRIOR = 1947,
    SPECIES_AQUA_MADOR = 1948,
    SPECIES_NEO_AQUA_MADOR = 1949,
    SPECIES_ANCIENT_GEAR_SOLDIER = 1950,
    SPECIES_ANCIENT_GEAR_GOLEM = 1951,
    SPECIES_ULTIMATE_ANCIENT_GEAR_GOLEM = 1952,
    SPECIES_WALL_SHADOW = 1953,
    SPECIES_FIREWALL_DRAGON = 1954,
    SPECIES_PREDAPLANT_VERTE_ANACONDA = 1955,
    SPECIES_BLOWBACK_DRAGON = 1956,
    SPECIES_BARREL_DRAGON = 1957,
    SPECIES_BLADE_SKATER = 1958,
    SPECIES_CYBER_BLADER = 1959,
    SPECIES_HELIOS_THE_PRIMORDIAL_SUN = 1960,
    SPECIES_HELIOS_DUO_MEGISTUS = 1961,
    SPECIES_HELIOS_TRICE_MEGISTUS = 1962,
    SPECIES_STAR_BOY = 1963,
    SPECIES_MISTAR_BOY = 1964,
    SPECIES_DARK_RULER_HA_DES = 1965,
    SPECIES_DARK_KING_OF_THE_ABYSS = 1966,
    SPECIES_SUNLIGHT_UNICORN = 1967,
    SPECIES_FIEND_KRAKEN = 1968,
    SPECIES_DOOM_KRAKEN = 1969,
    SPECIES_MONTAGE_DRAGON = 1970,
    SPECIES_BLADEDGE = 1971,
    SPECIES_PLASMA_VICE = 1972,
    SPECIES_EMBODIMENT_OF_APOPHIS = 1973,
    SPECIES_FORMULA_SYNCHRON = 1974,
    SPECIES_MAMMOTH_GRAVEYARD = 1975,
    SPECIES_GREAT_MAMMOTH_OF_GOLDFINE = 1976,
    SPECIES_LAUNDRY_DRAGONMAID = 1977,
    SPECIES_DRAGONMAID_NUDYARL = 1978,
    SPECIES_HITOTSU_ME_GIANT = 1979,
    SPECIES_CYBERNETIC_CYCLOPEAN = 1980,
    SPECIES_SONIC_BIRD = 1981,
    SPECIES_ALECTOR = 1982,
    SPECIES_RUBY_CARBUNCLE = 1983,
    SPECIES_CRYSTAL_BEAST_SAPHIRE_PEGASUS = 1984,
    SPECIES_PENGUIN_SOLDIER = 1985,
    SPECIES_EMPEROR_PENGUIN = 1986,
    SPECIES_NIGHTMARE_PENGUIN = 1987,
    SPECIES_SWORDSTALKER = 1988,
    SPECIES_TOON_MERMAID = 1989,
    SPECIES_GEMINI_ELF = 1990,
    SPECIES_DARK_JEROID = 1991,
    SPECIES_SPARKMAN = 1992,
    SPECIES_THUNDERGIANT = 1993,
    SPECIES_CHANGE_OF_HEART = 1994,
    SPECIES_MIMICAT = 1995,
    SPECIES_ARCHFIENDS_MIRROR = 1996,
    SPECIES_NIWATORI = 1997,
    SPECIES_THUNDER_KID = 1998,
    SPECIES_SPACE_MAMBO = 1999,
    SPECIES_MUSHROOM_MAN = 2000,
    SPECIES_MEDA_BAT = 2001,
    SPECIES_BUBBLEMAN = 2002,
    SPECIES_STEAM_HEALER = 2003,
    SPECIES_MELCHID_THE_FOUR_FACE_BEAST = 2004,
    SPECIES_MASKED_BEAST_DES_GARDIUS = 2005,
    SPECIES_GRAND_TIKI_ELDER = 2006,
    SPECIES_MASKED_BEAST = 2007,
    SPECIES_CLOUDIAN_NIMBUSMAN = 2008,
    SPECIES_CLOUDIAN_EYE_OF_THE_TYPHOON = 2009,
    SPECIES_CLEAR_VICE_DRAGON = 2010,
    SPECIES_HONEST = 2011,
    SPECIES_MAGICIAN_OF_BLACK_CHAOS = 2012,
    SPECIES_RAINBOW_DRAGON = 2013,
    SPECIES_RAINBOW_NEOS = 2014,
    SPECIES_GHOSTRICK_WITCH = 2015,
    SPECIES_GAMECIEL = 2016,
    SPECIES_MYSTICAL_BEAST_OF_SERKET = 2017,
    SPECIES_JUDGE_MAN = 2018,
    SPECIES_JUDGMENT_DRAGON = 2019,
    SPECIES_ELDLICH = 2020,
    SPECIES_DESTINY_HERO_PLASMA = 2021,
    SPECIES_DESTINY_HERO_DREADMASTER = 2022,
    SPECIES_DIVINE_SERPENT_GEH = 2023,
    SPECIES_FROST_AND_FLAME_DRAGON = 2024,
    SPECIES_REPTILIANNE_SERVANT = 2025,
    SPECIES_DRAGON_QUEEN_OF_TRAGIC_ENDING = 2026,
    SPECIES_ZOA = 2027,
    SPECIES_METALZOA = 2028,
    SPECIES_KYUOTORA = 2029,
    SPECIES_SHUNOROS = 2030,
    SPECIES_TYRANT_DRAGON = 2031,
    SPECIES_DAEDALUS = 2032,
    SPECIES_DANDYLION = 2033,
    SPECIES_GIANT_REX = 2034,
    SPECIES_SNOWMAN_EATER = 2035,
    SPECIES_SNOWMAN_EATER_BUSTED = 2036,
    SPECIES_VENOM_BOA = 2037,
    SPECIES_VENNOMINON = 2038,
    SPECIES_VENNOMINAGA = 2039,
    SPECIES_ARCANA_FORCE_THE_FIEND = 2040,
    SPECIES_ARCANA_FORCE_THE_DARK_RULER = 2041,
    SPECIES_ARCANA_FORCE_THE_LIGHT_RULER = 2042,
    SPECIES_ARCANA_FORCE_THE_WORLD = 2043,
    SPECIES_SAMSARAS_LOTUS = 2044,
    SPECIES_YUBEL = 2045,
    SPECIES_YUBEL_TERROR_INCARNATE = 2046,
    SPECIES_YUBEL_ULTIMATE_KNIGHTMARE = 2047,
    SPECIES_DARK_DIVINER = 2048,
    SPECIES_UNDERGROUND_ARACHNID = 2049,
    SPECIES_FROZEN_FITZGERALD = 2050,
    SPECIES_ZEMAN_THE_APE_KING = 2051,
    SPECIES_DARK_FLATTOP = 2052,
    SPECIES_HUNDRED_EYES_DRAGON = 2053,
    SPECIES_SUPAY = 2054,
    SPECIES_MOON_DRAGON_QUILLA = 2055,
    SPECIES_SUN_DRAGON_INTI = 2056,
    SPECIES_EARTHBOUND_IMMORTAL_CCAPAC_APU = 2057,
    SPECIES_EARTHBOUND_IMMORTAL_CCAPAC_APU_AWAKENED = 2058,
    SPECIES_EARTHBOUND_IMMORTAL_CUSILLU = 2059,
    SPECIES_EARTHBOUND_IMMORTAL_CUSILLU_AWAKENED = 2060,
    SPECIES_EARTHBOUND_IMMORTAL_CCARAYHUA = 2061,
    SPECIES_EARTHBOUND_IMMORTAL_CCARAYHUA_AWAKENED = 2062,
    SPECIES_EARTHBOUND_IMMORTAL_URU = 2063,
    SPECIES_EARTHBOUND_IMMORTAL_URU_AWAKENED = 2064,
    SPECIES_EARTHBOUND_IMMORTAL_CHACU_CHALLHUA = 2065,
    SPECIES_EARTHBOUND_IMMORTAL_CHACU_CHALLHUA_AWAKENED = 2066,
    SPECIES_EARTHBOUND_IMMORTAL_ASLLA_PISCU = 2067,
    SPECIES_EARTHBOUND_IMMORTAL_ASLLA_PISCU_AWAKENED = 2068,
    SPECIES_EARTHBOUND_IMMORTAL_WIRAQOCHA_RASCA = 2069,
    SPECIES_EARTHBOUND_IMMORTAL_WIRAQOCHA_RASCA_AWAKENED = 2070,
    SPECIES_DEBRIS_DRAGON = 2071,
    SPECIES_STARDUST_DRAGON = 2072,
    SPECIES_SHOOTING_STAR_DRAGON = 2073,
    SPECIES_RED_RISING_DRAGON = 2074,
    SPECIES_RED_DRAGON_ARCHFIEND = 2075,
    SPECIES_RED_NOVA_DRAGON = 2076,
    SPECIES_RED_ROSE_DRAGON = 2077,
    SPECIES_BLACK_ROSE_DRAGON = 2078,
    SPECIES_RUDDY_ROSE_DRAGON = 2079,
    SPECIES_BLACKWING_GHIBLI = 2080,
    SPECIES_BLACKWING_DRAGON = 2081,
    SPECIES_BLACKWING_ASSAULT_DRAGON = 2082,
    SPECIES_FAIRY_DRAGON = 2083,
    SPECIES_ANCIENT_FAIRY_DRAGON = 2084,
    SPECIES_ANCIENT_PIXIE_DRAGON = 2085,
    SPECIES_REVOLUTION_SYNCHRON = 2086,
    SPECIES_POWER_TOOL_DRAGON = 2087,
    SPECIES_LIFE_STREAM_DRAGON = 2088,
    SPECIES_MAJESTIC_DRAGON = 2089,
    SPECIES_MAJESTIC_STAR_DRAGON = 2090,
    SPECIES_MAJESTIC_RED_DRAGON = 2091,
    SPECIES_SHOOTING_QUASAR_DRAGON = 2092,
    SPECIES_CRIMSON_DRAGON = 2093,
    SPECIES_NIBIRU = 2094,
    SPECIES_NIBIRU_MONSTER_FORM = 2095,
    SPECIES_VICTORY_DRAGON = 2096,
