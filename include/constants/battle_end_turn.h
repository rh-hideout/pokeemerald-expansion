...
enum EndTurnResolutionOrder
{
    ...
    ENDTURN_SEND_OUT_REPLACEMENTS_1,
    ENDTURN_AFFECTION,
    ENDTURN_FUTURE_SIGHT,
    ENDTURN_WISH,
    ENDTURN_FIRST_EVENT_BLOCK,
    ENDTURN_SEND_OUT_REPLACEMENTS_2,
    ENDTURN_AQUA_RING,
    ENDTURN_INGRAIN,
    ENDTURN_LEECH_SEED,
    ENDTURN_POISON,
    ...
    ENDTURN_PERISH_SONG,
    ENDTURN_ROOST,
    ENDTURN_SEND_OUT_REPLACEMENTS_3,
    ...
    ENDTURN_SEND_OUT_REPLACEMENTS_4,
    ENDTURN_FORM_CHANGE,
    ENDTURN_EJECT_PACK,
    ENDTURN_SEND_OUT_REPLACEMENTS_5,
