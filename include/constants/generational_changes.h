...
#define CONFIG_DEFINITIONS(F) \
    ...
    F(INCAPACITATED_CATCH_BONUS, incapacitatedCatchBonus, (u32, GEN_COUNT - 1)) /* TODO: use in tests */ \
    F(LOW_LEVEL_CATCH_BONUS,     lowLevlCatchBonus,       (u32, GEN_COUNT - 1)) /* TODO: use in tests */ \
    F(MISSING_BADGE_CATCH_MALUS, missingBadgeCatchMalue,  (u32, GEN_COUNT - 1)) /* TODO: use in tests */ \
    F(CRITICAL_CAPTURE_IF_OWNED, criticalCaptureIfOwned,  (u32, GEN_COUNT - 1)) /* TODO: use in tests */ \
    /* Other settings */ \
