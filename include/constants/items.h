...
enum __attribute__((packed)) Item
{
    ...
    ITEM_ENERGYPOWDER = ITEM_ENERGY_POWDER, // Pre-Gen 6 name
    ITEM_ENERGY_ROOT = 40,
    ITEM_HEAL_POWDER = 41,
    ITEM_REVIVAL_HERB = 42,
    ITEM_ANTIDOTE = 43,
    ITEM_PARALYZE_HEAL = 44,
    ITEM_PARLYZ_HEAL = ITEM_PARALYZE_HEAL, // Pre-Gen 6 name
    ITEM_BURN_HEAL = 45,
    ITEM_ICE_HEAL = 46,
    ITEM_AWAKENING = 47,
    ITEM_FULL_HEAL = 48,
    ...
    ITEM_MAX_ETHER = 50,
    ITEM_ELIXIR = 51,
    ITEM_ELIXER = ITEM_ELIXIR, // Pre-Gen 3 name
    ITEM_MAX_ELIXIR = 52,
    ITEM_MAX_ELIXER = ITEM_MAX_ELIXIR, // Pre-Gen 3 name
    ITEM_BERRY_JUICE = 53,
    ITEM_SACRED_ASH = 54,
    ITEM_SWEET_HEART = 55,
    ITEM_MAX_HONEY = 56,
    ...
    ITEM_RAGECANDYBAR = ITEM_RAGE_CANDY_BAR, // Pre-Gen 6 name
    ITEM_LAVA_COOKIE = 59,
    ITEM_OLD_GATEAU = 60,
    ...
    ITEM_HEALTH_WING = ITEM_HEALTH_FEATHER, // Pre-Gen 8 name
    ITEM_MUSCLE_FEATHER = 74,
    ITEM_MUSCLE_WING = ITEM_MUSCLE_FEATHER, // Pre-Gen 8 name
    ITEM_RESIST_FEATHER = 75,
    ITEM_RESIST_WING = ITEM_RESIST_FEATHER, // Pre-Gen 8 name
    ITEM_GENIUS_FEATHER = 76,
    ITEM_GENIUS_WING = ITEM_GENIUS_FEATHER, // Pre-Gen 8 name
    ITEM_CLEVER_FEATHER = 77,
    ITEM_CLEVER_WING = ITEM_CLEVER_FEATHER, // Pre-Gen 8 name
    ITEM_SWIFT_FEATHER = 78,
    ITEM_SWIFT_WING = ITEM_SWIFT_FEATHER, // Pre-Gen 8 name
    ...
    ITEM_X_ATTACK = 121,
    ITEM_X_DEFENSE = 122,
    ITEM_X_DEFEND = ITEM_X_DEFENSE, // Pre-Gen 6 name
    ITEM_X_SP_ATK = 123,
    ITEM_X_SPECIAL = ITEM_X_SP_ATK, // Pre-Gen 6 name
    ITEM_X_SP_DEF = 124,
    ITEM_X_SPEED = 125,
    ITEM_X_ACCURACY = 126,
    ...
    ITEM_TINYMUSHROOM = ITEM_TINY_MUSHROOM, // Pre-Gen 6 name
    ITEM_BIG_MUSHROOM = 138,
    ITEM_BALM_MUSHROOM = 139,
    ITEM_BALMMUSHROOM = ITEM_BALM_MUSHROOM, // Pre-Gen 6 name
    ITEM_PEARL = 140,
    ITEM_BIG_PEARL = 141,
    ...
    ITEM_PRETTY_WING = ITEM_PRETTY_FEATHER, // Pre-Gen 8 name
    ...
    ITEM_BLU_APRICORN = ITEM_BLUE_APRICORN, // Pre-Gen 6 name
    ITEM_YELLOW_APRICORN = 190,
    ITEM_YLW_APRICORN = ITEM_YELLOW_APRICORN, // Pre-Gen 6 name
    ITEM_GREEN_APRICORN = 191,
    ITEM_GRN_APRICORN = ITEM_GREEN_APRICORN, // Pre-Gen 6 name
    ITEM_PINK_APRICORN = 192,
    ITEM_PNK_APRICORN = ITEM_PINK_APRICORN, // Pre-Gen 6 name
    ITEM_WHITE_APRICORN = 193,
    ITEM_WHT_APRICORN = ITEM_WHITE_APRICORN, // Pre-Gen 6 name
    ITEM_BLACK_APRICORN = 194,
    ITEM_BLK_APRICORN = ITEM_BLACK_APRICORN, // Pre-Gen 6 name
    ...
    ITEM_THUNDERSTONE = ITEM_THUNDER_STONE, // Pre-Gen 6 name
    ITEM_LEAF_STONE = 214,
    ITEM_ICE_STONE = 215,
    ITEM_SUN_STONE = 216,
    ITEM_MOON_STONE = 217,
    ...
    ITEM_UPGRADE = 228,
    ITEM_UP_GRADE = ITEM_UPGRADE, // Pre-Gen 8 name
    ITEM_PROTECTOR = 229,
    ...
    ITEM_LIGHT_BALL = 392,
    ITEM_LEEK = 393,
    ITEM_STICK = ITEM_LEEK, // Pre-Gen 8 name
    ITEM_THICK_CLUB = 394,
    ITEM_LUCKY_PUNCH = 395,
    ITEM_METAL_POWDER = 396,
    ITEM_QUICK_POWDER = 397,
    ITEM_DEEP_SEA_SCALE = 398,
    ITEM_DEEPSEASCALE = ITEM_DEEP_SEA_SCALE, // Pre-Gen 6 name
    ITEM_DEEP_SEA_TOOTH = 399,
    ITEM_DEEPSEATOOTH = ITEM_DEEP_SEA_TOOTH, // Pre-Gen 6 name
    ITEM_SOUL_DEW = 400,
    ...
    ITEM_NEVERMELTICE = ITEM_NEVER_MELT_ICE, // Pre-Gen 6 name
    ITEM_BLACK_BELT = 431,
    ITEM_BLACKBELT = ITEM_BLACK_BELT, // Gen 2 name
    ITEM_POISON_BARB = 432,
    ITEM_SOFT_SAND = 433,
    ITEM_SHARP_BEAK = 434,
    ITEM_TWISTED_SPOON = 435,
    ITEM_TWISTEDSPOON = ITEM_TWISTED_SPOON, // Pre-Gen 6 name
    ITEM_SILVER_POWDER = 436,
    ITEM_SILVERPOWDER = ITEM_SILVER_POWDER, // Pre-Gen 6 name
    ITEM_HARD_STONE = 437,
    ITEM_SPELL_TAG = 438,
    ITEM_DRAGON_FANG = 439,
    ITEM_BLACK_GLASSES = 440,
    ITEM_BLACKGLASSES = ITEM_BLACK_GLASSES, // Pre-Gen 6 name
    ITEM_METAL_COAT = 441,
    ...
    ITEM_BRIGHTPOWDER = ITEM_BRIGHT_POWDER, // Pre-Gen 6 name
    ITEM_WHITE_HERB = 460,
    ITEM_EXP_SHARE = 461,
    ITEM_EXP_ALL = ITEM_EXP_SHARE, // Gen 1 name
    ITEM_QUICK_CLAW = 462,
    ...
    // Misc. Key Items
    ITEM_BIKE = 706,
    ITEM_BICYCLE = ITEM_BIKE, // Pre-Gen 8 name
    ITEM_MACH_BIKE = 707,
    ITEM_ACRO_BIKE = 708,
    ITEM_OLD_ROD = 709,
    ITEM_GOOD_ROD = 710,
    ...
    ITEM_ITEMFINDER = ITEM_DOWSING_MACHINE, // Pre-Gen 4 name
    ITEM_DOWSING_MCHN = ITEM_DOWSING_MACHINE, // Gen 4-5 name
    ITEM_TOWN_MAP = 713,
    ITEM_VS_SEEKER = 714,
    ITEM_TM_CASE = 715,
    ITEM_BERRY_POUCH = 716,
    ITEM_POKEMON_BOX_LINK = 717,
    ITEM_POKEMON_BOX = ITEM_POKEMON_BOX_LINK, // Gen 7 name
    ITEM_COIN_CASE = 718,
    ITEM_POWDER_JAR = 719,
    ...
    ITEM_SS_TICKET = 727,
    ITEM_EON_TICKET = 728,
    ITEM_MYSTIC_TICKET = 729, // Unofficial name with space
    ITEM_MYSTICTICKET = ITEM_MYSTIC_TICKET,
    ITEM_AURORA_TICKET = 730, // Unofficial name with space
    ITEM_AURORATICKET = ITEM_AURORA_TICKET,
    ITEM_OLD_SEA_MAP = 731,
    ITEM_LETTER = 732,
    ITEM_DEVON_PARTS = 733,
    ITEM_DEVON_GOODS = ITEM_DEVON_PARTS, // Gen 3 name
    ITEM_GO_GOGGLES = 734,
    ...
    ITEM_RM_1_KEY = ITEM_KEY_TO_ROOM_1, // Gen 3 name
    ITEM_KEY_TO_ROOM_2 = 740,
    ITEM_RM_2_KEY = ITEM_KEY_TO_ROOM_2, // Gen 3 name
    ITEM_KEY_TO_ROOM_4 = 741,
    ITEM_RM_4_KEY = ITEM_KEY_TO_ROOM_4, // Gen 3 name
    ITEM_KEY_TO_ROOM_6 = 742,
    ITEM_RM_6_KEY = ITEM_KEY_TO_ROOM_6, // Gen 3 name
    ITEM_METEORITE = 743,
    ITEM_MAGMA_EMBLEM = 744,
    ITEM_CONTEST_PASS = 745,
    ITEM_PARCEL = 746,
    ITEM_OAKS_PARCEL = ITEM_PARCEL, // Pre-Gen 4 name
    ITEM_SECRET_KEY = 747,
