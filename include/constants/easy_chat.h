...
#define EC_WORD_CENTRE        ((EC_GROUP_TRAINER << EC_MASK_BITS) | 7)
...
#define EC_WORD_COLOUR         ((EC_GROUP_STATUS << EC_MASK_BITS) | 8)
#define EC_WORD_ALT_COLOUR     ((EC_GROUP_STATUS << EC_MASK_BITS) | 9)
...
#define EC_WORD_COLOUR_CHANGE  ((EC_GROUP_STATUS << EC_MASK_BITS) | 86)
