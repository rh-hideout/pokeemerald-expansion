...
#define BERRY_COLOUR_RED    0
#define BERRY_COLOUR_BLUE   1
#define BERRY_COLOUR_PURPLE 2
#define BERRY_COLOUR_GREEN  3
#define BERRY_COLOUR_YELLOW 4
#define BERRY_COLOUR_PINK   5
