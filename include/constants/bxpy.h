...
#define FONT_BXPY_SPECIES_NAME FONT_SMALL_NARROWER
...
#define BXPY_SEX_FRAME_FEMALE (BXPY_SEX_STEP_0 * BXPY_SEX_FRAME_SIZE)
#define BXPY_SEX_FRAME_MALE   (BXPY_SEX_STEP_1 * BXPY_SEX_FRAME_SIZE)
