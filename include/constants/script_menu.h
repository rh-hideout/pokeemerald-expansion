...
enum
{
    ...
    MULTI_PARENT_CHOICE,
    MULTI_HELP_OR_ADULT,
    MULTI_LITTLE_GIRL_BOOK_RESPONSE,
    ...
    MULTICHOICE_LIBRARY_HELP_BLAINE,
    MULTICHOICE_COUNTERPART_BOOK_RESPONSE,
    MULTICHOICE_TWIN_FIRST_ENCOUNTER,
    MULTICHOICE_CERULEAN_LIBRARY_OLD_MAN,
    MULTICHOICE_CERULEAN_FIRST_RESPONSE,
    MULTICHOICE_SAFFRON_TRUTH_RESPONSE,
    MULTICHOICE_CARPY_DECISION,
    MULTICHOICE_CERULEAN_BOOK_DISCLOSURE,
};
