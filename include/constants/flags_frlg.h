...
#define FLAG_BADGE01_GET_FRLG                                            (SYS_FLAGS + 0x20)
#define FLAG_BADGE02_GET_FRLG                                            (SYS_FLAGS + 0x21)
#define FLAG_BADGE03_GET_FRLG                                            (SYS_FLAGS + 0x22)
#define FLAG_BADGE04_GET_FRLG                                            (SYS_FLAGS + 0x23)
#define FLAG_BADGE05_GET_FRLG                                            (SYS_FLAGS + 0x24)
#define FLAG_BADGE06_GET_FRLG                                            (SYS_FLAGS + 0x25)
#define FLAG_BADGE07_GET_FRLG                                            (SYS_FLAGS + 0x26)
#define FLAG_BADGE08_GET_FRLG                                            (SYS_FLAGS + 0x27)
#define NUM_BADGES_FRLG                                                  (1 + FLAG_BADGE08_GET_FRLG - FLAG_BADGE01_GET_FRLG)

#define FLAG_SYS_POKEMON_GET_FRLG                                        (SYS_FLAGS + 0x28)
#define FLAG_SYS_POKEDEX_GET_FRLG                                        (SYS_FLAGS + 0x29)
#define FLAG_0x82A                                                  (SYS_FLAGS + 0x2A)
#define FLAG_0x82B                                                  (SYS_FLAGS + 0x2B)
#define FLAG_SYS_GAME_CLEAR_FRLG                                         (SYS_FLAGS + 0x2C)
#define FLAG_SYS_SET_TRAINER_CARD_PROFILE                           (SYS_FLAGS + 0x2D)
#define FLAG_0x82E                                                  (SYS_FLAGS + 0x2E)
#define FLAG_SYS_B_DASH_FRLG                                             (SYS_FLAGS + 0x2F)
...
#define FLAG_SYS_RESET_RTC_ENABLE_FRLG                                   (SYS_FLAGS + 0x37)
...
#define FLAG_SYS_RIBBON_GET_FRLG                                         (SYS_FLAGS + 0x3B)
...
#define FLAG_SYS_CLOCK_SET_FRLG                                          (SYS_FLAGS + 0x3F) // FLAG_0x83F
#define FLAG_SYS_NATIONAL_DEX_FRLG                                       (SYS_FLAGS + 0x40)
#define FLAG_SYS_PC_STORAGE_DISABLED                                (SYS_FLAGS + 0x41)
#define FLAG_SYS_INFORMED_OF_LOCAL_WIRELESS_PLAYER                  (SYS_FLAGS + 0x42)
#define FLAG_SHOWN_BOX_WAS_FULL_MESSAGE_FRLG                        (SYS_FLAGS + 0x43)
...
#define FLAG_ENABLE_SHIP_NAVEL_ROCK_FRLG                                 (SYS_FLAGS + 0x4A)
#define FLAG_ENABLE_SHIP_BIRTH_ISLAND_FRLG                               (SYS_FLAGS + 0x4B)
