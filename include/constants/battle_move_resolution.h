...
enum CancelerState
{
    ...
    CANCELER_STAT_CHANGE_SUB,
    CANCELER_STAT_STUFF_CHEEKS,
    CANCELER_STAT_CHANGE_MOVES,
    CANCELER_ACCURACY, // For stat changes only
    CANCELER_MIRROR_ARMOR,
    CANCELER_STAT_CHANGE_MOVE_ANIM,
    CANCELER_END,
};
