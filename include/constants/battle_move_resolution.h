...
enum MultihitBlockStates
{
    ...
    MULTIHIT_BLOCK_SMART_EFFECTIVENESS_MESSAGE,
...
enum MoveEndState
{
    ...
    MOVEEND_PROTECT_LIKE_EFFECT_ALLIED_SIDE,
    MOVEEND_ADDITIONAL_EFFECTS_ALLIED_SIDE,
    MOVEEND_ABSORB_ALLIED_SIDE,
    MOVEEND_RAGE_ALLIED_SIDE,
    MOVEEND_BEAK_BLAST_ALLIED_SIDE,
    MOVEEND_ABILITIES_TARGET_ALLIED_SIDE,
    MOVEEND_RESIST_BERRY_MESSAGE_ALLIED_SIDE,
    MOVEEND_FORM_CHANGE_ON_HIT_ALLIED_SIDE, // Disguise / Gulp Missile
    MOVEEND_ABILITIES_ATTACKER_ALLIED_SIDE,
    ...
    MOVEEND_ITEM_EFFECTS_TARGET_ALLIED_SIDE,
    MOVEEND_ITEM_EFFECTS_ATTACKER_1_ALLIED_SIDE,
    ...
    MOVEEND_ABILITIES_TARGET_OPPOSING_SIDE,
    MOVEEND_RESIST_BERRY_MESSAGE_OPPOSING_SIDE,
    MOVEEND_FORM_CHANGE_ON_HIT_OPPOSING_SIDE, // Disguise / Gulp Missile
    MOVEEND_ABILITIES_ATTACKER_OPPOSING_SIDE,
