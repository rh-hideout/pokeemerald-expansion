...
#define SIDE_STATUS_TOXIC_SPIKES 0
#define SIDE_STATUS_STEALTH_ROCK 0
#define SIDE_STATUS_STEELSURGE 0
#define SIDE_STATUS_STICKY_WEB 0
#define SIDE_STATUS_SPIKES 0
