...
enum StartingStatus
{
    ...
    STARTING_STATUS_SPIKES_PLAYER_L1,
    STARTING_STATUS_SPIKES_PLAYER_L2,
    STARTING_STATUS_SPIKES_PLAYER_L3,
    STARTING_STATUS_SPIKES_OPPONENT_L1,
    STARTING_STATUS_SPIKES_OPPONENT_L2,
    STARTING_STATUS_SPIKES_OPPONENT_L3,
    STARTING_STATUS_TOXIC_SPIKES_PLAYER_L1,
    STARTING_STATUS_TOXIC_SPIKES_PLAYER_L2,
    STARTING_STATUS_TOXIC_SPIKES_OPPONENT_L1,
    STARTING_STATUS_TOXIC_SPIKES_OPPONENT_L2,
    STARTING_STATUS_STICKY_WEB_PLAYER,
    STARTING_STATUS_STICKY_WEB_OPPONENT,
    STARTING_STATUS_STEALTH_ROCK_PLAYER,
    STARTING_STATUS_STEALTH_ROCK_OPPONENT,
    STARTING_STATUS_SHARP_STEEL_PLAYER,
    STARTING_STATUS_SHARP_STEEL_OPPONENT,
};
