...
#define BATTLE_TYPE_TOWER_LINK_MULTI        (BATTLE_TYPE_BATTLE_TOWER | BATTLE_TYPE_LINK | BATTLE_TYPE_MULTI)
#define IS_BATTLE_TYPE_TOWER_LINK_MULTI     (((gBattleTypeFlags) & BATTLE_TYPE_TOWER_LINK_MULTI) == BATTLE_TYPE_TOWER_LINK_MULTI)
