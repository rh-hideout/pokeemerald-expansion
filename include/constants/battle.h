...
#define SIDE_STATUS_SCREEN_ANY     (SIDE_STATUS_REFLECT | SIDE_STATUS_LIGHTSCREEN | SIDE_STATUS_AURORA_VEIL | SIDE_STATUS_MIRAGE_VEIL)
...
enum MoveEffects
{
    ...
    MOVE_EFFECT_STICKY_TONGUE,    
    MOVE_EFFECT_LEECH_SEED_ON_HIT,
    MOVE_EFFECT_RECHARGE_D,
    MOVE_EFFECT_CLEAR_WEATHER,
    MOVE_EFFECT_CURSE,
    MOVE_EFFECT_DAILY_DOSE,
    MOVE_EFFECT_BEAR_HUG_ABILITY,
    MOVE_EFFECT_BEAR_HUG_ITEM,
    MOVE_EFFECT_PSYCHIC_D,
