...
#define VOLATILE_DEFINITIONS(F) \
    ...
    F(VOLATILE_CHRONOVISION,                chronovision,                  (u32, 1))
...
#define B_WEATHER_DARKNESS      (1 << BATTLE_WEATHER_DARKNESS)

#define B_WEATHER_ANY           (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_SUN | B_WEATHER_HAIL | B_WEATHER_STRONG_WINDS | B_WEATHER_SNOW | B_WEATHER_FOG | B_WEATHER_DARKNESS)
#define B_WEATHER_DAMAGING_ANY  (B_WEATHER_HAIL | B_WEATHER_SANDSTORM)
#define B_WEATHER_ICY_ANY       (B_WEATHER_HAIL | B_WEATHER_SNOW)
#define B_WEATHER_LOW_LIGHT     (B_WEATHER_FOG | B_WEATHER_ICY_ANY | B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_DARKNESS)
