...
enum __attribute__((packed)) Move
{
    ...
    // Z Moves
    FIRST_Z_MOVE = (MOVES_COUNT + 0),
    MOVE_BREAKNECK_BLITZ = FIRST_Z_MOVE,
    MOVE_ALL_OUT_PUMMELING = (MOVES_COUNT + 1),
    MOVE_SUPERSONIC_SKYSTRIKE = (MOVES_COUNT + 2),
    MOVE_ACID_DOWNPOUR = (MOVES_COUNT + 3),
    MOVE_TECTONIC_RAGE = (MOVES_COUNT + 4),
    MOVE_CONTINENTAL_CRUSH = (MOVES_COUNT + 5),
    MOVE_SAVAGE_SPIN_OUT = (MOVES_COUNT + 6),
    MOVE_NEVER_ENDING_NIGHTMARE = (MOVES_COUNT + 7),
    MOVE_CORKSCREW_CRASH = (MOVES_COUNT + 8),
    MOVE_INFERNO_OVERDRIVE = (MOVES_COUNT + 9),
    MOVE_HYDRO_VORTEX = (MOVES_COUNT + 10),
    MOVE_BLOOM_DOOM = (MOVES_COUNT + 11),
    MOVE_GIGAVOLT_HAVOC = (MOVES_COUNT + 12),
    MOVE_SHATTERED_PSYCHE = (MOVES_COUNT + 13),
    MOVE_SUBZERO_SLAMMER = (MOVES_COUNT + 14),
    MOVE_DEVASTATING_DRAKE = (MOVES_COUNT + 15),
    MOVE_BLACK_HOLE_ECLIPSE = (MOVES_COUNT + 16),
    MOVE_TWINKLE_TACKLE = (MOVES_COUNT + 17),
    // Signature Z Moves
    MOVE_CATASTROPIKA = (MOVES_COUNT + 18),
    MOVE_10000000_VOLT_THUNDERBOLT = (MOVES_COUNT + 19),
    MOVE_10_000_000_VOLT_THUNDERBOLT = MOVE_10000000_VOLT_THUNDERBOLT,
    MOVE_STOKED_SPARKSURFER = (MOVES_COUNT + 20),
    MOVE_EXTREME_EVOBOOST = (MOVES_COUNT + 21),
    MOVE_PULVERIZING_PANCAKE = (MOVES_COUNT + 22),
    MOVE_GENESIS_SUPERNOVA = (MOVES_COUNT + 23),
    MOVE_SINISTER_ARROW_RAID = (MOVES_COUNT + 24),
    MOVE_MALICIOUS_MOONSAULT = (MOVES_COUNT + 25),
    MOVE_OCEANIC_OPERETTA = (MOVES_COUNT + 26),
    MOVE_SPLINTERED_STORMSHARDS = (MOVES_COUNT + 27),
    MOVE_LETS_SNUGGLE_FOREVER = (MOVES_COUNT + 28),
    MOVE_CLANGOROUS_SOULBLAZE = (MOVES_COUNT + 29),
    MOVE_GUARDIAN_OF_ALOLA = (MOVES_COUNT + 30),
    MOVE_SEARING_SUNRAZE_SMASH = (MOVES_COUNT + 31),
    MOVE_MENACING_MOONRAZE_MAELSTROM = (MOVES_COUNT + 32),
    MOVE_LIGHT_THAT_BURNS_THE_SKY = (MOVES_COUNT + 33),
    MOVE_SOUL_STEALING_7_STAR_STRIKE = (MOVES_COUNT + 34),
    LAST_Z_MOVE = MOVE_SOUL_STEALING_7_STAR_STRIKE,
    MOVES_COUNT_Z,

    // Max Moves
    FIRST_MAX_MOVE = MOVES_COUNT_Z,
    MOVE_MAX_GUARD = (FIRST_MAX_MOVE + 0),
    MOVE_MAX_STRIKE = (FIRST_MAX_MOVE + 1),
    MOVE_MAX_KNUCKLE = (FIRST_MAX_MOVE + 2),
    MOVE_MAX_AIRSTREAM = (FIRST_MAX_MOVE + 3),
    MOVE_MAX_OOZE = (FIRST_MAX_MOVE + 4),
    MOVE_MAX_QUAKE = (FIRST_MAX_MOVE + 5),
    MOVE_MAX_ROCKFALL = (FIRST_MAX_MOVE + 6),
    MOVE_MAX_FLUTTERBY = (FIRST_MAX_MOVE + 7),
    MOVE_MAX_PHANTASM = (FIRST_MAX_MOVE + 8),
    MOVE_MAX_STEELSPIKE = (FIRST_MAX_MOVE + 9),
    MOVE_MAX_FLARE = (FIRST_MAX_MOVE + 10),
    MOVE_MAX_GEYSER = (FIRST_MAX_MOVE + 11),
    MOVE_MAX_OVERGROWTH = (FIRST_MAX_MOVE + 12),
    MOVE_MAX_LIGHTNING = (FIRST_MAX_MOVE + 13),
    MOVE_MAX_MINDSTORM = (FIRST_MAX_MOVE + 14),
    MOVE_MAX_HAILSTORM = (FIRST_MAX_MOVE + 15),
    MOVE_MAX_WYRMWIND = (FIRST_MAX_MOVE + 16),
    MOVE_MAX_DARKNESS = (FIRST_MAX_MOVE + 17),
    MOVE_MAX_STARFALL = (FIRST_MAX_MOVE + 18),
    // Gigantamax Moves
    MOVE_G_MAX_VINE_LASH = (FIRST_MAX_MOVE + 19),
    MOVE_G_MAX_WILDFIRE = (FIRST_MAX_MOVE + 20),
    MOVE_G_MAX_CANNONADE = (FIRST_MAX_MOVE + 21),
    MOVE_G_MAX_BEFUDDLE = (FIRST_MAX_MOVE + 22),
    MOVE_G_MAX_VOLT_CRASH = (FIRST_MAX_MOVE + 23),
    MOVE_G_MAX_GOLD_RUSH = (FIRST_MAX_MOVE + 24),
    MOVE_G_MAX_CHI_STRIKE = (FIRST_MAX_MOVE + 25),
    MOVE_G_MAX_TERROR = (FIRST_MAX_MOVE + 26),
    MOVE_G_MAX_FOAM_BURST = (FIRST_MAX_MOVE + 27),
    MOVE_G_MAX_RESONANCE = (FIRST_MAX_MOVE + 28),
    MOVE_G_MAX_CUDDLE = (FIRST_MAX_MOVE + 29),
    MOVE_G_MAX_REPLENISH = (FIRST_MAX_MOVE + 30),
    MOVE_G_MAX_MALODOR = (FIRST_MAX_MOVE + 31),
    MOVE_G_MAX_MELTDOWN = (FIRST_MAX_MOVE + 32),
    MOVE_G_MAX_DRUM_SOLO = (FIRST_MAX_MOVE + 33),
    MOVE_G_MAX_FIREBALL = (FIRST_MAX_MOVE + 34),
    MOVE_G_MAX_HYDROSNIPE = (FIRST_MAX_MOVE + 35),
    MOVE_G_MAX_WIND_RAGE = (FIRST_MAX_MOVE + 36),
    MOVE_G_MAX_GRAVITAS = (FIRST_MAX_MOVE + 37),
    MOVE_G_MAX_STONESURGE = (FIRST_MAX_MOVE + 38),
    MOVE_G_MAX_VOLCALITH = (FIRST_MAX_MOVE + 39),
    MOVE_G_MAX_TARTNESS = (FIRST_MAX_MOVE + 40),
    MOVE_G_MAX_SWEETNESS = (FIRST_MAX_MOVE + 41),
    MOVE_G_MAX_SANDBLAST = (FIRST_MAX_MOVE + 42),
    MOVE_G_MAX_STUN_SHOCK = (FIRST_MAX_MOVE + 43),
    MOVE_G_MAX_CENTIFERNO = (FIRST_MAX_MOVE + 44),
    MOVE_G_MAX_SMITE = (FIRST_MAX_MOVE + 45),
    MOVE_G_MAX_SNOOZE = (FIRST_MAX_MOVE + 46),
    MOVE_G_MAX_FINALE = (FIRST_MAX_MOVE + 47),
    MOVE_G_MAX_STEELSURGE = (FIRST_MAX_MOVE + 48),
    MOVE_G_MAX_DEPLETION = (FIRST_MAX_MOVE + 49),
    MOVE_G_MAX_ONE_BLOW = (FIRST_MAX_MOVE + 50),
    MOVE_G_MAX_RAPID_FLOW = (FIRST_MAX_MOVE + 51),
