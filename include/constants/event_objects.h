...
#define OBJ_EVENT_GFX_VARS_END OBJ_EVENT_GFX_VAR_F

#define OBJ_EVENT_GFX_OWES   (OBJ_EVENT_GFX_VARS_END + 1)
#define OBJ_EVENT_GFX_OWE_0  (OBJ_EVENT_GFX_OWES + 0x0)
#define OBJ_EVENT_GFX_OWE_1  (OBJ_EVENT_GFX_OWES + 0x1)
#define OBJ_EVENT_GFX_OWE_2  (OBJ_EVENT_GFX_OWES + 0x2)
#define OBJ_EVENT_GFX_OWE_3  (OBJ_EVENT_GFX_OWES + 0x3)
#define OBJ_EVENT_GFX_OWE_4  (OBJ_EVENT_GFX_OWES + 0x4)
#define OBJ_EVENT_GFX_OWE_5  (OBJ_EVENT_GFX_OWES + 0x5)
#define OBJ_EVENT_GFX_OWE_6  (OBJ_EVENT_GFX_OWES + 0x6)
#define OBJ_EVENT_GFX_OWE_7  (OBJ_EVENT_GFX_OWES + 0x7)
#define OBJ_EVENT_GFX_OWE_8  (OBJ_EVENT_GFX_OWES + 0x8)
#define OBJ_EVENT_GFX_OWE_9  (OBJ_EVENT_GFX_OWES + 0x9)
#define OBJ_EVENT_GFX_OWE_A  (OBJ_EVENT_GFX_OWES + 0xA)
#define OBJ_EVENT_GFX_OWE_B  (OBJ_EVENT_GFX_OWES + 0xB)
#define OBJ_EVENT_GFX_OWE_C  (OBJ_EVENT_GFX_OWES + 0xC)
#define OBJ_EVENT_GFX_OWE_D  (OBJ_EVENT_GFX_OWES + 0xD)
#define OBJ_EVENT_GFX_OWE_E  (OBJ_EVENT_GFX_OWES + 0xE)
#define OBJ_EVENT_GFX_OWE_F  (OBJ_EVENT_GFX_OWES + 0xF)
#define OBJ_EVENT_GFX_OWES_END OBJ_EVENT_GFX_OWE_F
