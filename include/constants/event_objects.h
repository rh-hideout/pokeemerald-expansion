...
#define OBJ_EVENT_GFX_SCHOOL_KID_F                OBJ_EVENT_GFX_GIRL_3
...
#define OBJ_EVENT_GFX_SWIMMING_TRIATHLETE_M       OBJ_EVENT_GFX_SWIMMER_M
#define OBJ_EVENT_GFX_SWIMMER_F                   43
#define OBJ_EVENT_GFX_SWIMMING_TRIATHLETE_F       OBJ_EVENT_GFX_SWIMMER_F
...
#define OBJ_EVENT_GFX_BIRD_KEEPER                 OBJ_EVENT_GFX_MAN_5
