...
#define OBJ_EVENT_GFX_OVERWORLD_ENCOUNTERS      (OBJ_EVENT_GFX_VARS + 0x10)
#define OBJ_EVENT_GFX_OVERWORLD_ENCOUNTER_LAND  (OBJ_EVENT_GFX_OVERWORLD_ENCOUNTERS + 0x0)
#define OBJ_EVENT_GFX_OVERWORLD_ENCOUNTER_WATER (OBJ_EVENT_GFX_OVERWORLD_ENCOUNTERS + 0x1)
