...
#### todo Dustin
- finish texts on guides/documentation
- final walkthrough with taking screenshots 
...
Each of the game's terminals are tied to a specific flag, hindering the player to advance the game further. Between the puzzels, the game environment regularly challenges the player with the common elements of what Pokemon itself has to offer, including fights, leveling and organization of one's own Pokemon-team.
