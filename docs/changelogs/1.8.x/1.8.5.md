...
## 🤹 Moves 🤹
### Fixed
* Added missing `ignoreCertainFailurestitute` flags for Defog (only in Gen 4), Torment and Powder by @AlexOn1ine in https://github.com/rh-hideout/pokeemerald-expansion/pull/4623
