...
* Fixed AI not considering Memento an effect that reduces stats by adding it to `IsStatLoweringMove` by @PCG06 in https://github.com/rh-hideout/pokeemerald-expansion/pull/4386
