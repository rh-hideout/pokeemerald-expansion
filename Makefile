...
clean-assets:
	...
	find . \( -iname '*.1bpp' -o -iname '*.4bpp' -o -iname '*.8bpp' -o -iname '*.gbapal' -o -iname '*.lz' -o -iname '*.rl' -o -iname '*.latfont' -o -iname '*.hwjpnfont' -o -iname '*.smol' -o -iname '*.smolTM' -o -iname '*.fwjpnfont' \) -exec rm {} +
