...
# include/constants/hoenn_dex.h src/data/hoenn_dex.h are generated by a Python script
#HOENN_DEX_TOOL_DIR := $(TOOLS_DIR)/hoenn_dex
#AUTO_GEN_TARGETS += $(INCLUDE_DIRS)/constants/hoenn_dex.h
#AUTO_GEN_TARGETS += $(DATA_SRC_SUBDIR)/hoenn_dex.h
#
#$(DATA_SRC_SUBDIR)/wild_encounters.h: $(DATA_SRC_SUBDIR)/wild_encounters.json $(HOENN_DEX_TOOL_DIR)/wild_encounters_to_header.py $(INCLUDE_DIRS)/config/overworld.h $(INCLUDE_DIRS)/config/dexnav.h
#	python3 $(HOENN_DEX_TOOL_DIR)/populate_hoenn_dex.py
