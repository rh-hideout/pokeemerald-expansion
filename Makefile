...
# pokeball.h is generated by a Python script
POKEBALL_TOOL_DIR := $(TOOLS_DIR)/pokeball
AUTO_GEN_TARGETS += $(DATA_SRC_SUBDIR)/pokeball.h

$(DATA_SRC_SUBDIR)/pokeball.h: $(INCLUDE_DIRS)/pokeball.h $(POKEBALL_TOOL_DIR)/pokeball_to_header.py
	python3 $(POKEBALL_TOOL_DIR)/pokeball_to_header.py > $@

$(C_BUILDDIR)/pokeball.o: c_dep += $(DATA_SRC_SUBDIR)/pokeball.h
