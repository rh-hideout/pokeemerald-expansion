...
TEACHABLE_DEPS := $(ALL_LEARNABLES_JSON) $(shell find data/ -type f -name '*.inc') $(INCLUDE_DIRS)/constants/tms_hms.h $(LEARNSET_HELPERS_DIR)/make_teachables.py $(C_SUBDIR)/pokemon.c
