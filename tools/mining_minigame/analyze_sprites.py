...
def main():
    ...
    contents = """// DO NOT MODIFY THIS FILE'S CONTENT! THE CONTENT OF THIS FILE IS AUTOGENERATED (tools/mining_minigame/analyze_sprites.py)! ONLY MODIFY THIS FILE IF YOU KNOW WHAT YOU ARE DOING!
